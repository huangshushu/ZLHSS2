    ...
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			if(cm.getBossLog('每日蘑菇王') == 0){
					if (cm.haveItem(4000040,1)){
						text += "  #L2#"+爱心+"#e每日殴打蘑菇王       (金币20W)(#r可完成#k)#n"+感叹号+"#l\r\n"//3
					}else{
						text += "  #L2#"+爱心+"#e每日殴打蘑菇王       (金币20W)(#b可开始#k)#n"+爱心+"#l\r\n"//3
					} 
				} else if(cm.getBossLog('每日蘑菇王') == 1){
					text += "  #L2#"+爱心+"#e每日殴打蘑菇王       (金币20W)(#r"+完成+"#k)#n"+爱心+"#l\r\n"//3
				} else {
					text += "		  "+琴符+"#e   (#rlv.15#k)主线任务2   "+琴符+"#l\r\n\r\n"//3
			}
			if(cm.getBossLog('每日僵尸蘑菇王') == 0){
					if (cm.haveItem(4000176,1)){
					text += "  #L3#"+爱心+"#e每日殴打僵尸蘑菇王   (金币20W)(#r可完成#k)#n"+感叹号+"#l\r\n"//3
					}else{
					text += "  #L3#"+爱心+"#e每日殴打僵尸蘑菇王   (金币20W)(#b可开始#k)#n"+爱心+"#l\r\n"//3
					} 
				} else if(cm.getBossLog('每日僵尸蘑菇王') == 1){
					text += "  #L3#"+爱心+"#e每日殴打僵尸蘑菇王   (金币20W)(#r"+完成+"#k)#n"+爱心+"#l\r\n"//3
				} else {
					text += "		  "+琴符+"#e   (#rlv.15#k)主线任务2   "+琴符+"#l\r\n\r\n"//3
			}
			if(cm.getBossLog('每日蓝蘑菇王') == 0){
					if (cm.haveItem(4001010,1)){
					text += "  #L4#"+爱心+"#e每日殴打蓝蘑菇王     (金币20W)(#r可完成#k)#n"+感叹号+"#l\r\n"//3
					}else{
					text += "  #L4#"+爱心+"#e每日殴打蓝蘑菇王     (金币20W)(#b可开始#k)#n"+爱心+"#l\r\n"//3
					} 
				} else if(cm.getBossLog('每日蓝蘑菇王') == 1){
					text += "  #L4#"+爱心+"#e每日殴打蓝蘑菇王     (金币20W)(#r"+完成+"#k)#n"+爱心+"#l\r\n"//3
				} else {
					text += "		  "+琴符+"#e   (#rlv.15#k)主线任务2   "+琴符+"#l\r\n\r\n"//3
			}
			if(cm.getBossLog('每日蜈蚣王') == 0){
					if (cm.haveItem(4031227,1)){
					text += "  #L5#"+爱心+"#e每日殴打蜈蚣王       (金币30W)(#r可完成#k)#n"+感叹号+"#l\r\n"//3
					}else{
					text += "  #L5#"+爱心+"#e每日殴打蜈蚣王       (金币30W)(#b可开始#k)#n"+爱心+"#l\r\n"//3
					} 
				} else if(cm.getBossLog('每日蜈蚣王') == 1){
					text += "  #L5#"+爱心+"#e每日殴打蜈蚣王       (金币30W)(#r"+完成+"#k)#n"+爱心+"#l\r\n"//3
				} else {
					text += "		  "+琴符+"#e   (#rlv.15#k)主线任务2   "+琴符+"#l\r\n\r\n"//3
			}
			if(cm.getBossLog('每日多多') == 0){
					if (cm.haveItem(4000460,1) && cm.haveItem(4000461,1) && cm.haveItem(4000462,1)){
					text += "  #L6#"+爱心+"#e每日殴打神殿三Boss  (金币100W)(#r可完成#k)#n"+感叹号+"#l\r\n"//3
					}else{
					text += "  #L6#"+爱心+"#e每日殴打神殿三Boss  (金币100W)(#b可开始#k)#n"+爱心+"#l\r\n"//3
					} 
				} else if(cm.getBossLog('每日多多') == 1){
					text += "  #L6#"+爱心+"#e每日殴打神殿三Boss  (金币100W)(#r"+完成+"#k)#n"+爱心+"#l\r\n"//3
				} else {
					text += "		  "+琴符+"#e   (#rlv.15#k)主线任务2   "+琴符+"#l\r\n\r\n"//3
			}
			...
			if(cm.getBossLog('每日鱼王') == 0){
					...
					text += "  #L9#"+爱心+"#e每日殴打鱼王        (金币100W)(#r可完成#k)#n"+感叹号+"#l\r\n"//3
					}else{
					text += "  #L9#"+爱心+"#e每日殴打鱼王        (金币100W)(#b可开始#k)#n"+爱心+"#l\r\n"//3
					} 
				} else if(cm.getBossLog('每日鱼王') == 1){
					text += "  #L9#"+爱心+"#e每日殴打鱼王        (金币100W)(#r"+完成+"#k)#n"+爱心+"#l\r\n"//3
				} else {
					text += "		  "+琴符+"#e   (#rlv.15#k)主线任务2   "+琴符+"#l\r\n\r\n"//3
			}
			if(cm.getBossLog('每日老板') == 0){
					if (cm.haveItem(4000094,3)){
					text += "  #L10#"+爱心+"#e每日殴打老板     (奖励混沌)(#r可完成#k)#n"+感叹号+"#l\r\n"//3
					}else{
					text += "  #L10#"+爱心+"#e每日殴打老板     (奖励混沌)(#b可开始#k)#n"+爱心+"#l\r\n"//3
					} 
				} else if(cm.getBossLog('每日老板') == 1){
					text += "  #L10#"+爱心+"#e每日殴打老板     (奖励混沌)(#r"+完成+"#k)#n"+爱心+"#l\r\n"//3
				} else {
					text += "		  "+琴符+"#e   (#rlv.15#k)主线任务2   "+琴符+"#l\r\n\r\n"//3
			}
			if(cm.getBossLog('每日天狗') == 0){
					if (cm.haveItem(4000224,1)){
					text += "  #L11#"+爱心+"#e每日殴打天狗      (混沌卷轴 x1)(#r可完成#k)#n"+感叹号+"#l\r\n"//3
					}else{
					text += "  #L11#"+爱心+"#e每日殴打天狗      (混沌卷轴 x1)(#b可开始#k)#n"+爱心+"#l\r\n"//3
					} 
				} else if(cm.getBossLog('每日天狗') == 1){
					text += "  #L11#"+爱心+"#e每日殴打天狗      (混沌卷轴 x1)(#r"+完成+"#k)#n"+爱心+"#l\r\n"//3
				} else {
					text += "		  "+琴符+"#e   (#rlv.15#k)主线任务2   "+琴符+"#l\r\n\r\n"//3
			}
			if(cm.getBossLog('每日大姐大') == 0){
					if (cm.haveItem(4000138,1)){
					text += "  #L12#"+爱心+"#e每日殴打大姐大    (祝福卷轴 x1)(#r可完成#k)#n"+感叹号+"#l\r\n"//3
					}else{
					text += "  #L12#"+爱心+"#e每日殴打大姐大    (祝福卷轴 x1)(#b可开始#k)#n"+爱心+"#l\r\n"//3
					} 
				} else if(cm.getBossLog('每日大姐大') == 1){
					text += "  #L12#"+爱心+"#e每日殴打大姐大    (祝福卷轴 x1)(#r"+完成+"#k)#n"+爱心+"#l\r\n"//3
				} else {
					text += "		  "+琴符+"#e   (#rlv.15#k)主线任务2   "+琴符+"#l\r\n\r\n"//3
			}
	    ...
	    cm.dispose();
			...
			if (cm.haveItem(4000040,1)){
				...
				cm.喇叭(1,"玩家："+cm.getName()+" 完成每日殴打蘑菇王！奖励金币20W！");
                cm.sendOk("兑换成功！");
            cm.setBossLog('每日蘑菇王');
                cm.dispose();
		}else{
	    ...
	    cm.dispose();
			...
			if (cm.haveItem(4000176,1)){
				...
				cm.gainMeso(+200000); //加减金币
				//cm.gainMeso(+2049100); //加减金币	
				cm.喇叭(1,"玩家："+cm.getName()+" 完成每日殴打僵尸蘑菇王！奖励金币20W！");
                cm.sendOk("兑换成功！");
	    ...
	    cm.dispose();
			...
			if (cm.haveItem(4001010,1)){
				...
				cm.gainMeso(+200000); //加减金币
				//cm.gainMeso(+2049100); //加减金币	
				cm.喇叭(1,"玩家："+cm.getName()+" 完成每日殴打蓝蘑菇王！奖励金币20W！");
                cm.sendOk("兑换成功！");
						...
						cm.dispose();
							...
							if (cm.haveItem(4031227,1)){
									if (cm.getLevel() > 59){
										...
										//cm.gainMeso(+2049100); //加减金币	
											cm.喇叭(1,"玩家："+cm.getName()+" 完成每日击败蜈蚣王！奖励金币30W！");
											cm.sendOk("兑换成功！");
											cm.setBossLog('每日蜈蚣王');
											cm.dispose();
									}else{
						...
						cm.dispose();
							...
							if (cm.haveItem(4000460,1) && cm.haveItem(4000461,1) && cm.haveItem(4000462,1)){
									if (cm.getLevel() > 119){
										...
										//cm.gainMeso(+2049100); //加减金币	
											cm.喇叭(1,"玩家："+cm.getName()+" 完成每日击败神殿三Boss！奖励金币100W！");
											cm.sendOk("兑换成功！");
											cm.setBossLog('每日多多');
											cm.dispose();
									}else{
						...
						cm.dispose();
							...
							if (cm.haveItem(4000094,3)){
									if (cm.getLevel() > 149){
										...
										cm.gainItem(2049100, 1, 1);//混沌
										//cm.gainItem(5340001, 1,1);//鱼竿
										//cm.gainItem(2300000, 100,1);//鱼饵
										//cm.gainMeso(+2049100); //加减金币	
											cm.喇叭(1,"玩家："+cm.getName()+" 完成每日击败老板！奖励混沌！");
											cm.sendOk("兑换成功！");
											cm.setBossLog('每日老板');
											cm.dispose();
									}else{
						...
						cm.dispose();
							...
							if (cm.haveItem(4000224,1)){
									if (cm.getLevel() > 149){
											...
											cm.喇叭(1,"玩家："+cm.getName()+" 完成每日击败天狗！奖励混沌卷轴x1！");
											cm.sendOk("兑换成功！");
											cm.setBossLog('每日天狗');
											cm.dispose();
									}else{
						...
						cm.dispose();
							...
							if (cm.haveItem(4000138,1)){
									if (cm.getLevel() > 159){
											...
											cm.喇叭(1,"玩家："+cm.getName()+" 完成每日击败大姐大！奖励祝福卷轴x1！");
											cm.sendOk("兑换成功！");
											cm.setBossLog('每日大姐大');
											cm.dispose();
									}else{
