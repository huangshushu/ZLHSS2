	...
	if (mode == -1) {
		...
		if (a == -1) {
			...
			if (selection == 0) {
		        ...
		        if(dmID!=1113090) {
		        cm.sendOk("把#v1113090#放在第一格!");	
				cm.dispose();
				}  
			 else	if (cm.haveItem(4005000, 10) && cm.haveItem(4005001, 10) && cm.haveItem(4005002, 10) && cm.haveItem(4005003, 10) && cm.getInventory(1).getItem(1).getOwner() == "第一阶段") {
					...
					cm.全服公告("玩家：["+cm.getName()+"]成功强化宝石戒指为第二阶段！恭喜恭喜！");
					cm.dispose();
				} else {
