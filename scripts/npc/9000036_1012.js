...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "#b#v4031138#金币*2000W\r\n"
            cm.sendSimple(text);
        } else if (selection == 1) {

			if(cm.getzb() >= 200 && cm.haveItem(1112949,1)&& cm.getPlayer().getBossLog("200赞助物品礼包",1) == 0){
