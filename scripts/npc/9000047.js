...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        cm.dispose();
         ...
         var 
        selStr = "#e#d              " + xx + " 武 器 觉 醒 " + xx + "\r\n";
		selStr += "" + epp + "" + epp + "" + epp + "" + epp + "\r\n";
            var x = 0;
        //str += "#r#L1#"+xxx+"#v1112676#升级成#v1112677##r#l\r\n";
        selStr += "           #L1#"+xx+"#e#r旋 涡 武 器 觉 醒#b#l \r\n\r\n";//#r#e#L98#"+xx+" 戒指淬炼系统 \r\n
		selStr += "           #L2#"+xx+"#r#e埃 苏 武 器 觉 醒#b#l \r\n\r\n";
		selStr += "           #L3#"+xx+"#r#e特 米 纳 斯 觉 醒#b#l \r\n\r\n";
		selStr += "           #L4#"+xx+"#r#e神 秘 之 影 觉 醒#b#l \r\n\r\n";
		selStr += "           #L5#"+xx+"#r#e  三 神 器 觉 醒 #b#l \r\n";
		selStr +="\r\n";
        selStr +="\r\n";;
		selStr += "\r\n" + epp + "" + epp + "" + epp + "" + epp + ""
        ...
        switch (selection) {
            case 1://能力
                cm.dispose();
				cm.openNpc(2470020);//cm.openNpc(9105003,"戒指强化");
				break;
            case 2://充值
                cm.dispose();
				cm.openNpc(2470021);//160juexing
                break;
            case 3://充值
                cm.dispose();
				cm.openNpc(2470022);//160juexing
                break;
            case 4://充值
                cm.dispose();
				cm.openNpc(2470023);//160juexing
                break;
            case 5://充值
                cm.dispose();
				cm.openNpc(2470027);//160juexing
                break;
            case 25://综合
                if (cm.getLevel() >= 10) {
