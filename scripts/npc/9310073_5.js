...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        var selStr = ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
			selStr += "              #r欢迎来到月月冒险岛抽奖中心#k\r\n";
			selStr += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n\r\n";
			selStr += "#g#L0##v4170011#副本抽奖#l   #b#L1##v4031138#金币抽奖#l   #r#L2##v4000463#点卷抽奖#l\r\n";
			//selStr += "                   #r###v5200002#积分抽奖#l不定时开启 \r\n";
        ...
        case 0:
            cm.dispose();
			cm.openNpc(9310073,51);
            break;
		case 1:
            cm.dispose();
			cm.openNpc(9310073,52);
            break;
		case 2:
            cm.dispose();
			cm.openNpc(9310073,53);
            break;
		case 3:
            cm.dispose();
			cm.openNpc(9310073,54);
            break;
}
	}
    }
