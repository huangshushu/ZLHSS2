...
function start() {
    cm.sendSimple(
			...
			"#L27#  27.短杖魔力卷轴30%     (需要30个印章)#l\r\n"+
			"#L28#  28.长杖魔力卷轴30%     (需要30个印章)#l\r\n"+
			"#r #k\r\n" +
			"#d    ------------------------------------#k\r\n" +
            "#e#L29#  29.套服敏捷诅咒卷轴30% (需要40个印章)#l\r\n"+
            "#L30#  30.套服力量诅咒卷轴30% (需要40个印章)#l\r\n"+
            "#L31#  31.套服智力诅咒卷轴30% (需要40个印章)#l\r\n"+
            "#L32#  32.套服幸运诅咒卷轴30% (需要40个印章)#l"
            );
}
