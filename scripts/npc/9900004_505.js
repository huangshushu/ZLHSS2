    ...
    if (mode == -1) {
		...
		var tex2 = ""+cm.getHyPay(1)+"";
           // text += "#L72##r" + 蓝色角点 + "材料合成#r New     #v4251202##z4251202##l#l\r\n\r\n"//3
            text += "#L71##r" + 蓝色角点 + "贝勒制作合成#r New     #v1113075#100六维#l#l\r\n"//3
            text += "#L73##r" + 蓝色角点 + "小青蛇戒指升级#r New     #v1112540#110六维#l#l\r\n"//3
            text += "#L9##r" + 蓝色角点 + "枫叶戒指 #r New       #v1112673#120六维#l#l\r\n"//3
            ...
            text += "#L4##r" + 蓝色角点 + "#r法弗纳武器~毕业武器#r New   #v1302275##z1302275##l#l\r\n"//3
		    text += "#L5##r" + 蓝色角点 + "#r法弗纳防具~毕业防具#r New   #v1042254##z1042254##l#l\r\n"//3
			text += "#L6##r" + 蓝色角点 + "#r暴君系列~毕业装备#r New   #v1102481##v1082543##v1072743##v1132174##l#l\r\n"//3
