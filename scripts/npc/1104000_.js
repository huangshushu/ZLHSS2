...
function action(mode, type, selection) {
    ...
    if (status == 0) {
			...
			//selStr+="#L4#困难模式（掉落#z4310091#）（扣500点券）#l\r\n";
			//selStr+="#L7#简单模式（组队模式）（扣队长5000抵用卷）#l\r\n";
			//selStr+="#L8#困难模式（组队模式）（扣队长1000点券）#l";
