...
var 金币 = 1000000;
var itemlist = Array(
	Array(1112738, 1113038),
	Array(1113038, 1113075)
    ...
    if (mode == -1) {
        ...
        if (a == -1) {
			...
			if (selection == 0) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1112738#放在装备栏#r第1格#b，#v1113038#放在#r第2格\r\n\r\n";
			    text += "#b需要材料：#v4310025#*200，#v4000082#*40，#v4000125#*40\r\n          #v4000235#*15，#v4000243#*15，#v4000244#*15，#v4000245#*15\r\n\r\n         #v4310143#*150， 金币*1E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 1) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1113038#放在装备栏#r第1格#b，#v1113075#放在#r第2格\r\n\r\n";
			    text += "#b需要材料：#v4310025#*200，#v4000082#*50，#v4000125#*50\r\n          #v4000235#*20，#v4000243#*20，#v4000244#*20，#v4000245#*20\r\n\r\n         #v4310143#*200， 金币*2E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 2) {
			...
			if (b == 1) {
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
				    ...
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1112738 || cm.getInventory(1).getItem(2).getItemId() != 1113038)  {
				...
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
		            cm.sendOk("#b请将神铸所需的装备放置在装备栏的#r第1、2格#b！");
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1113038 || cm.getInventory(1).getItem(2).getItemId() != 1113075)  {
		            cm.sendOk("#r第1、2格装备#r不符合要求，请仔细确认！");
				    cm.dispose();
				} else {
					var ItemID = cm.getInventory(1).getItem(1).getItemId();
			...
			if (b == 1) {
				...
				if (cm.haveItem(4310025,200) && cm.haveItem(4000082,40) && cm.haveItem(4000125,40) && cm.haveItem(4000235,15) && cm.haveItem(4000243,15) && cm.haveItem(4000244,15) && cm.haveItem(4000245,15)&& cm.haveItem(4310143,150) && cm.getMeso() >= 100000000) {
					cm.gainItem(4310025,-200);
					cm.gainItem(4000082,-40);
					cm.gainItem(4000125,-40);
					cm.gainItem(4000235,-15);
					cm.gainItem(4000243,-15);
				...
				var 可砸次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
				var 星级 = cm.getInventory(1).getItem(1).getOwner();	
				if (cm.haveItem(4310025,200) && cm.haveItem(4000082,50) && cm.haveItem(4000125,50) && cm.haveItem(4000235,20) && cm.haveItem(4000243,20) && cm.haveItem(4000244,20) && cm.haveItem(4000245,20)&& cm.haveItem(4310143,200) && cm.getMeso() >= 200000000) {
					cm.gainItem(4310025,-200);
					cm.gainItem(4000082,-50);
					cm.gainItem(4000125,-50);
					cm.gainItem(4000235,-20);
					cm.gainItem(4000243,-20);
