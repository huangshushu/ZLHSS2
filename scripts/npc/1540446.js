...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == startmap) {
        if (status == 0) {
            ...
            rwpz += "#d       当前已挑战斯乌[#e#g"+cm.getBossLog("斯乌") + "#n#k/#r#e3#n#k]次#n#k\r\n";
            rwpz += "\r\n#b推荐人數：" + minPlayers + " - " + maxPlayers + "#n    推荐等级：" + minLevel[selection] + " - " + maxLevel[selection] + "#n#k";
            rwpz += "\r\n#d当前已進行：#e#r" +cm.getBossLog("斯乌")  + " #n#k次\r\n";
            ...
            if (cm.getParty() == null) { //判断组队
                ...
                return;
                      ...
                      if (cm.getPlayerCount(350060160) <= 0 && cm.getPlayerCount(350060160) <= 0 && cm.getPlayerCount(350060160) <= 0 && cm.getPlayerCount(350060160) <= 0 && cm.getPlayerCount(350060160) <= 0) {
                            ...
                            cm.getPlayer().setBossLog("斯乌");
                            //cm.喇叭(2,"『终极BOSS』：【" + cm.getChar().getName() + "】带领他的队伍悍不畏死的去斯乌了");
                    } else {
