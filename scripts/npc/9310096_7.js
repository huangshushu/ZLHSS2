...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
		var a0 = "             #L0#"+ 小烟花 +"#r#v1113070##z1113070#制作"+ 小烟花 +"#l\r\n\r\n                     #b需要材料如下#l\r\n\r\n  #v4001158#*50、#v4001198#*50、#v4001241#*30、#v4001242#*30、#v4000235#*30\r\n\r\n   #v4000243#*30、#v4000460#*30、#v4000461#*30、#v4000462#*30、#v4001080#*10\r\n\r\n           #v4001094#*10、#v4021009#*5、#v4031138#5000万\r\n";
...
//		var a2 = "#L2#" + 正方箭头 + "#b制作外星碎片耳环#r#v1032191##z1032191##l\r\n\r\n需要#v1032142#*1、#v4001129#*200、#v4002000#*25、#v4002001#*25、#v4002002#*25、#v4002003#*25、#v4000125#*500、#v4000313#*500、#v4011008#*4、1500万游戏币来制作\r\n";
		...
		if (cm.haveItem(4001158,50)&&cm.haveItem(4001198,50)&&cm.haveItem(4001241,30)&&cm.haveItem(4001242,30)&&cm.haveItem(4000235,30)&&cm.haveItem(4000243,30)&&cm.haveItem(4000460,30)&&cm.haveItem(4000461,30)&&cm.haveItem(4000462,30)&&cm.haveItem(4001080,10)&&cm.haveItem(4001094,10)&&cm.haveItem(4021009,5)&& cm.getMeso() >=50000000) {
			...
			cm.gainItem(4000460,-30);
			cm.gainItem(4000461,-30);
			cm.gainItem(4000462,-30);
			cm.gainItem(4001080,-10);
			cm.gainItem(4001094,-10);
			cm.gainItem(4021009,-5);
			cm.gainMeso(-50000000);
			cm.gainItem(1113070,1);
			Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(11,cm.getC().getChannel(),"真红之环制作" + " : " + cm.getPlayer().getName() +"玩家成功制作了真红之环。O(∩_∩)O哈哈~",true).getBytes());
