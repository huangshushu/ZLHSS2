...
function action(mode, type, selection) {
	...
	if (!cm.haveItem(exchangeItem, 100)) {
	    ...
	    cm.sendGetNumber("嗯，这是个好主意！ 我可以给你 #i2022457#每100个 #i" + exchangeItem + "##t" + exchangeItem + "# 你想要给我多少 (当前道具: " + cm.getPlayer().itemQuantity(exchangeItem) + ")", java.lang.Math.min(300.0, cm.getPlayer().itemQuantity(exchangeItem) / 100.0), 1, java.lang.Math.min(300.0, cm.getPlayer().itemQuantity(exchangeItem) / 100.0));
	}
    } else if (status == 2) { 
