...
function action(mode, type, selection) {
    ...
    if (status == 0) {
    var selStr = "#d#e" + epp + "制作中心" + epp + "#l#k\r\n";
        //selStr += "#b#e\t\t\t#L14#" + aaa + "材料地图传送" + aaa + "#l#k\r\n";
		selStr +="#r#L2#"+xxx+"FFN防具"+xxx+"#l   #r#L9#"+xxx+"暴君防具"+xxx+"#l  #r#L1#"+xxx+"神秘武器"+xxx+"#l\r\n";
        ...
        case 2:
            cm.dispose();
            cm.openNpc(2470018,"zz150fj"); //卷轴商城
            break;
        ...
        case 5:
			...
			case 9:
            cm.dispose();
            cm.openNpc(2470018,"制作暴君防具"); //结晶合成
            break;
			case 10:
            cm.dispose();
