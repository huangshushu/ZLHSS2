var a = 0;
var Text = "#b#e七七限时戒指活动  （固有时装戒指一人只能带一个） 兑换时间5.28-6.28所有材料出处：世界所有怪小几率出  #r\r\n#L20##v3990020##v3990021##v3990022##v3990023##各需要1个#r\r\n合成 随机 全属性攻魔10-88血魔1000#v1112271#双防御300#l\r\n\r\n\r\n\r\n#L30##b#v3990020##v3990021##v3990022##v3990023##+1000万游戏币\r\n重置属性10-88#v1112271#\r\n\r\n\r\n\r\n";//#L30##b获取戒指后使用#v3994047##v3994048##v3994049#市场14洞门口强化
var db;
var time;
...
if ( cm.itemQuantity(3990020) >=1 && cm.getPlayer().getBossLog("戒指兑换1111",1) == 0&& cm.itemQuantity(3990021) >=1&& cm.itemQuantity(3990022) >=1&& cm.getMeso()>=1000000){
...
cm.gainMeso(-1000000);
Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(12, cm.getClient().getChannel(), "限时活动" + " : " + "恭喜『" + cm.getChar().getName() + "』玩家成功兑换限时非洲之星聊天片戒指 随机10-80属性！"));
...
Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(12, cm.getClient().getChannel(), "限时活动" + " : " + "恭喜『" + cm.getChar().getName() + "』玩家成功重置限时非洲之星聊天戒指 随机10-80属性！"));
	cm.sendNext("#b重置提示:#r\r\n恭喜你重置成功！")
cm.dispose();
}else{
	var text = " 重置 活动戒指\r\n"
