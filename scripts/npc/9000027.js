...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
		   ...
		   text += " \t\t\t  #e#r #v3992025#  装备强化中心  #v3992025##k#n              \r\n"
            text += ""+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+"\r\n"
            text += "#d角色名称：#b" + cm.getName() + "#k#n\t\t  #d充值余额：#b" + cm.getmoneyb() + "#k#n\r\n"	
		
		var tex2 = ""+cm.getHyPay(1)+"";
            text += "#L1##r" + 蓝色角点 + "#r #v2613050#X卷轴强化 #r New     #l  \r\n"//3

            text += "#L2##r" + 蓝色角点 + "#r #v2046996#惊人卷轴强化 #r New     #l  \r\n"//3
			
			text += "#L3##r" + 蓝色角点 + "#r #v1122076#进阶龙王项链强化 #r New     #l  \r\n\r\n"//3

			
			//text += "#L6##r" + 蓝色角点 + "#r 购买~~ 金肝月卡 #rNew     #l \r\n\r\n"//3
