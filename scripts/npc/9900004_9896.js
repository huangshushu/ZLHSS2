...
var fbmc = "[法弗武器]-(觉醒系统)";//副本名称
var choose = 100;
var itempass = false;
var xnew = Array("开山裂地","撕天断海","斩星贯月","陨日破宇","鸿蒙创世","宇宙之心");
var xold = Array("","开山裂地","撕天断海","斩星贯月","陨日破宇","鸿蒙创世","宇宙之心");
var itemList = Array(1372177,1382208,1402196,1412135,1422140,1432167,1442223,1452205,1462193,1332225,1472214,1482168,1492179,1302275,1312153,1322203);
var costitem = 4310091;
var itemCount = Array(4,8,12,16,20,60);
var update = Array(25,35,50,70,90,120);
//////////////////////////////////////////////////////////
function start() {
status = -1;
action(1, 0, 0);
...
if (status == 0) {
	...
	cm.sendSimple (textz);   
		...
		if(selection == 0) {
			var string1 = "可以觉醒：#i"+1372177+"##i"+1432167+"##i"+1332225+"##i"+1302275+"#这样的武器\r\n"
		...
		if(itempass == false){
			cm.sendOk("只能觉醒#i"+1372177+"##i"+1432167+"##i"+1332225+"##i"+1302275+"#哟");
			cm.dispose();
			return;
		}
		...
		if(cm.haveItem(costitem, itemCount[choose])) { 
			...
			cm.全服黄色喇叭("[法弗武器觉醒] : 玩家["+cm.getPlayer().getName()+"]将[法弗纳武器]觉醒为["+xnew[choose]+"]！！！简直强炸天！！！");
