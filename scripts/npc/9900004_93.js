...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
		   ...
		   text += " \t\t#e#r #v4000422#  累计充值礼包中心  #v4000422##k#n              \r\n  #b#e\t \t  联系群主QQ：343432766#b#k\r\n\r\n"
		   text += "#r\t\t注：赞助比例1:2 再返点券1：400#k\r\n";
            text += ""+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+"\r\n"
            text += "#d\t  角色名称：#b" + cm.getName() + "\t\t#k#n   #d累计赞助：#b" + cm.读取累计赞助() + "#k#n\r\n"	
		
		var tex2 = ""+cm.getHyPay(1)+"";
          //  text += "#L6##r" + 蓝色角点 + " #r New 注：《购买GM #k可刷物品获得 #r礼包！》 #l\r\n"//3
			text += "#L20##r" + 蓝色角点 + " 赞助商店#r New  #v3994691# #l\r\n"
			text += "#L21##r" + 蓝色角点 + " 礼品商店#r New  #v3994691# #l\r\n"
            text += "#L1##r" + 蓝色角点 + " 累计充值#r New  #v3994691# #l\r\n"//3
			text += "#L2##r" + 蓝色角点 + " CDK兑换#r New  #v3994691# #l\r\n"//3
...
//text += ""+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n\r\n"
 if (cm.getPlayer().isGM()) {
       ...
       cm.dispose();
        ...
        } else if (selection == 20) {//充值介绍
			cm.dispose();
			cm.openNpc(9900004, 82);
		} else if (selection == 21) {//充值介绍
			cm.dispose();
