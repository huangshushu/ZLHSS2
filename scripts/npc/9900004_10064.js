		...
		if (a == -1) {
			...
			if (selection == 0) {
				...
				cm.dispose();
				 ...
				 else if (cm.haveItem(4002000, 15) && cm.haveItem(4002001, 15) && cm.haveItem(4002002, 15) && cm.haveItem(4002003, 15) && cm.haveItem(4031559, 15) && cm.getInventory(1).getItem(1).getOwner() == "") {
					...
					cm.全服公告("玩家：["+cm.getName()+"]成功强化邮票戒指为第一阶段！恭喜恭喜！");
					cm.dispose();
				} else {
