...
function action(mode, type, selection) {
  ...
  if (status == 0) {
    if (cm.getPlayerStat("LVL") >= 40) {
      cm.sendNext(
        "是啊...我是仙女的炼金大师。但是，仙女不应该在一个人的时间很长一段时间的接触......。如果你得到了我的资料，我会让你成为一个特殊的道具。"
      );
    } else {
      cm.sendOk(
        "我可以做出稀有，贵重物品，但不幸的是，我不能让它像你这样的陌生人。"
      );
      cm.dispose();
    }
  } else if (status == 1) {
    ...
    if (selection == 0) {
      ...
      cm.sendYesNo(
        "所以，你想要做" +
          item +
          "? 那么你需要的材料有: #b#t4021000##k, #b#t4021001##k, #b#t4021002##k, #b#t4021003##k, #b#t4021004##k, #b#t4021005##k, #b#t4021006##k, #b#t4021007##k 和 #b#t4021008##k. 然后还有 15,000 枫币"
      );
    } else if (selection == 2) {
      item = "黑羽毛";
      cm.sendYesNo(
        "所以，你想要做" +
          item +
          "? 那么你需要的材料有: #b1 #t4001006##k, #b1 #t4001007##k 和 #b1 #t4001008##k. 然后还有 30,000 枫币"
      );
    }
  } else if (status == 3) {
    if (selected == 0) {
