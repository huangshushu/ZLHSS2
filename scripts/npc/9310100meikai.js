...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#e#d皇家骑宠抽奖NPC欢迎您的光临！\r\n使用方法：抽取之后，请点击自己技能栏，新手技能栏有白雪人头像技能，使用技能查看抽取坐骑外贸，再次兑换变换其中，随机到自己喜欢的，就不必随机了，永久使用，下骑宠右键点击BUFF图标即可。\r\n#k注意：切勿坐上座骑使用抽取\r\n\r\n"//3
            text += "#L1##r抽取皇家坐骑 需求：#v4001215x1##l\r\n"//3
            text += "#L2##r购买#v4001215#1张   3000点券#l\r\n"//3
            text += "#L3##r购买#v4001215#10张  28000点券#l\r\n"//3
          //  text += "#L4##r购买#v4001215#100张 180000点券#l\r\n\r\n"//3
            cm.sendSimple(text);
        } else if (selection == 1) {
            ...
            cm.dispose();
			 ...
			 if (cm.canHold(4001215,1) && cm.getPlayer().getCSPoints(1) < 3000) { // Not Party Leader
                    cm.sendOk("你的点券不足2000点，请足够后再来");
                    cm.dispose();
                } else {
			cm.gainNX(-3000);
            cm.gainItem(4001215, 1);
            ...
            cm.dispose();
			 ...
			 if (cm.canHold(4001215,10) && cm.getPlayer().getCSPoints(1) < 28000) { // Not Party Leader
                    cm.sendOk("你的点券不足19000点，请足够后再来");
                    cm.dispose();
                } else {
			cm.gainNX(-28000);
            ...
            cm.dispose();
			 ...
			 if (cm.canHold(4001215,100) && cm.getPlayer().getCSPoints(1) < 180000) { // Not Party Leader
                    cm.sendOk("你的点券不足180000点，请足够后再来");
                    cm.dispose();
                } else {
			cm.gainNX(-180000);
