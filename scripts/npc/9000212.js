...
var EvName = ["ALM"]
/* 事件储存 */
var LogName = ["阿勒玛", "困难阿勒玛"]
/* 副本状态 */
var State = [true, true]
/* 开始地图 */
var starMap = 450001219
/* 等级限制 */
var MinLv = [230, 230]
var MaxLv = [300 ,300]
/* 挑战限制 */
...
var MaxPlayer = [6,6]
/* 道具限制 */
var ItemLimit = [[4310218, 1],[4310218, 2000]]//星缘纪念币
/* 副本等级 */
var Mob = 255
/* 破攻限制 */
var LimitBreak = [50*10000*10000, 250*10000*10000]

/* 副本奖励 */

var reward = [//奖励图鉴
              [4310217],
			  [2049389, 2430558,1332239,2614057,4032398,2435824]
			  ]
/* 变量值调用说明 0 = 副本Name  1 = 检测开始地图 2 = 道具限制 3 = 破攻限制  =VIP限制*/ 
var Basis = ["阿勒玛副本", true, true, true]
...
function action(mode, type, selection) {
    ...
    switch (status) {
        case 0:
            ...
            txt += "#d\t" + wi1 + " 副本道具限制 : #b" + (Basis[3] ? "#r需要:#b#z" + ItemLimit[Sel][0] + "#×" + ItemLimit[Sel][1] + "" : "#g不限制") + "#k#n\r\n";
            txt += "#d\t" + wi1 + " 副本破攻限制 : #b" + (Basis[3] ? "#r要求:#b" + LimitBreak[Sel] : "#g不限制") + "#k#n\r\n";
            txt += "#d\t" + wi1 + " 副本人数限制 : #b[ " + format(" ", 2, MinPlayer[Sel].toString()) + " ] - [ " + format(" ", 3, MaxPlayer[Sel].toString()) + " ]#k#n\r\n"
                ...
                if (next) {
                    ...
                    var prop = em.getProperty("state");
                        if (prop == null || prop.equals("0")) {
							...
							cm.worldSpouseMessage(0x15,"[副本消息]: "+ cm.getChar().getName() +" 带领他的队伍一起去挑战" + LogName[Sel] + " 了!!! ");//颜色消息
