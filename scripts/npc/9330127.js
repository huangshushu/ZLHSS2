...
function action(mode, type, selection) {
    ...
    if (status == 0) {
            var selStr = "\t\t\t#e欢迎使用月光岛翅膀进阶系统\r\n";
		selStr +="         #e#r#L0#"+cb+" 领取森林的低语#l  #n\r\n\r\n";		
		selStr +="          #e#r#L1#"+cb+" 森林的低语进阶#l#n\r\n\r\n";
		selStr +="          #e#r#L6#"+cb+" 进阶材料的出处#l#n\r\n\r\n";	
...
;
        ...
        switch (selection) {
        case 0:
	if (cm.getBossLog("领取森林的低语",1) == 0 && cm.getSpace(1) > 1) {
	    cm.gainItem(1102936, 1);
	    cm.setBossLog("领取森林的低语",1);
	    cm.worldSpouseMessage(0x20, "『进阶翅膀』 : 玩家 " + cm.getChar().getName() + " 领取了初阶段翅膀开启了进阶之路。");
	    cm.sendOk(" #b成功领取了初级翅膀一个。请妥善保管每次进阶的翅膀。每个人最多在我这里领取1次初级翅膀。");
            cm.dispose();
	} else {
