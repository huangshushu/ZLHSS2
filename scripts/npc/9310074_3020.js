...
var 金币 = 1000000;
var itemlist = Array(
	Array(1003112, 1003797, 1003976, 1004422),
	Array(1003112, 1003798, 1003976, 1004423),
	Array(1003112, 1003799, 1003976, 1004424),
	Array(1003112, 1003800, 1003976, 1004425),
	Array(1003112, 1003801, 1003976, 1004426)
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (a == -1) {
			...
			if (selection == 0) {
				cm.dispose();
				cm.openNpc(9310074,30201);
            }
			else if (selection == 1) {
				cm.dispose();
				cm.openNpc(9310074,30202);
            }
			else if (selection == 2) {
				cm.dispose();
				cm.openNpc(9310074,30203);
            }
			else if (selection == 3) {
				cm.dispose();
				cm.openNpc(9310074,30204);
            }
			else if (selection == 4) {
				cm.dispose();
				cm.openNpc(9310074,30205);
            }
			else if (selection == 5) {
				cm.dispose();
