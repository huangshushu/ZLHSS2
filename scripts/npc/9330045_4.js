...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
		   ...
		   text += " \t\t\t  #e#r #v1432039#  钓鱼兑换  #v1432039##k#n              \r\n"
            text += ""+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+"\r\n"
            text += "#d角色名称：#b" + cm.getName() + "#k#n\t\t  #d剩余金币：#b" + cm.getMeso() + "#k#n\r\n"	
		
		var tex2 = ""+cm.getHyPay(1)+"";
            text += "#L1##r" + 蓝色角点 + "#v4031644# X 5#r  兑换New     #v4000313# X5#l#l\r\n\r\n"//3
            text += "#L2##r" + 蓝色角点 + "#v4031645# X 20#r  兑换New     #v4251202##l#l\r\n\r\n"//3
            text += "#L3##r" + 蓝色角点 + "#v4031646# X 5#r  兑换New     #v5220000##l#l\r\n\r\n"//3
            text += "#L4##r" + 蓝色角点 + "#v4031647# X 66#r  兑换New     #v1112907#<全属12 G8>#l#l\r\n\r\n"//3
...
text += ""+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n\r\n"
 if (cm.getPlayer().isGM()) {
            ...
            cm.openNpc(9900004, 660);
        } else if (selection == 2) {//皇家班
            cm.openNpc(9900004, 661);
        } else if (selection == 3) {//皇家班
            cm.openNpc(9900004, 662);
        } else if (selection == 4) { //巨匠
            cm.openNpc(9900004, 663);
	} else if (selection == 5) {//法服呐
            cm.openNpc(9900004, 664);
