...
var txt;
var 价位 = 1000;
var 限制职业 =[["段",112,122,132,212,222,232,312,322,412,422,434,512,522,532,2112,2218,2712,1112,3112,3122,4112,5112,6112,1212,3212,4212,1312,2312,3312,1412,2412,572,1512,3512,3612,6512,6412,15212]];//允许的职业
var 道具 = [2438614];
var 检测 = false;
function start() {
    status = -1;
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            txt += "\t\t #L1#" + Icon[97][1] + " #n#b 段数BUFF药水" + Icon[97][1] + "#l#k\r\n\r\n";
            txt += "\t\t #L2#" + Icon[97][1] + " #n#d 隐身BUFF药水" + Icon[97][1] + "#l#k\r\n\r\n";
            txt += "\t\t #L3#" + Icon[97][1] + " #n#b 减伤BUFF药水" + Icon[97][1] + "#l#k\r\n";
            txt += "\r\n\r\n";
            txt += "　　 " + Icon[83][1] + " " + Icon[99][1] + " " + Icon[100][1] + " " + Icon[99][1] + " " + Icon[83][1];
            ...
            switch (selection) {
                ...
                case 2:
				cm.dispose();
				cm.openNpc(9201056,1);
                    return;
                    break;
                case 3:
                    cm.dispose();
                    cm.openNpc(9201056,2);
                        return;
                        break;
            }
        }
