...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.sendNextPrev("你可以选择你要转职成为一位 #r狂战士#k, #r见习骑士#k 或 #r枪骑兵#k.")
    } else if (status == 12) {
        cm.askAcceptDecline("但是我必须先测试你,你准备好了吗 ?");
    } else if (status == 13) {
        cm.gainItem(4031008, 1);
        cm.warp(102020300);
        cm.sendOk("请去找 #b剑士转职教官#k . 他会帮助你的.");
        cm.dispose();
    } else if (status == 21) {
