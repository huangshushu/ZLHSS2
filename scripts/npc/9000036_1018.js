...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			//text += "#b#v1112900##z1112900#*1（升级至四维800，攻魔400）\r\n"
			...
			text += "#b#v4170012##z4170012#*5\r\n"
			text += "#b#v2046913##z2046913#*5\r\n"
			text += "#b#v4001255##z4001255#*2\r\n"
			text += "#b#v4001245##z4001245#*2\r\n"
            cm.sendSimple(text);
        } else if (selection == 1) {

			if(cm.getzb() >= 7000 && cm.haveItem(1112949,1) && cm.getPlayer().getBossLog("7000赞助物品礼包",1) == 0 ){
				//cm.gainItem(1112900,-1);
				//cm.gainItem(1112900,800,800,800,800,0,0,400,400,0,0,0,0,0,0);//赞助戒指
				cm.gainItem(4310060,15);//进化石
				cm.gainItem(2028158,1);//随机公式箱子
				cm.gainItem(2028068,1);//暴君自选箱子
				...
				cm.gainItem(4170012,5);//必成卷兑换蛋
				cm.gainItem(2046913,5);//宿命正义自选
				cm.gainItem(4001255,2);//15星必成币
				cm.gainItem(4001245,2);//猪美美的金蛋
				
				cm.getPlayer().setBossLog("7000赞助物品礼包",1,1);
