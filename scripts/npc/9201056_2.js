...
var txt;
var 价位 = 1000;
var 限制职业 = [["减", 112,122,132,212,222,232,312,322,412,422,434,512,522,532,2112,2218,2712,1112,3112,3122,4112,5112,6112,1212,3212,4212,1312,2312,3312,1412,2412,572,1512,3512,3612,6512
]];//允许的职业
var 道具 = [2430489];
var 检测 = false;
function start() {
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            txt += "\t\t #L1#" + Icon[97][1] + " #n#b 减伤BUFF药水" + Icon[97][1] + "#l#k\r\n\r\n";
