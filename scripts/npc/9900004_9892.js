...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		if (cm.haveItem(4000002,50) && cm.haveItem(4000017,10)){
			...
			//cm.gainNX(100);//点卷
			cm.worldMessage(6,"玩家：["+cm.getName()+"]完成了每日收集任务1，获得：50W游戏币！");
			cm.getPlayer().setBossLog("每日跑商1");
			cm.getPlayer().setBossLog("每日跑商");
			
			cm.sendOk("完成了每日收集任务1，获得：50W游戏币！！！");
			cm.dispose();
		}else{
		...
		if (cm.haveItem(4000013,50) ){
			...
			cm.getPlayer().setBossLog("每日跑商");
			cm.worldMessage(6,"玩家：["+cm.getName()+"]完成了每日收集任务2，获得：50W游戏币！！！");
		...
		if (cm.haveItem(4000190,30) && cm.haveItem(4000191,30) ){
			...
			cm.gainMeso(+500000); //加减金币
			cm.getPlayer().setBossLog("每日跑商");
			cm.worldMessage(6,"玩家：["+cm.getName()+"]完成了每日收集任务3，获得：50W游戏币！！！");
		...
		if (cm.haveItem(4000043,50) ){
			...
			cm.gainMeso(+500000); //加减金币
			cm.getPlayer().setBossLog("每日跑商");
			cm.worldMessage(6,"玩家：["+cm.getName()+"]完成了每日收集任务4，获得：50W游戏币！！！");
		...
		if (cm.haveItem(4000165,20) && cm.haveItem(4000164,20)){
			...
			cm.gainMeso(+500000);
			cm.getPlayer().setBossLog("每日跑商");
			cm.worldMessage(6,"玩家：["+cm.getName()+"]完成了每日收集任务5，获得：50w游戏币！！");
		 ...
		 cm.dispose();
			...
			cm.gainMeso(+500000);
			cm.getPlayer().setBossLog("每日跑商");
			cm.worldMessage(6,"玩家：["+cm.getName()+"]完成了每日收集任务6，获得：50w游戏币！！");
		 ...
		 cm.dispose();
			...
			cm.getPlayer().setBossLog("每日跑商");
			cm.gainMeso(+500000);
			cm.worldMessage(6,"玩家：["+cm.getName()+"]完成了每日收集任务7，获得：50w游戏币！");
