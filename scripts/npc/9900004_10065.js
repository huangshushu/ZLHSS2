	...
	if (mode == -1) {
		...
		if (a == -1) {
			...
			if (selection == 0) {
				...
				cm.dispose();
			 ...
			 else	if (cm.haveItem(4002000, 30) && cm.haveItem(4002001, 30) && cm.haveItem(4002002, 30) && cm.haveItem(4002003, 30) && cm.haveItem(4031559, 30) && cm.getInventory(1).getItem(1).getOwner() == "第一阶段") {
					...
					cm.全服公告("玩家：["+cm.getName()+"]成功强化邮票戒指为第二阶段！恭喜恭喜！");
					cm.dispose();
				} else {
