...
function action(mode, type, selection) {
  ...
  if (selection == 0) {
    ...
    var 手套ID;
    if (手套 != null) 手套ID = 手套.getItemId();
    if (手套ID > 0) {
      txt2 += "\r\n#L10208#" + cm.显示物品(手套ID) + "#k#l";
    }
    var 披风 = inv.getItem(-9);
    var 披风ID;
    if (披风 != null) 披风ID = 披风.getItemId();
    if (披风ID > 0) {
    ...
    var 项链ID;
    if (项链 != null) 项链ID = 项链.getItemId();
    if (项链ID > 0) {
      txt2 += "\r\n#L10217#" + cm.显示物品(项链ID) + "#k#l";
    }
    var 腰带 = inv.getItem(-29);
    var 腰带ID;
    if (腰带 != null) 腰带ID = 腰带.getItemId();
    if (腰带ID > 0) {
