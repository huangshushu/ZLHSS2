...
var itemList = Array(
//Array(1012438, 2, 1, 1), //漩涡文身
//Array(1032224, 2, 1, 1), //漩涡耳环
//Array(1022211, 2, 1, 1), //漩涡眼镜
//Array(1122269, 2, 1, 1), //漩涡吊坠
//Array(1132247, 2, 1, 1), //漩涡腰带
//Array(1112794, 2, 1, 1), //终极戒指
Array(1302297, 2, 1, 1), //终极戒指
Array(1312173, 2, 1, 1), //终极戒指
Array(1322223, 2, 1, 1), //终极戒指
Array(1332247, 2, 1, 1), //终极戒指
Array(1382231, 2, 1, 1), //终极戒指
Array(1402220, 2, 1, 1), //终极戒指
Array(1412152, 2, 1, 1), //终极戒指
Array(1422158, 2, 1, 1), //终极戒指
Array(1432187, 2, 1, 1), //终极戒指
Array(1442242, 2, 1, 1), //终极戒指
Array(1452226, 2, 1, 1), //终极戒指
Array(1462213, 2, 1, 1), //终极戒指
Array(1472235, 2, 1, 1), //终极戒指
Array(1482189, 2, 1, 1), //终极戒指
Array(1492199, 2, 1, 1), //终极戒指

Array(4310100, 500, 1, 1), //漩涡兑换币
...
var str1 = "\r\n";	
           for (var i = 0; i < itemList.length; i++){
				...
				cm.sendYesNo(""+小烟花+"#r欢迎来到老虎BOSS箱子#v2028170#抽奖!\r\n\r\n"+小烟花+"#e以下是奖池内容的全部物品:\r\n\r\n" + str1);
			} else {
var str1 = "\r\n";	
           for (var i = 0; i < itemList.length; i++){
                   str1 += "#v"+itemList[i][0]+"#";
            }
				cm.sendOk(""+小烟花+"#r欢迎来到老虎BOSS箱子#v2028170#抽奖!\r\n\r\n"+小烟花+"#e以下是奖池内容的全部物品:\r\n\r\n" + str1);
				cm.dispose();
			}
		} else if (status == 1){	
        ...
        if (finalitem.length != 0) {
            ...
            item = cm.gainGachaponItem(itemId, quantity, "老虎BOSS箱子抽奖", notice);
            if (item != -500) {
			cm.gainItem(2028170, -1);//获得物品
