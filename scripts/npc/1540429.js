...
var 价位2 = 300000;
var 价位3 = 300000;
var 限制职业 = [["段", 112, 122,1412, 3312, 132, 434,532,2312,4112, 312, 232, 422, 2112, 2712, 3212, 3512 , 5112,  6112 , 2512]];//允许的职业
var 道具 = [2431582, 2431583, 2433559];
var 检测 = false;
function start() {
    status = -1;
    action(1, 0, 0);
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            txt += "\r\n\r\n";
            txt += "\t\t #L0#" + Icon[97][1] + " #r#e伴侣BUFF#n#b说明中心 " + Icon[97][1] + "#l#k\r\n\r\n";
            txt += "\t\t #L1#" + Icon[97][1] + " #r#e伴侣#n#b 增加段数BUFF药 " + Icon[97][1] + "#l#k\r\n\r\n";
            txt += "\t\t #L2#" + Icon[97][1] + " #r#e伴侣#n#b 减伤25% BUFF药 " + Icon[97][1] + "#l#k\r\n\r\n";
			//txt += "\t\t #L3#" + Icon[97][1] + " #r#e伴侣#n#b 吸血BUFF药 " + Icon[97][1] + "#l#k\r\n";
            txt += "\r\n\r\n";
            txt += "　　 " + Icon[83][1] + " " + Icon[99][1] + " " + Icon[100][1] + " " + Icon[99][1] + " " + Icon[83][1];
            ...
            switch (selection) {
                case 0:
                    ...
                    txt += "\t" + Icon[86][1] + " #g功能说明\r\n\r\n";
                    txt += "\t" + Icon[86][1] + " #b四转之后才可以购买，不是所有职业都可以使用\r\n";
                    txt += "\t" + Icon[86][1] + " #b段数药水：3000点卷，最多提升至15段 \r\n";
					txt += "\t" + Icon[86][1] + " #b减伤药水：30万点卷，减少受到的伤害25%\r\n";
                    txt += "\t\t\t\t\t　#L999#" + Icon[76][1] + "\r\n";
                ...
                case 1:
                    ...
                    break;
                case 2:
                    if (cm.getNX(1) < 价位2) { cm.playerMessage(1, "抱歉 - 你没有 " + 价位2 + " 点卷 不能购买这个药品r\n\r\n"); cm.dispose(); return; };
                    if (cm.getLevel() < 180) { cm.playerMessage(1, "抱歉 - 只有 180 级才可以使用这个功能r\n\r\n"); cm.dispose(); return; }
                    ...
                    break;
                case 3:
                    if (cm.getNX(1) < 价位3) { cm.playerMessage(1, "抱歉 - 你没有 " + 价位2 + " 点卷 不能购买这个药品r\n\r\n"); cm.dispose(); return; };
                    if (cm.getLevel() < 180) { cm.playerMessage(1, "抱歉 - 只有 180 级才可以使用这个功能r\n\r\n"); cm.dispose(); return; }
