...
var 金币 = 1000000;
var itemlist = Array(
	Array(1012173, 1012319),
	Array(1012319, 1012438)
    ...
    if (mode == -1) {
        ...
        if (a == -1) {
			...
			if (selection == 0) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1012173#放在装备栏#r第1格#b，#v1012319#放在#r第2格\r\n\r\n";
			text += "#b需要材料：#v4002000#*25，#v4002001#*25，#v4002002#*25，#v4002003#*25\r\n          #v4310143#*160，#v4251402#*15，#v4011007#*4，#v4011008#*4\r\n\r\n          金币*4000W\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 1) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1012319#放在装备栏#r第1格#b，#v1012438#放在#r第2格\r\n\r\n";
			text += "#b需要材料：#v4002000#*30，#v4002001#*30，#v4002002#*30，#v4002003#*30\r\n          #v4310143#*240，#v4251402#*20，#v4011007#*6，#v4011008#*6\r\n\r\n          金币*1E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 2) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1003976#放在装备栏#r第1格#b，#v1004422#放在#r第2格\r\n\r\n";
			...
			if (b == 1) {
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
				    ...
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1012173 || cm.getInventory(1).getItem(2).getItemId() != 1012319)  {
				...
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
		            cm.sendOk("#b请将神铸所需的装备放置在装备栏的#r第1、2格#b！");
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1012319 || cm.getInventory(1).getItem(2).getItemId() != 1012438)  {
		            cm.sendOk("#r第1、2格装备#r不符合要求，请仔细确认！");
				    cm.dispose();
				} else {
					var ItemID = cm.getInventory(1).getItem(1).getItemId();
				...
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
		            cm.sendOk("#b请将神铸所需的装备放置在装备栏的#r第1、2格#b！");
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1003976 || cm.getInventory(1).getItem(2).getItemId() != 1004422)  {
		            cm.sendOk("#r第1、2格装备#r不符合要求，请仔细确认！");
				    cm.dispose();
				} else {
					var ItemID = cm.getInventory(1).getItem(1).getItemId();
			...
			if (b == 1) {
				...
				if (cm.haveItem(4002000,25) && cm.haveItem(4002001,25) && cm.haveItem(4002002,25) && cm.haveItem(4002003,25) && cm.haveItem(4310143,160) && cm.haveItem(4251402,15) && cm.haveItem(4011007,4)  && cm.haveItem(4011008,4) && cm.getMeso() >= 40000000) {
					...
					Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(11,cm.getC().getChannel(),"装备神铸" + " : 恭喜" + cm.getPlayer().getName() +"成功将恐怖鬼娃的伤口神铸成八周年点点红，脸饰属性获得大幅提升，大家祝贺他/她！",true).getBytes());
		 		    cm.dispose();
				} else {
				...
				var 可砸次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
				var 星级 = cm.getInventory(1).getItem(1).getOwner();	
				if (cm.haveItem(4002000,30) && cm.haveItem(4002001,30) && cm.haveItem(4002002,30) && cm.haveItem(4002003,30) && cm.haveItem(4310143,240) && cm.haveItem(4251402,20) && cm.haveItem(4011007,6)  && cm.haveItem(4011008,6) && cm.getMeso() >= 100000000) {
					cm.gainItem(4002000,-25);
					cm.gainItem(4002001,-25);
					cm.gainItem(4002002,-25);
					cm.gainItem(4002003,-25);
					...
					Packages.server.MapleInventoryManipulator.addFromDrop(cm.getC(),equip,false,false);
		 		    cm.sendOk("#b恭喜你，装备神铸成功，战斗力又得到了进一步提升！");
					Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(11,cm.getC().getChannel(),"装备神铸" + " : 恭喜" + cm.getPlayer().getName() +"成功将八周年点点红神铸成漩涡文身，文身属性获得大幅提升，大家祝贺他/她！",true).getBytes());
		 		    cm.dispose();
				} else {
					cm.sendOk("#b很抱歉，你的材料不足，请仔细确认！");
					cm.dispose();
				...
				if (cm.haveItem(4000272,400) && cm.haveItem(4000082,60) && cm.haveItem(4310057,175) && cm.haveItem(4001129,175) && cm.haveItem(4250802,15) && cm.haveItem(4011007,3) && cm.haveItem(4011008,3) && cm.getMeso() >= 200000000) {
					...
					Packages.server.MapleInventoryManipulator.addFromDrop(cm.getC(),equip,false,false);
		 		    cm.sendOk("#b恭喜你，装备神铸成功，战斗力又得到了进一步提升！");
					Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(11,cm.getC().getChannel(),"装备神铸" + " : 恭喜" + cm.getPlayer().getName() +"成功将漩涡文身神铸成埃苏莱布斯文身，文身属性获得大幅提升，大家祝贺他/她！",true).getBytes());
		 		    cm.dispose();
				} else {
					cm.sendOk("#b很抱歉，你的材料不足，请仔细确认！");
					cm.dispose();
