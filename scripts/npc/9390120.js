...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            //text += "#L1##r" + 蓝色箭头 + "挑战【贝勒德】#g>>>>>>>>#b#v4251201#\r\n\r\n"//3
           // text += "#L2##r" + 蓝色箭头 + "挑战血焰将军#g>>>>>>#b#v4251201#\r\n\r\n"//3
         ...
         //   text += ""+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n"
          ...
          //  text += "#L6##d" + 红色箭头 + "制作#v4031497#1个\t需要：#v4000313#5个\r\n\r\n"//3
			...
			if(cm.haveItem(4251201,1)){ //物品条件
                            //cm.removeAll(4032398); 
                            cm.gainItem(4251201,-1);
			    cm.spawnMobOnMap(9390600,1,12,62,863000920);
		            //cm.summonMobter(9400633, 1);
                            //cm.summonMob(9400633,180000,5250,1);
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]开始挑战树心之王，【贝勒德】！");
			   cm.dispose();
		   }else{
			   cm.sendOk("需要搜集#b1个 #v4251201#");
			   cm.dispose();
		   }
...
cm.喇叭(2, "[" + cm.getPlayer().getName() + "]成功开始挑战绯红BOSS副本，召唤出一只【海之魔女】！！");
            ...
            if (!cm.canHold(4031497, 1)) {
                ...
                cm.dispose();
            } else if (cm.haveItem(4000313, 5)) {
                cm.gainItem(4000313,-5);
                cm.gainItem(4031497,1);
                cm.sendOk("恭喜你成功兑换#v4031497#X1个！");
                cm.dispose();
            } else {
                cm.sendOk("兑换失败，需要#v4000313#X5个！");
                cm.dispose();
            }
