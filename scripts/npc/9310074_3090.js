...
var 金币 = 1000000;
var itemlist = Array(
	Array(1082647, 1082543, 1082556, 1082636),
	Array(1082647, 1082544, 1082556, 1082637),
	Array(1082647, 1082545, 1082556, 1082638),
	Array(1082647, 1082546, 1082556, 1082639),
	Array(1082647, 1082547, 1082556, 1082640)
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (a == -1) {
			...
			if (selection == 0) {
				cm.dispose();
				cm.openNpc(9310074,30901);
            }
			else if (selection == 1) {
				cm.dispose();
				cm.openNpc(9310074,30902);
            }
			else if (selection == 2) {
				cm.dispose();
				cm.openNpc(9310074,30903);
            }
			else if (selection == 3) {
				cm.dispose();
				cm.openNpc(9310074,30904);
            }
			else if (selection == 4) {
				cm.dispose();
				cm.openNpc(9310074,30905);
            }
			else if (selection == 5) {
				cm.dispose();
