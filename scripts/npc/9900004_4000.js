...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += ""+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+"\r\n"
            text += "#d角色名称：#b" + cm.getName() + "#k#n\t\t  #d累计赞助：#b" + cm.读取累计赞助() + "#k#n\r\n"	
		...
		var tex2 = ""+cm.getHyPay(1)+"";
            ...
            text += "#L1##r" + 蓝色角点 + "#r 累计~~ 500元礼包#r New     #l  \r\n\r\n"//3
			...
			text += "#L10##r" + 蓝色角点 + "#r 累计~~ 20000元礼包 #rNew       #l \r\n\r\n"//3
			
			text += "#L11##r" + 蓝色角点 + "#r 累计~~ 25000元礼包 #rNew       #l \r\n\r\n"//3
			
			text += "#L12##r" + 蓝色角点 + "#r 累计~~ 30000元礼包 #rNew       #l \r\n\r\n"//3
			
			text += "#L13##r" + 蓝色角点 + "#r 累计~~ 40000元礼包 #rNew       #l \r\n\r\n"//3
			
			text += "#L14##r" + 蓝色角点 + "#r 累计~~ 50000元礼包 #rNew       #l \r\n\r\n"//3
			
			text += "#L15##r" + 蓝色角点 + "#r 累计~~ 60000元礼包 #rNew       #l \r\n\r\n"//3
...
text += ""+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n\r\n"
 if (cm.getPlayer().isGM()) {
		...
		cm.dispose();
            cm.openNpc(9900004, 7777);
        } else if (selection == 14) {//本服介绍
		cm.dispose();
            cm.openNpc(9900004, 7778);
        } else if (selection == 15) {//充值介绍
		cm.dispose();
            cm.openNpc(9900004, 7779);
        ...
        } else if (selection == 6666) {//cm.结束对话();
		cm.dispose();
