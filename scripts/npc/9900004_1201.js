...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
           ...
           // gsjb += "#L10##r[金币]#k 兑换 #v4021010#   -   (#r2000#k#kW = 1#b)#l\r\n";
            gsjb += "#L17##r快速搬砖 - #k#v4000000##v4000016##v4000010##v4000004##v4000011##v4000001##v4000003##v4000012##l\r\n";//#v4000000##v4000016#
            //gsjb += "#L12##b#v4001126#兑换[点卷]  #b比例 - (#r1 = 1#b)#l\r\n";
            gsjb += "#L13##b#v4000313#兑换[点券]  #b比例 - (#r1 = 20#b)#l\r\n";
			//gsjb += "#L24##b#v4002003#兑换[点券]  #b比例 - (#r1 = 30#b)#l\r\n";
			//gsjb += "#L25##b#v4002002#兑换[点券]  #b比例 - (#r1 = 30#b)#l\r\n";
            gsjb += "#L1##b#v4000040#兑换[金币]  #b比例 - (#r1 = 300000#b)#l\r\n";
            gsjb += "#L2##b#v4000176#兑换[金币]  #b比例 - (#r1 = 300000#b)#l\r\n";
            //gsjb += "#L11##b#v4001010#兑换[金币]  #b比例 - (#r1 = 30000#b)#l\r\n";
			...
			/*
            gsjb += "#L20##b#v4000000#兑换[金币]  #b比例 - (#r1 = 100#b)#l\r\n";
            gsjb += "#L21##b#v4000016#兑换[金币]  #b比例 - (#r1 = 100#b)#l\r\n";
            gsjb += "#L22##b#v4000010#兑换[金币]  #b比例 - (#r1 = 100#b)#l\r\n";
            gsjb += "#L23##b#v4000004#兑换[金币]  #b比例 - (#r1 = 100#b)#l\r\n";
            gsjb += "#L24##b#v4000011#兑换[金币]  #b比例 - (#r1 = 100#b)#l\r\n";
            gsjb += "#L25##b#v4000001#兑换[金币]  #b比例 - (#r1 = 100#b)#l\r\n";
            gsjb += "#L26##b#v4000003#兑换[金币]  #b比例 - (#r1 = 100#b)#l\r\n";
            gsjb += "#L27##b#v4000012#兑换[金币]  #b比例 - (#r1 = 100#b)#l\r\n";
			*/
            gsjb += "#L3##b#v4000235#兑换[金币]  #b比例 - (#r1 = 1000000#b)#l\r\n";
            gsjb += "#L4##b#v4000243#兑换[金币]  #b比例 - (#r1 = 1000000#b)#l\r\n";
            gsjb += "#L5##b#v4000175#兑换[金币]  #b比例 - (#r1 = 1000000#b)#l\r\n";
            gsjb += "#L6##b#v4000094#兑换[金币]  #b比例 - (#r1 = 400000#b)#l\r\n";
            gsjb += "#L7##b#v4000224#兑换[金币]  #b比例 - (#r1 = 1000000#b)#l\r\n";
            //gsjb += "#L8##b#v4000140#兑换[金币]  #b比例 - (#r1 = 2000000#b)#l\r\n";
            gsjb += "#L9##b#v4000138#兑换[金币]  #b比例 - (#r1 = 1000000#b)#l\r\n";
           ...
           cm.sendGetNumber("请输入数量:\r\n#b比例 - (#r1 = 1#b)\r\n  当前数量: #c4031196# 个#r \r\n", 1, 1, 100000 ); }
            ...
            if (beauty == 1) {
                ...
                if (cm.haveItem(4000235, selection)){
                    ...
                    cm.sendOk("兑换成功。 [#r"+selection+"#k] 兑换了:[#r"+(selection*1000000)+"#k] 金币。");
                     cm.gainMeso(+1000000* selection);
					cm.worldMessage(6,"玩家：["+cm.getName()+"]努力搬砖，在柯南那里兑换了："+(selection*1000000)+" 金币。");
					 cm.dispose();
                } else {
                    cm.sendOk("您的输入的数量错误，无法兑换。");
                    cm.dispose()
                ...
                if (cm.haveItem(4000094, selection)){
                    ...
                    cm.sendOk("兑换成功。 [#r"+selection+"#k] 兑换了:[#r"+(selection*40000)+"#k] 金币。");
                     cm.gainMeso(+40000* selection);
                ...
                if (cm.haveItem(4001126, selection)){
					...
					cm.gainNX(selection*2);	//加减点券
					//cm.gainDY(selection*2); //抵用券加减
					cm.getChar().UpdateCash();   //
                    cm.sendOk("兑换成功。 [#r"+selection+"#k]枫叶 兑换了:[#r"+(selection*2)+"#k] 点券");
					cm.worldMessage(6,"玩家：["+cm.getName()+"]努力搬砖，在柯南那里兑换了："+(selection*2)+" 点券");
					 cm.dispose();
                } else {
                    cm.sendOk("您的输入的数量错误，无法兑换。");
                    cm.dispose()
                ...
                if (cm.haveItem(4000313, selection)){
					...
					cm.gainNX(selection*20);	//加减点券
					//cm.gainDY(selection*2); //抵用券加减
					cm.getChar().UpdateCash();   //
                    cm.sendOk("兑换成功。 [#r"+selection+"#k]黄金枫叶 兑换了:[#r"+(selection*20)+"#k] 点券");
					cm.worldMessage(6,"玩家：["+cm.getName()+"]努力搬砖，在柯南那里兑换了："+(selection*20)+" 点券");
					 cm.dispose();
                } else {
                    cm.sendOk("您的输入的数量错误，无法兑换。");
                    cm.dispose()
                ...
                if (zliang > 0){
                    ...
                    cm.gainMeso(+2000*zliang);
                    cm.sendOk("兑换成功。共兑换了:[#r"+(zliang*2000)+"#k] 金币。");
					cm.worldMessage(6,"玩家：["+cm.getName()+"]努力搬砖，在柯南那里兑换了："+(zliang*2000)+" 金币。");
					cm.dispose();
                } else {
                ...
                if (cm.haveItem(4000000, selection)){
                     ...
                     cm.gainMeso(+2000* selection);
                    cm.sendOk("兑换成功。 [#r"+selection+"#k] 共兑换了:[#r"+(selection*2000)+"#k] 金币。");
					cm.worldMessage(6,"玩家：["+cm.getName()+"]努力搬砖，在柯南那里兑换了："+(selection*2000)+" 金币。");
					 cm.dispose();
                } else {
                    cm.sendOk("您的输入的数量错误，无法兑换。");
                    cm.dispose()
