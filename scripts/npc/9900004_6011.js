...
if (status == 0) {
var textz = "\r\n"
textz += "   \t\t\t   #e#d欢迎来到#r新手升星系统#k#r#n \r\n"
textz += "   #b   萌新记得好好看说明哦，内含升星系统详细介绍#k#n\r\n"
textz += "  #k         切记毕业装备不要使用该功能#k#n\r\n"
textz += "  #k         切记毕业装备不要使用该功能#k#n\r\n"
textz += "  #k         切记毕业装备不要使用该功能#k#n\r\n"
textz += "#L0##b" + 红色箭头 + "升星系统说明\r\n";
textz += "#L1##b" + 红色箭头 + "升级#e#b■#n#r新手强化★　　　　#e#b■" + 蓝色角点 + "  需要#v3992025#×10个#l\r\n";
textz += "#L2##b" + 红色箭头 + "升级#e#b■#n#r新手强化★★　　　#e#b■" + 蓝色角点 + "  需要#v3992025#×20个#l\r\n";
textz += "#L3##b" + 红色箭头 + "升级#e#b■#n#r新手强化★★★　　#e#b■" + 蓝色角点 + "  需要#v3992025#×30个#l\r\n";
textz += "#L4##b" + 红色箭头 + "升级#e#b■#n#r新手强化★★★★　#e#b■" + 蓝色角点 + "  需要#v3992025#×40个#l\r\n";
textz += "#L5##b" + 红色箭头 + "升级#e#b■#n#r新手强化★★★★★#e#b■" + 蓝色角点 + "  需要#v3992025#×50个#l\r\n";
//textz += "#L6##b" + 红色箭头 + "升级#e#b■#n#r★★★★★★#e#b■" + 蓝色角点 + "  需要#v3992025#×500个#l\r\n";
//textz += "#L7##b" + 红色箭头 + "升级#e#b■#n#r7★#e#b■" + 蓝色角点 + "  需要#v3992025#×600个#l\r\n";
...
var a=item.getItemId();
cm.serverNotice("『升星公告』：很遗憾【"+ cm.getChar().getName() +"】的装备升级失败降为【"+ cm.getChar().getInventory(Packages.client.inventory.MapleInventoryType.EQUIP).getItem(1).getOwner() +"】 战斗力大幅降低！");
        cm.sendOk("#e#b成功的将  #v"+a+"#降为至#r "+xnew5+"");
				//cm.sendOk("第七颗星升级失败");
        cm.dispose();
			}
     }else{
