var QuestName = "隐藏任务 -- 通缉猪猪";//任务ID
var Meso = 1000000;//奖励金币
var Exp = 1000000;//奖励经验
var ItemID = 4031456;//奖励道具ID
var QuestItemID = 4000178;//任务所需道具ID
var QuestItemNum = 1000;//任务所需道具数量
...
var status = 0;
	...
	if (status == 0) {
		...
		textz += " - 任务奖励道具100个：#v"+ItemID+"##z"+ItemID+"#\r\n\r\n";
		...
		cm.sendYesNo (textz);  
		   ...
		   if (cm.haveItem(QuestItemID,QuestItemNum) == false) {
                    ...
                    cm.gainItem(ItemID,100);//奖励道具ID，数量
					cm.gainExp(Exp);
					cm.gainMeso(Meso);
