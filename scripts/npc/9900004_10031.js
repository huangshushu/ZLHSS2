	...
	if (mode == -1) {
		...
		if (a == -1) {
			...
			if (selection == 0) {
		        ...
		        if(dmID!=1112907) {
		        cm.sendOk("把#v1112907#放在第一格!");	
				cm.dispose();				
				}
			 else	if (cm.haveItem(4031631, 20) && cm.haveItem(4031630, 20) && cm.haveItem(4031641, 20)&& cm.getInventory(1).getItem(1).getOwner() == "第一阶段") {
					...
					cm.gainItem(4031631, -20);
					cm.gainItem(4031641, -20);
					cm.gainItem(4031630, -20);
					cm.sendOk("强化成功，当前装备等级为 “#r第二阶段#k”。\r\n #r#e全属性增加[3]点");
					cm.全服公告("玩家：["+cm.getName()+"]成功强化小鱼戒指为第二阶段！恭喜恭喜！");
					cm.dispose();
