...
function start() {
 	if (cm.getBossLog("挑战副本44") > 2){
		...
		cm.dispose();
            ...
            cm.dispose();
	} else if (cm.getPlayerCount(108010201) > 0 && cm.getBossLog('挑战暴力熊44') < 3|| cm.getPlayerCount(108010201) > 0) {
...
function action(mode, type, selection) {
    var em = cm.getEventManager("huodong6");
    if (em == null) {
