...
var 金币 = 1000000;
var itemlist = Array(
	Array(1003112, 1003797),
	Array(1003797, 1003976),
	Array(1003976, 1004422)	
);
    ...
    if (mode == -1) {
        ...
        if (a == -1) {
			...
			if (selection == 0) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1003112#放在装备栏#r第1格#b，#v1003797#放在#r第2格\r\n\r\n";
			    text += "#b需要材料：#v4001080#*10，#v4001081#*10，#v4001082#*10\r\n          #v4000313#*400，#v4250802#*15，#v4011007#*4，#v4011008#*4\r\n\r\n          #v4310143#*160，金币*1E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 1) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1003797#放在装备栏#r第1格#b，#v1003976#放在#r第2格\r\n\r\n";
			    text += "#b需要材料：#v4001080#*15，#v4001081#*15，#v4001082#*15\r\n          #v4000313#*600，#v4250802#*20，#v4011007#*8，#v4011008#*8\r\n\r\n          #v4310143#*240，金币*2E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 2) {
			    ...
			    text += "#b需要材料：#v4001080#*20，#v4001081#*20，#v4001082#*20\r\n          #v4000313#*800，#v4250802#*30，#v4011007#*12，#v4011008#*12\r\n\r\n          #v4310143#*320，金币*3E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
		} else if (a == 2) {
			if (b == 1) {
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
				    ...
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1003112 || cm.getInventory(1).getItem(2).getItemId() != 1003797)  {
				...
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
		            cm.sendOk("#b请将神铸所需的装备放置在装备栏的#r第1、2格#b！");
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1003797 || cm.getInventory(1).getItem(2).getItemId() != 1003976)  {
		            cm.sendOk("#r第1、2格装备#r不符合要求，请仔细确认！");
				    cm.dispose();
				} else {
					var ItemID = cm.getInventory(1).getItem(1).getItemId();
			...
			if (b == 1) {
				...
				if (cm.haveItem(4001080,10) && cm.haveItem(4001081,10) && cm.haveItem(4001082,10) && cm.haveItem(4000313,400) && cm.haveItem(4250802,15) && cm.haveItem(4011007,4) && cm.haveItem(4011008,4)&& cm.haveItem(4310143,160) && cm.getMeso() >= 100000000) {
				...
				var 可砸次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
				var 星级 = cm.getInventory(1).getItem(1).getOwner();	
				if (cm.haveItem(4001080,15) && cm.haveItem(4001081,15) && cm.haveItem(4001082,15) && cm.haveItem(4000313,600) && cm.haveItem(4250802,20) && cm.haveItem(4011007,8) && cm.haveItem(4011008,8) && cm.haveItem(4310143,240)&& cm.getMeso() >= 200000000) {
				...
				var 可砸次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
				var 星级 = cm.getInventory(1).getItem(1).getOwner();	
				if (cm.haveItem(4001080,20) && cm.haveItem(4001081,20) && cm.haveItem(4001082,20) && cm.haveItem(4000313,800) && cm.haveItem(4250802,30) && cm.haveItem(4011007,12) && cm.haveItem(4011008,12) && cm.haveItem(4310143,320)&& cm.getMeso() >= 300000000) {
					cm.gainItem(4001080,-20);
					cm.gainItem(4001081,-20);
					cm.gainItem(4001082,-20);
					cm.gainItem(4000313,-800);
					cm.gainItem(4250802,-30);
