...
function action(mode, type, selection) {
    ...
    if (status == 0) {
            ...
            var   text = "#r使用5000点券就可以随机获得百宝箱里的礼物，快行动吧！\r\n#e#d" + 小烟花 + "任何建议，请联系管理，谢谢！" + 小烟花 + "#n#k\r\n\r\n";
        text += "#L1#" + 小烟花 +  "使用5000点券抽#r1#k次#l#L10"+"#" + 小烟花 + "使用50000点券抽#r10#k次\r\n\r\n";
        ...
        if (selection == 102) {
			...
			textItem += "\r\n";
            cm.sendOk("使用5000点券随机获得以下道具，快行动吧！\r\n#e#r任何建议，请联系管理，谢谢！#n#k\r\n" + textItem);
            status = -1;
            //cm.safeDispose();
