...
虎咆哮特效 = "#fString/SnailMS.img/旧技能展示/虎咆啸#";
轻舞飞扬特效 = "#fString/SnailMS.img/旧技能展示/轻舞飞扬#";
连环环破特效 = "#fString/SnailMS.img/旧技能展示/连环环破#";
圣灵之锤特效 = "#fString/SnailMS.img/旧技能展示/圣灵之锤#";
龙咆哮特效 = "#fString/SnailMS.img/旧技能展示/龙咆哮#";
枪连击特效1 = "#fString/SnailMS.img/旧技能展示/枪连击#";
火凤球特效 = "#fString/SnailMS.img/旧技能展示/火凤球#";
天降落星特效1 = "#fString/SnailMS.img/旧技能展示/天降落星#";
冰凤球特效 = "#fString/SnailMS.img/旧技能展示/冰凤球#";
落霜冰破特效 = "#fString/SnailMS.img/旧技能展示/落霜冰破#";
神圣祈祷特效 = "#fString/SnailMS.img/旧技能展示/神圣祈祷#";
圣光特效 = "#fString/SnailMS.img/旧技能展示/圣光#";
暴风箭雨特效 = "#fString/SnailMS.img/旧技能展示/暴风箭雨#";
射手飞龙冲击波特效 = "#fString/SnailMS.img/旧技能展示/飞龙冲击波#";
一击要害箭特效 = "#fString/SnailMS.img/旧技能展示/一击要害箭#";
穿透箭特效 = "#fString/SnailMS.img/旧技能展示/穿透箭#";
多重飞镖特效 = "#fString/SnailMS.img/旧技能展示/多重飞镖#";
忍者冲击特效1 = "#fString/SnailMS.img/旧技能展示/忍者冲击#";
天流血阐杀特效 = "#fString/SnailMS.img/旧技能展示/天流血阐杀#";
暗杀特效1 = "#fString/SnailMS.img/旧技能展示/暗杀#";
碎石乱击特效 = "#fString/SnailMS.img/旧技能展示/碎石乱击#";
潜龙出渊特效 = "#fString/SnailMS.img/旧技能展示/潜龙出渊#";
迷惑射击特效 = "#fString/SnailMS.img/旧技能展示/迷惑射击#";
金属风暴特效1 = "#fString/SnailMS.img/旧技能展示/金属风暴#";
三重重击特效 = "#fString/SnailMS.img/旧技能展示/三重重击#";
冰雪矛特效 = "#fString/SnailMS.img/旧技能展示/冰雪矛#";
落霜冰破特效 = "#fString/SnailMS.img/旧技能展示/落霜冰破#";
一出双击特效 = "#fString/SnailMS.img/旧技能展示/一出双击#";
巨熊咆哮特效 = "#fString/SnailMS.img/旧技能展示/巨熊咆哮#";
地毯式空袭特效 = "#fString/SnailMS.img/旧技能展示/地毯式空袭#";
