		...
		if (a == -1) {
			...
			if (selection == 0) {
				...
				cm.dispose();
				 ...
				 else if (cm.haveItem(4031630, 25) && cm.haveItem(4031631, 25) && cm.haveItem(4031641, 25)&& cm.getInventory(1).getItem(1).getOwner() == "第二阶段") {
					...
					cm.gainItem(4031630, -25);
					cm.gainItem(4031631, -25);
					cm.gainItem(4031641, -25);
					cm.sendOk("强化成功，当前装备等级为 “#r第三阶段#k”。\r\n #r#e全属性增加[3]点");
					cm.全服公告("玩家：["+cm.getName()+"]成功强化小鱼戒指为第三阶段！恭喜恭喜！");
					cm.dispose();
