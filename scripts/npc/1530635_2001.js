...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        txt = "\t\t　　　　#b #v4021007# #r#e制作中心#n#b #v4021007# #k\r\n";
        txt += Icon[41][1];
        for (var i = 0; i <= 59; i++) {
            txt += Icon[42][1];
        };
        ...
        txt += "　　　　　　#b在这里可以制作任何的属性道具#k\r\n";
        txt += "\t\t #L0#" + Icon[15][1] + " #d制作 #b140 #d级类型的#r 防具 " + Icon[15][1] + "#l#k\r\n\r\n";
        txt += "\t\t #L1#" + Icon[15][1] + " #d制作 #b140 #d级类型的#r 武器 " + Icon[15][1] + "#l#k\r\n\r\n";
        txt += "\t\t #L2#" + Icon[15][1] + " #d制作 #b150 #d级类型的#r 防具 " + Icon[15][1] + "#l#k\r\n\r\n";
        txt += "\t\t #L3#" + Icon[15][1] + " #d制作 #b150 #d级类型的#r 武器 " + Icon[15][1] + "#l#k\r\n\r\n";
        txt += Icon[41][1];
        for (var i = 0; i <= 59; i++) {
            txt += Icon[42][1];
        };
        ...
        switch (selection) {
            case 0:
                cm.dispose();
                cm.openNpc(2470018, "fensalifjzz");
                
                break;

            case 1:
                cm.dispose();
                cm.openNpc(2470018, "aisuliwqzz");
                break;

            case 2:
                cm.dispose();
                cm.openNpc(2470018, "fafufangjuzz");
                break;
                
            case 3:
                cm.dispose();
                cm.openNpc(2470018, "fafunazz");
                break;
        }
    }
}