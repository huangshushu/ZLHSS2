	...
	if (mode == -1) {
		...
		if (status == 0) {
			...
			cm.dispose();
		       ...
		       if (!cm.haveItem(4251302, 1) || cm.getMeso() <= 15000000)  {
		            cm.sendOk("#v4251302#或金币不足1500万!");
				    cm.dispose();
          } else if (cm.getBossLog("qianghua2") == 1){//每天一次
