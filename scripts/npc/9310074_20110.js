...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
            text += "        #L1#"+小烟花+"#r我要制作#v1442209#布莱克缤长矛"+小烟花+"#l\r\n\r\n\r\n";
			text += "#b需要材料：#v1442203#*1，#v4000270#*200，#v4000082#*10，#v4310057#*10\r\n          #v4000268#*200，#v4011007#*2，#v4011008#*2， #v4310143#*10\r\n\r\n         金币*1E\r\n";
            cm.sendSimple(text);
        } else if (selection == 1) {
			if (cm.getInventory(1).isFull()){
				...
				cm.sendOk("#b恭喜你，成功制作了#v1442209#，快去亮出的全新武器吧！");
				Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(12, cm.getClient().getChannel(), "布莱克缤武器制作" + " : " + "恭喜" + cm.getChar().getName() + "成功制作了布莱克缤长矛，战斗力又获得了进一步提升，大家恭喜他/她吧！"));
				cm.dispose();
			}
			else{
