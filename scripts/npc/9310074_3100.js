...
var 金币 = 1000000;
var itemlist = Array(
	Array(1132287, 1132174, 1132247, 1132246),
	Array(1132287, 1132175, 1132247, 1132246),
	Array(1132287, 1132176, 1132247, 1132246),
	Array(1132287, 1132177, 1132247, 1132246),
	Array(1132287, 1132178, 1132247, 1132246)
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (a == -1) {
			...
			if (selection == 0) {
				cm.dispose();
				cm.openNpc(9310074,31001);
            }
			else if (selection == 1) {
				cm.dispose();
				cm.openNpc(9310074,31002);
            }
			else if (selection == 2) {
				cm.dispose();
				cm.openNpc(9310074,31003);
            }
			else if (selection == 3) {
				cm.dispose();
				cm.openNpc(9310074,31004);
            }
			else if (selection == 4) {
				cm.dispose();
				cm.openNpc(9310074,31005);
            }
			else if (selection == 5) {
				cm.dispose();
