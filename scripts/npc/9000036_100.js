...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        selStr += "   #r#L0#"+小烟花+"100档奖励"+小烟花+"#l       #r#L1#"+小烟花+"200档奖励"+小烟花+"#l\r\n\r\n";
		selStr += "   #r#L2#"+小烟花+"500档奖励"+小烟花+"#l       #r#L3#"+小烟花+"1000档奖励"+小烟花+"#l\r\n\r\n";
		selStr += "   #r#L4#"+小烟花+"2000档奖励"+小烟花+"#l      #r#L5#"+小烟花+"4000档奖励"+小烟花+"#l\r\n\r\n";
		selStr += "   #r#L6#"+小烟花+"5000档奖励"+小烟花+"#l      #r#L7#"+小烟花+"7000档奖励"+小烟花+"#l\r\n\r\n";
		selStr += "   #r#L8#"+小烟花+"8000档奖励"+小烟花+"#l";     //#r#L9#"+小烟花+"15000档奖励"+小烟花+"#l\r\n\r\n
		//selStr += "   #r#L10#"+小烟花+"20000档奖励"+小烟花+"#l     //#r#L11#"+小烟花+"25000档奖励"+小烟花+"#l\r\n\r\n";
