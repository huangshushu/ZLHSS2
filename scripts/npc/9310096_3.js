...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
		var a0 = "          #L0#"+ 小烟花 +"#r#v1022231##z1022231#制作"+ 小烟花 +"#l\r\n\r\n                    #b需要材料如下#l\r\n\r\n   #v4001129#*150、#v4031456#*500、#v4000244#*30、#v4000245#*30、#v4001341#*60\r\n\r\n    #v4021010#*50、#v4251202#*20、#v4000463#*20、#v4011007#*6、#v4031138#1亿\r\n";
...
//		var a2 = "#L2#" + 正方箭头 + "#b制作外星碎片耳环#r#v1032191##z1032191##l\r\n\r\n需要#v1032142#*1、#v4001129#*200、#v4002000#*25、#v4002001#*25、#v4002002#*25、#v4002003#*25、#v4000125#*500、#v4000313#*500、#v4011008#*4、1500万游戏币来制作\r\n";
		...
		if (cm.haveItem(4001129,150)&&cm.haveItem(4031456,500)&&cm.haveItem(4000244,30)&&cm.haveItem(4000245,30)&&cm.haveItem(4001341,60)&&cm.haveItem(4021010,50)&&cm.haveItem(4251202,20)&&cm.haveItem(4000463,20)&&cm.haveItem(4011007,6)&& cm.getMeso() >=100000000) {
			cm.gainItem(4001129,-150);
			cm.gainItem(4031456,-500);
			cm.gainItem(4000244,-30);
			cm.gainItem(4000245,-30);
			cm.gainItem(4001341,-60);
			cm.gainItem(4021010,-50);
			cm.gainItem(4251202,-20);
			cm.gainItem(4000463,-20);
			cm.gainItem(4011007,-6);
			cm.gainMeso(-100000000);
			cm.gainItem(1022231,1);
			Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(11,cm.getC().getChannel(),"绚蓝水印脸饰制作" + " : " + cm.getPlayer().getName() +"玩家成功制作了绚蓝水印脸饰。O(∩_∩)O哈哈~",true).getBytes());
