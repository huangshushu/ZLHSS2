	...
	if (mode == -1) {
		...
		if (a == -1) {
			...
			if (selection == 0) {
				...
				cm.dispose();
			 ...
			 else	if (cm.haveItem(4005000, 20) && cm.haveItem(4005001, 20) && cm.haveItem(4005002, 20) && cm.haveItem(4005003, 20) && cm.getInventory(1).getItem(1).getOwner() == "第三阶段") {
					...
					cm.全服公告("玩家：["+cm.getName()+"]成功强化宝石戒指为满阶！恭喜恭喜！");
					cm.dispose();
				} else {
