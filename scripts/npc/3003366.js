        ...
        if (status == 0) {
            ...
            switch (selection) {
                case 0:
                    ...
                    txt += "\t" + Icon[86][1] + " #g功能说明\r\n\r\n";
                    txt += "\t" + Icon[86][1] + " #bARC 只能提升神秘徽章：阿尔卡那\r\n";
                ...
                case 1:
                    ...
                    if (检测) {
						...
						equip.setStr(equip.getStr() + 30);
						equip.setDex(equip.getDex() + 30);
						equip.setInt(equip.getInt() + 30);
						equip.setLuk(equip.getLuk() + 30);
						//equip.setSpeed(equip.getSpeed() + 1000);
                        cm.removeSlot(1, 1, 1);
                        cm.addFromDrop(cm.getC(), equip, true);
                        cm.playerMessage(1, "ARC + 10，提升成功。");
                        cm.dispose();
                        return;
                    } else {
                        txt = "　　 " + Icon[83][1] + " " + Icon[99][1] + " " + Icon[100][1] + " " + Icon[99][1] + " " + Icon[83][1] + "\r\n";
