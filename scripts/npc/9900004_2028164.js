...
Array(1402196,2028164,1,1), //25
Array(1432167,2028164,1,1), //25
Array(1472214,2028164,1,1), //25
Array(1382208,2028164,1,1), //25
Array(1452205,2028164,1,1), //25
Array(1462193,2028164,1,1), //25
Array(1492179,2028164,1,1), //25
Array(1332225,2028164,1,1), //25
Array(1442223,2028164,1,1), //25
Array(1302275,2028164,1,1), //25
Array(1482168,2028164,1,1), //25
Array(1312153,2028164,1,1), //25
Array(1322203,2028164,1,1) //25
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            sl = cm.getPlayer().getItemQuantity(2028164, false);
            StringS = "#b#n   角色剩余:" + sl + " 个#v2028164#（请保证背包有空间，否则会消失）";
