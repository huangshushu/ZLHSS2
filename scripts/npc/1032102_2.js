    ...
    if (status == 0) {
      ...
      if (selection == 0) {
        ...
        if (pet == null || !cm.haveItem(5380000, 1)) {
          cm.sendOk(
            "您没有 #i5380000##t5380000#, 然后，宠物等级15级后我再告诉您怎么做。"
          );
          cm.dispose();
        } else {
        ...
        if (
          cm.haveItem(4031274, 1) &&
          cm.haveItem(4031275, 1) &&
          cm.haveItem(4031276, 1) &&
          cm.haveItem(4031277, 1) &&
          cm.haveItem(4031278, 1)
        ) {
          ...
          cm.sendOk(
            "我需要#i4031274# x1、#i4031275# x1 、 #i4031276# x1 、 #i4031277# x1 、 #i4031278# 麻烦准备好再来找我。"
          );
          cm.dispose();
        }
      } else if (selection == 2) {
        ...
        for (var i = 0; i <= inv.getSlotLimit(); i++) {
          ...
          /* 					if(it != null){
						cm.playerMessage(6, "getItemId:" + it.getItemId() + "getExpiration:" + it.getExpiration() + "getCurrentTime:" + cm.getCurrentTime());
					} */
        }
      ...
      if (theitems.length <= 0) {
        ...
        cm.sendOk("我需要 #i5180000#.");
      } else {
        cm.gainItem(5180000, -1);
        theitems[selection].setExpiration(
          cm.getCurrentTime() + 45 * 24 * 60 * 60 * 1000
        );
        cm.getPlayer().dropMessage(1, "你的宠物已延长45天寿命 请好好对待它");
