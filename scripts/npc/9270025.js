...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            var txt = "";
            txt = "#r" + 玫瑰 + "这里是女神每日福利礼包中心" + 玫瑰 + "#k\r\n\r\n";

        if ( cm.getPlayer().getBossLog("meitianrenwu3") == 1){
				txt += "#r" + 桃花 + "你今天已经领过了,请明天在来吧!!!!" + 桃花 + "#k\r\n\r\n";
                cm.sendOk(txt);
                cm.dispose();

            }else{
                txt += "#L1##d" + 桃花 + "请把女神勋章放入背包领取每日福利#v1142574##k\r\n\r\n";
                cm.sendSimple(txt);
            }
            ...
            if (cm.haveItem(1142574,1) ){
                ...
                cm.sendOk("恭喜您获得了#v4000463#*20  #v2340000#*1  #v2049100#*1!");
                ...
                cm.dispose();
		    cm.全服公告("恭喜[" + cm.getPlayer().getName() + "]领取了女神每日福利！！");
            cm.dispose();
			}else{
            cm.sendOk("道具不足无法换购！");
            cm.dispose();
