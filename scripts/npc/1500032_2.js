...
function action(mode, type, selection) {
    ...
    if (status == 0) {
            var selStr = "#d把勋章取下放背包，请选择当前需要晋级的军衔：#n#k\r\n";
		selStr +="#e#r#L0#"+zs1+"晋级到『团长军衔』全属性+25#l#n\r\n\r\n";
		selStr +="#e#r#L1#"+zs1+"晋级到『旅长军衔』全属性+50#l#n\r\n\r\n";
		selStr +="#e#r#L2#"+zs1+"晋级到『师长军衔』全属性+75#l#n\r\n\r\n";
		selStr +="#e#r#L3#"+zs1+"晋级到『军长军衔』全属性+100#l#n\r\n\r\n";;
        cm.sendSimple(selStr);
    } else if (status == 1) {
        switch (selection) {
        case 0:
            cm.dispose();
            cm.openNpc(1500032,4);
            break;
        case 1:
            cm.dispose();
            cm.openNpc(1500032,5);
            break;
        case 2:
            cm.dispose();
            cm.openNpc(1500032,6);
            break;
        case 3:
            cm.dispose();
            cm.openNpc(1500032,7);
            break;
        }
    }
}
