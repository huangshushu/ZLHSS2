...
var 金币 = 1000000;
var itemlist = Array(
	Array(1132287, 1132175),
	Array(1132175, 1132247),
    ...
    if (mode == -1) {
        ...
        if (a == -1) {
			...
			if (selection == 0) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1132287#放在装备栏#r第1格#b，#v1132175#放在#r第2格\r\n\r\n";
		    	text += "#b需要材料：#v4031227#*10，#v4002002#*25\r\n          #v4000487#*300，#v4250902#*10，#v4011007#*2，#v4011008#*2\r\n          #v4310143#*120，金币*5000W\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 1) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1132175#放在装备栏#r第1格#b，#v1132247#放在#r第2格\r\n\r\n";
		    	text += "#b需要材料：#v4031227#*15，#v4002002#*30\r\n          #v4000487#*300，#v4250902#*15，#v4011007#*4，#v4011008#*4\r\n          #v4310143#*160，金币*1E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 2) {
			...
			if (b == 1) {
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
				    ...
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1132287 || cm.getInventory(1).getItem(2).getItemId() != 1132175)  {
				...
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
		            cm.sendOk("#b请将神铸所需的装备放置在装备栏的#r第1、2格#b！");
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1132175 || cm.getInventory(1).getItem(2).getItemId() != 1132247)  {
		            cm.sendOk("#r第1、2格装备#r不符合要求，请仔细确认！");
				    cm.dispose();
				} else {
					var ItemID = cm.getInventory(1).getItem(1).getItemId();
			...
			if (b == 1) {
				...
				if (cm.haveItem(4031227,10) && cm.haveItem(4002002,25) && cm.haveItem(4000487,300) && cm.haveItem(4250902,10) && cm.haveItem(4011007,2) && cm.haveItem(4011008,2) && cm.haveItem(4310143,120) && cm.getMeso() >= 50000000) {
				...
				var 可砸次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
				var 星级 = cm.getInventory(1).getItem(1).getOwner();	
				if (cm.haveItem(4031227,15) && cm.haveItem(4002002,30) && cm.haveItem(4000487,300) && cm.haveItem(4250902,15) && cm.haveItem(4011007,4) && cm.haveItem(4011008,4) && cm.haveItem(4310143,160) && cm.getMeso() >= 100000000) {
				...
				var 可砸次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
				var 星级 = cm.getInventory(1).getItem(1).getOwner();	
				if (cm.haveItem(4031227,20) && cm.haveItem(4002002,40) && cm.haveItem(4000487,300) && cm.haveItem(4250902,20) && cm.haveItem(4011007,5) && cm.haveItem(4011008,5) && cm.haveItem(4310143,200) && cm.getMeso() >= 150000000) {
