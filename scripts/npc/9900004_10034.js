...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		var tex2 = ""+cm.getHyPay(1)+"";
            ...
            text += "#r#L1##v1112907#升为1阶全属性+3需要\r\n  #k#v4031641#15#v4031630#15#v4031631#15#l\r\n\r\n"//3
			text += "#r#L2##v1112907#升为2阶全属性+3需要\r\n  #k#v4031641#20#v4031630#20#v4031631#20#l\r\n\r\n"//3#l\r\n"//3
			text += "#r#L3##v1112907#升为3阶全属性+3需要\r\n  #k#v4031641#25#v4031630#25#v4031631#25#l\r\n\r\n"//3 4031630 31 33
			text += "#r#L4##v1112907#升为满阶全属性+3需要\r\n #k#v4031641#35#v4031630#35#v4031631#35#l\r\n\r\n"//3 4031630 31 33

text += "\r\n"+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n\r\n"
		    cm.sendSimple(text);
        } else if (selection == 1) {//贝勒制作
            cm.openNpc(9900004, 10013);
		} else if (selection == 2) {//贝勒制作
            cm.openNpc(9900004, 10031);
		} else if (selection == 3) {//贝勒制作
            cm.openNpc(9900004, 10032);
		} else if (selection == 4) {//贝勒制作
            cm.openNpc(9900004, 10033);
