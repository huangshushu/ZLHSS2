...
var itemList = Array(
        ...
        Array(2022251, 840, 4, 0), //枫叶棒棒糖
        Array(2022245, 880, 4, 0), //心跳停止糖
        Array(2022220, 860, 1, 0), //拉图斯的御守
        Array(2022216, 860, 1, 0), //菇菇宝贝的御守
        Array(2022217, 860, 1, 0), //残暴炎魔的御守	
        Array(1102033, 780, 1, 0), //红龙纹披风
        Array(1102034, 780, 1, 0), //蓝龙纹披风
        Array(1102035, 780, 1, 0), //黑龙纹披风
        ...
        Array(1452167, 100, 1, 1), //金刚不坏小鸡
        Array(1004096, 120, 1, 1), //新春舞狮(头)
        Array(1032129, 100, 1, 1), //许愿树传说耳环
        Array(1112672, 80, 1, 1), //传说枫叶银之戒
        Array(1142698, 120, 1, 1), //新年目标王
        Array(1003114, 60, 1, 1), //神龙头盔
        Array(1102248, 50, 1, 1), //神龙披风
        Array(1012170, 20, 1, 1), //鬼娃恰吉的伤口
		Array(1012171, 10, 1, 1), //鬼娃恰吉的伤口
        Array(3010755, 120, 1, 1), //天鹅便桶
        Array(3010756, 120, 1, 1), //饭桶招财猫
        Array(3010608, 100, 1, 1), //名画椅子
        Array(3010593, 100, 1, 1), //小姐小姐新年到～
        Array(3010622, 100, 1, 1), //我的好友丹金椅
        Array(3010624, 120, 1, 1), //电视椅
        Array(3010642, 100, 1, 1), //重新上色的画
        Array(3010664, 100, 1, 1), //进化椅子
        Array(3010675, 100, 1, 1), //斑斑的愤怒
        Array(3010682, 100, 1, 1), //天文台椅子
        Array(3010601, 120, 1, 1), //黑猫篮椅
        Array(3010688, 120, 1, 1), //实验室椅子
        Array(3010716, 120, 1, 1), //超级菇菇椅子
        Array(3010721, 120, 1, 1), //漫画书椅子
        Array(3010722, 120, 1, 1), //僵尸狩猎者椅子
        Array(3010609, 120, 1, 1), //时尚潮男椅
        Array(3010757, 80, 1, 1), //你跟我
        Array(3010754, 120, 1, 1), //百鬼夜行
        Array(3010766, 120, 1, 1), //尖耳木椅
        Array(3010799, 80, 1, 1), //坟墓椅
        Array(3010810, 100, 1, 1), //火车旅行椅子
        Array(3010863, 100, 1, 1), //愤怒的美容院椅子
        Array(3015331, 80, 1, 1), //猫咪纸屋
        Array(1322001, 100, 1, 1), //槌子
        Array(1322006, 100, 1, 1), //钢管
        Array(1142374, 100, 1, 1), //圣诞奇蹟
