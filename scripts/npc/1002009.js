...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		//text += z6 + z6 + z6 + z6 + z6 + z6 + z6 + z6 + z6 + z6 + z6 + z6 + z6 + z6 + z6 + z6 + z6 + z6 + z6 +z6+z6+ "\r\n";
        text += "#L0#" + bb + " #k开锁之王#b        <大量点卷>       #r[每日无限]#b#l"
        text += "\r\n#L19#" + bb + " #k打倒帝国主义#b   <资源ROLL点>      #r[每日一次]#b#l"
		text += "\r\n#L555#" + bb + " #k神话副本#b       <资源ROLL点>      #r[每日必做]#b#l"
		text += "\r\n#L14#" + bb + " #k骑宠活动#b        <炫酷坐骑>       #r[每日一次]#b#l"
		text += "\r\n#L7#" + bb + " #kXO问答活动#b      <各种卷轴>       #r[2 4 6开启]#b#l"
		text += "\r\n#L11#" + bb + " #k家族跑旗#b        <奖励丰富>       #r[活动开启]#b#l"
		//text += "\r\n#L15#" + bb + " #k野外BOSS#b        <童年记忆>       #r[经典怀旧]#b#l"
                text += "\r\n#L2#" + bb + " #k射手跳跳#b        <纯属娱乐>       #r[经典怀旧]#b#l"
		text += "\r\n#L18#" + bb + " #k玩具跳跳#b        <纯属娱乐>       #r[经典怀旧]#b#l"
		//text += "\r\n#L16#" + bb + " #k忍苦跳跳#b        <纯属娱乐>       #r[经典怀旧]#b#l"
		text += "\r\n#L17#" + bb + " #k火山跳跳#b        <纯属娱乐>       #r[经典怀旧]#b#l"

        //text += "\r\n#L3#" + bb + " #kPK#b <抵用券、游戏币>      #r[每日十次]#b#l"
		...
		text += "\r\n#L13#" + bb + " #k手速红包#b        <抢红包咯>       #r[ GM开启 ]#b#l"
		//text += "\r\n#L16#" + bb + " #k攻城中心#b <徽章、箱子、点卷>      #r[每日开启]#b#l"
        ...
        if (selection == 0) {
            ...
            cm.dispose();
            cm.openNpc(2084001,"阿斯旺组队口");	
        } else if (selection == 16) {
            cm.dispose();
            cm.openNpc(2084001,"攻城中心");
        } else if (selection == 2) {
            cm.dispose();
            cm.warp(100000202)
		} else if (selection == 16) {
