...
var 装备列表 = Array(//ID、前缀、攻击、魔攻、力量、敏捷、智力、运气、物防、魔防、命中、回避、速度、跳跃、可升级次数
	Array(1102109, "一阶段", 1, 1, 1, 1, 1, 1, 10, 10, 0, 0, 0, 0, 7),
	Array(1102248, "二阶段", 3, 3, 3, 3, 3, 3, 30, 30, 0, 0, 0, 0, 7),
	Array(1102227, "三阶段", 6, 6, 6, 6, 6, 6, 60, 60, 0, 0, 0, 0, 7),
	Array(1102394, "满阶段", 10, 10, 10, 10, 10, 10, 100, 100, 0, 0, 0, 0, 7),
	Array(1102506, "史诗", 15, 15, 15, 15, 15, 15, 150, 150, 0, 0, 0, 0, 7),
	Array(1102828, "传说", 23, 23, 23, 23, 23, 23, 230, 230, 0, 0, 0, 0, 7)
);
