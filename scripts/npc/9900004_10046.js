...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		var tex2 = ""+cm.getHyPay(1)+"";
            ...
            text += "#L1##v1142358#升为1阶全属性+3需要\r\n#v4000019#x150#v4000016#x150#v4000000#x150+1000点券+2000抵用券+20W金币#l\r\n"//3
			text += "#L2##v1142358#升为2阶全属性+3需要\r\n#v4000019#x300#v4000016#x300#v4000000#x300+2000点券+4000抵用券+50W金币#l\r\n"//3
			text += "#L3##v1142358#升为3阶全属性+3需要\r\n#v4000019#x450#v4000016#x450#v4000000#x450+3000点券+6000抵用券+70W金币#l\r\n"//3
			text += "#L4##v1142358#升为满阶全属性+3需要\r\n#v4000019#x600#v4000016#x600#v4000000#x600+4000点券+8000抵用券+100W金币#l\r\n"//3
