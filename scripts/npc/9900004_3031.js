var weapon = [1132178, 1132177, 1132176, 1132175, 1132174, 1102485, 1102484, 1102483, 1102482, 1102481,1082547,1082546,1082545,1082544,1082543,1072747,1072746,1072745,1072744,1072743];
var req = [
    [4000313, 3000],
	[4000464, 50],
    [4310058, 100],
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        cm.sendSimple("#r          #v1302065# 这里可以合成暴君防具 #v1302065#\r\n 确定要合成吗？\r\n" + msg + "")
    } else if (status == 1) {
        sels = selection;
