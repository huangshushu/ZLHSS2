...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		var tex2 = ""+cm.getHyPay(1)+"";
            text += "#L1##r" + 蓝色角点 + "#r 领取~~ 累计赞助100  #s4111006##r New     #l  \r\n"//3

            text += "#L2##r" + 蓝色角点 + "#r 领取~~ 累计赞助300  #s2311003##r New     #l  \r\n"//3

            text += "#L3##r" + 蓝色角点 + "#r 领取~~ 累计赞助500  #s2101002##r New     #l  \r\n"//3

            text += "#L4##r" + 蓝色角点 + "#r 领取~~ 累计赞助1000  #s1121002##r New     #l  \r\n"//3

            text += "#L5##r" + 蓝色角点 + "#r 领取~~ 累计赞助3000  #s3121002##r New     #l  \r\n"//3
			
			text += "#L6##r" + 蓝色角点 + "#r 领取~~ 累计赞助5000  #s4111002##s4121007##r New     #l \r\n"//3
			
			text += "#L7##r" + 蓝色角点 + "#r 领取~~ 累计赞助10000  #s9001006##r 全屏范围 无消耗New     #l  \r\n\r\n"//3
