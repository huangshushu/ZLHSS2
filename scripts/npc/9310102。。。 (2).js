...
function action(mode, type, selection) {
    ...
    if (status == -1) {
        cm.sendSimple("你好~如果您有兴趣制作你的武器，你肯定会来对地方了！我在这个伟大的神木村最好武器制造商。好了，你怎么想的武器，是充满了龙的不可思议的力量？你有兴趣吗？\r\n#L0# 我想制作一个革命武器。#l");
    } else if (status == 0) {
        if (selection == 0) {
            if (cm.haveItem(4001079)) {
                ...
                var options = new Array("什么是催化剂?", "做一个革命武器"
                        );
        ...
        if (selectedType == 1) { //warrior weapon
            ...
            var matSet = new Array(new Array(4000244, 4000245, 4005000), 
