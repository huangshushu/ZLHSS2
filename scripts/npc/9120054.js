...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#L1##r" + 蓝色箭头 + "挑战猎魔人#g>>>>>>>>#b#v4440000#出处\r\n\r\n"//3
            text += "#L2##r" + 蓝色箭头 + "挑战血焰将军#g>>>>>>#b#v4441000#出处\r\n\r\n"//3
            text += "#L3##r" + 蓝色箭头 + "挑战地狱船长#g>>>>>>#b#v4442000#出处\r\n\r\n"//3
            text += "#L4##r" + 蓝色箭头 + "挑战海之魔女#g>>>>>>#b#v4443000#出处\r\n\r\n"//3
            text += "#L5##r" + 蓝色箭头 + "送我离开\r\n\r\n"//3
            text += ""+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n"
            text += ""+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+"\r\n"
            text += "#L6##d" + 红色箭头 + "制作#v4031497#1个\t需要：#v5200002# 200W\r\n\r\n"//3
            text += "#L7##d" + 红色箭头 + "制作#v4031497#10个\t需要：#v5200002# 1800W\r\n\r\n"//3
            text += ""+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+星星+"\r\n"
            cm.sendSimple(text);
			...
			if(cm.haveItem(4031497,1)){ //物品条件
			   ...
			   // cm.spawnMobOnMap(9400592,1,1940,276,803001200);
                           cm.指定地图召唤怪物(9400592, 803001200, 1940, 276);
...
cm.worldMessage(6,"玩家：["+cm.getName()+"]成功开始挑战绯红BOSS副本，召唤出一只【猎魔人】！！");
			...
			if(cm.haveItem(4031497,1)){ //物品条件
			 ...
			 //   cm.spawnMobOnMap(9400591,1,1940,276,803001200);
                     cm.指定地图召唤怪物(9400591, 803001200, 1940, 276);
...
cm.指定地图召唤怪物(9400589, 803001200, 1940, 276);
...
cm.指定地图召唤怪物(9400590, 803001200, 1940, 276);
