function action(mode, type, selection) {
	...
	case 261000011:
		...
		cm.sendOk("请找队长来和我谈。\r\n您当前累计通关：#r"+cm.getBossRankCount('男女副本总次数')+"#k次\r\n您当前带新通关：#r"+cm.getBossRankCount('越级男女副本总次数')+"#k次");
	    } else {
		...
		if (next && (cm.getPlayer().isGM() || size >= 4)) {
			...
			if (prop == null || prop.equals("0")) {
				...
				cm.sendOk("其他队伍正在挑战，请使用其他频道!");
                   }
		} else {
			cm.sendOk("请你的队员大于4个人(含)都要50等以上(含)255等以下(255也可)都要在这张地图再来找我");
		}
	    }
	    break;
	case 926100000:
