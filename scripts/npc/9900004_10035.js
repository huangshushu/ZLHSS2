	...
	if (mode == -1) {
		...
		if (a == -1) {
			...
			if (selection == 0) {
				...
				cm.dispose();
			 ...
			 else	if (cm.haveItem(4000019, 300) && cm.haveItem(4000016, 300) && cm.haveItem(4000000, 300) && cm.getPlayer().getNX() > 3000  && cm.getPlayer().getCSPoints(2) > 6000  && cm.getPlayer().getMeso() > 700000 &&cm.getInventory(1).getItem(1).getOwner() == "第一阶段") {
					...
					cm.全服公告("玩家：["+cm.getName()+"]成功强化新手勋章为第二阶段！恭喜恭喜！");
					cm.dispose();
