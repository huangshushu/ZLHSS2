...
//fction action(mode, type, selection) {
			if (mode == -1) {
                cm.dispose();
            }else {
                if (status >= 0 && mode == 0) {
		...
		//if (status == 0) {
			...
			if(selection==3){
				...
				selText += "#L1# 换取(国庆X5 BOSS币X5 混沌X2 )(需要答对题目68道)#l\r\n";
				selText += "#L2# 换取答题(混沌祝福 国庆币 余额 50 )(需要答对题目88道)#l\r\n\r\n";
			...
			if(typed==2){
				if(selection==1){//4031470
					if (cm.getBossLog("答题68兑换") < 1){
						...
						cm.gainItem(4000463, 25);//天璇
						cm.gainItem(4310038, 5);//天璇
						cm.gainItem(2049100, 2);//祝福卷
						cm.setBossLog("答题68兑换");
						cm.sendOk("恭喜，您使用正确答题数目兑换了#i4000463#x5,#i4310038#x5,#i2049100#x2.");
						cm.喇叭(1,"[限时答题]:恭喜["+ cm.getChar().getName() +"]用正确答题数目68题兑换了混沌 祝福 国庆币~");
					} else {
						...
						cm.gainItem(4000463, 5);//天璇
						cm.gainItem(4310038, 5);//天璇
						cm.gainItem(2049100, 2);//祝福卷
										cm.setmoneyb(50);//奖励元宝
						cm.setBossLog("答题88兑换");
						cm.sendOk("恭喜，您使用正确答题数目兑换了#i1142767#x1.");
						cm.喇叭(1,"[限时答题]:恭喜["+ cm.getChar().getName() +"]用正确答题数目88题兑换了混沌 祝福 国庆币 50余额~");
					} else {
						cm.sendOk("抱歉，您今天已经领取过了.");
						cm.dispose();
						return;
