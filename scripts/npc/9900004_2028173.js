...
Array(1032223,2028173,1,1), //25
Array(1113075,2028173,1,1), //25
Array(1132246,2028173,1,1), //25
Array(1122267,2028173,1,1) //25
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            sl = cm.getPlayer().getItemQuantity(2028173, false);
            StringS = "#b#n   角色剩余:" + sl + " 个#v2028173#（请保证背包有空间，否则会消失）";
