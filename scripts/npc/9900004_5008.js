...
function action(mode, type, selection) {
    ...
    //        text += "#d角色名称：#b" + cm.getName() + "#k#n\t\t  #d剩余金币：#b" + cm.getMeso() + "#k#n\r\n"	
        ...
        //    text += "#L73##r" + 蓝色角点 + "疾风专属戒指升级#r New     #v1112540# 超然属性#l#l\r\n\r\n"//3
