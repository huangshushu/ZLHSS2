...
var 金币 = 1000000;
var itemlist = Array(
	Array(1112439, 1113038, "升级“点状”升级次数。"),
    Array(1032219, 1032191, "升级“点状”升级次数。"),//强化升级次数道具
	Array(1122150, 1122256, "提高血量/蓝量上限。"),//强化升级次数道具
	Array(1132164, 1132230, "随机皇家发型/脸型"),//强化升级次数道具
	Array(1132165, 1132230, "选择皇家发型/脸型"),//强化升级次数道具
	Array(1132166, 1132230, "增加装备强化次数"),//强化升级次数道具	
	Array(1132167, 1132230, "增加装备强化次数"),//强化升级次数道具
	Array(1132168, 1132230, "增加装备强化次数")//强化升级次数道具
...
var ItemID = cm.getInventory(1).getItem(1).getItemId();
		...
		var text =  "属性转移装备：#b#v"+ItemID+"##z"+ItemID+"##k  →  #b#v"+ItemID1+"##z"+ItemID1+"##k\r\n\r\n";
			...
			text += " #e- 转移装备敏捷值：#n#r"+敏捷+"#k 点。\r\n\r\n";
			text += " #e- 转移装备智力值：#n#r"+智力+"#k 点。\r\n\r\n";
			text += " #e- 转移装备运气值：#n#r"+运气+"#k 点。\r\n\r\n";
			text += " #e- 转移装备物攻值：#n#r"+物攻+"#k 点。\r\n\r\n";
			text += " #e- 转移装备魔攻值：#n#r"+魔攻+"#k 点。\r\n\r\n";
			text += " #e- 转移装备物防值：#n#r"+物防+"#k 点。\r\n\r\n";
			text += " #e- 转移装备魔防值：#n#r"+魔防+"#k 点。\r\n\r\n";
		...
		var 升级次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
           if (selection == 0&&cm.haveItem(4011007,4)&& cm.getMeso() >=200000000) {	//帽子
