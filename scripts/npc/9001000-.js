...
function action(mode, type, selection) {
	...
	switch (selection) {
		...
		if (intPoints >= 120000) {
			...
			cm.sendOk("请检查您是否已经为它充足的库存插槽.")
		    }
		} else {
		    cm.sendOk("请检查您是否已经为它足够的积分, #b目前的积分 : " + points);
		}
		break;
