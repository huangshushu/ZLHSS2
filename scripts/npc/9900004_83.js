...
function action(mode, type, selection) {
	...
	奖品集合.add(1115309);//隐形名片戒指
	价格集合.add(288);//隐形名片戒指价格
	// 奖品集合.add(2022461);//星缘的奖励3
	// 价格集合.add(10);//星缘的奖励3价格
	// 奖品集合.add(2022463);//星缘的奖励5
	// 价格集合.add(10);//星缘的奖励5价格
  	...
  	if (status == 0) {
		...
		text += ""+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+音符+"\r\n";
		text += "\t\t\t\t  #d礼品币剩余#v" + 兑换物 + "#：#b" + cm.判断背包其他栏().countById(兑换物) + "#k\r\n";
            
			
		for(var i = 0; i < 奖品集合.size(); i++){
			switch(奖品集合.get(i)){
				case 1:
					text += "#L" + i + "##r" + 蓝色角点 + "#b\t"  + 伤害皮肤 + "#d伤害皮肤自选权限#k [#r" + 价格集合.get(i) + "#b #v" + 兑换物 + "#]  #k  \r\n\t\t\t #b(包含480个伤害皮肤随意切换)#l\r\n";//3
					break;
				case 2:
					text += "#L" + i + "##r" + 蓝色角点 + "#b\t"  + 技能皮肤 + "#d技能皮肤自选权限#k [#r" + 价格集合.get(i) + "#b #v" + 兑换物 + "#]  #k  \r\n\t\t\t #b(包含第三套、第四套技能皮肤随意切换)#l\r\n";//3
					break;
				case 1115309:
