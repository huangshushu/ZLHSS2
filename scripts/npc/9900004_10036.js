	...
	if (mode == -1) {
		...
		if (a == -1) {
			...
			if (selection == 0) {
				...
				cm.dispose();
			 ...
			 else	if (cm.haveItem(4000019, 450) && cm.haveItem(4000016, 450) && cm.haveItem(4000000, 450) && cm.getPlayer().getNX() > 4000 && cm.getPlayer().getCSPoints(2) > 8000  && cm.getPlayer().getMeso() > 1000000 && cm.getInventory(1).getItem(1).getOwner() == "第二阶段") {
					...
					cm.全服公告("玩家：["+cm.getName()+"]成功强化新手勋章为第三阶段！恭喜恭喜！");
					cm.dispose();
