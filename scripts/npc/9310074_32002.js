...
var 金币 = 1000000;
var itemlist = Array(
	Array(1073057, 1072744),
	Array(1072744, 1072874),
	Array(1072874, 1073032)
    ...
    if (mode == -1) {
        ...
        if (a == -1) {
			...
			if (selection == 0) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1073057#放在装备栏#r第1格#b，#v1072744#放在#r第2格\r\n\r\n";
			    text += "#b需要材料：#v4001341#*35，#v4310057#*40\r\n          #v4310143#*120，#v4000435#*10，#v4250902#*10，#v4011007#*2\r\n          #v4011008#*2，金币*8000W\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 1) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1072744#放在装备栏#r第1格#b，#v1072874#放在#r第2格\r\n\r\n";
			    text += "#b需要材料：#v4001341#*40，#v4310057#*50\r\n          #v4310143#*160，#v4000435#*15，#v4250902#*15，#v4011007#*4\r\n          #v4011008#*4，金币*1.5E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 2) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1072874#放在装备栏#r第1格#b，#v1073032#放在#r第2格\r\n\r\n";
			    text += "#b需要材料：#v4001341#*50，#v4310057#*60\r\n          #v4310143#*200，#v4000435#*20，#v4250902#*20，#v4011007#*5\r\n          #v4011008#*5，金币*2E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
		} else if (a == 2) {
			if (b == 1) {
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
				    ...
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1073057 || cm.getInventory(1).getItem(2).getItemId() != 1072744)  {
				...
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
		            cm.sendOk("#b请将神铸所需的装备放置在装备栏的#r第1、2格#b！");
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1072744 || cm.getInventory(1).getItem(2).getItemId() != 1072874)  {
		            cm.sendOk("#r第1、2格装备#r不符合要求，请仔细确认！");
				    cm.dispose();
				} else {
					var ItemID = cm.getInventory(1).getItem(1).getItemId();
				...
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
		            cm.sendOk("#b请将神铸所需的装备放置在装备栏的#r第1、2格#b！");
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1072874 || cm.getInventory(1).getItem(2).getItemId() != 1073032)  {
		            cm.sendOk("#r第1、2格装备#r不符合要求，请仔细确认！");
				    cm.dispose();
				} else {
					var ItemID = cm.getInventory(1).getItem(1).getItemId();
			...
			if (b == 1) {
				...
				if (cm.haveItem(4001341,35) && cm.haveItem(4310057,40) && cm.haveItem(4310143,120) && cm.haveItem(4000435,10) && cm.haveItem(4250902,10) && cm.haveItem(4011007,2) && cm.haveItem(4011008,2) && cm.getMeso() >= 80000000) {
				...
				var 可砸次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
				var 星级 = cm.getInventory(1).getItem(1).getOwner();	
				if (cm.haveItem(4001341,40) && cm.haveItem(4310057,50) && cm.haveItem(4310143,160) && cm.haveItem(4000435,15) && cm.haveItem(4250902,15) && cm.haveItem(4011007,4) && cm.haveItem(4011008,4) && cm.getMeso() >= 150000000) {
				...
				var 可砸次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
				var 星级 = cm.getInventory(1).getItem(1).getOwner();	
				if (cm.haveItem(4001341,50) && cm.haveItem(4310057,60) && cm.haveItem(4310143,200) && cm.haveItem(4000435,20) && cm.haveItem(4250902,20) && cm.haveItem(4011007,5) && cm.haveItem(4011008,5) && cm.getMeso() >= 200000000) {
