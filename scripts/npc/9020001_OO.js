...
var prizeIdScroll = Array(2040501, 2040502, // Overall DEX and DEF
        2040516, // Gloves for DEX
        2040517, 2044701, 2043001, 2043301, 2043701, 2043801, 2044001, 2044301, 2044401, 2044501, 2044601, 2044801, 2044901);						// Helmet, Topwear and Bottomwear for DEF
...
//		    cm.sendNext("Please hurry on to the next stage, the portal opened!");
                    ...
                    if (!enough) {
                        ...
                        cm.sendNext("我很抱歉，但是这是不正确的答案！请在您的给我的正确数量。\r\n题目:" + questions[question]);
                    }
                    cm.dispose();
                }
            } else if (status == 1) {
