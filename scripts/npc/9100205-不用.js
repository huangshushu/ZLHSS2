...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#L1##d祝福卷 * 1张  #v1112915##k#l\r\n";
            //text += "#L2##d祝福卷 * 10张 #v1112793##k#l\r\n";
            //text += "#L3##d祝福卷 * 100张 #v1112677##k#l\r\n";
            cm.sendSimple(text);
        } else if (selection == 1) {
            if (cm.haveItem(4001126, 100) && cm.haveItem(4000313, 50) && cm.haveItem(4031456, 5) && cm.haveItem(4002000, 30) && cm.haveItem(4002001, 5) && cm.haveItem(4002002, 1)  && cm.getMeso() >=10000000) {
                ...
                cm.sendOk("换购#v2340000# 失败！#v4001126#*100个  #v4000313#*50个  #v4031456#*5个  #v4002000#*30个  #v4002001#*5个  #v4002002#*1个  1000万金币");
                cm.dispose();
            }
        } else if (selection == 2) {
