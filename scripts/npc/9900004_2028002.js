...
Array(1452190,2028002,1,1), //25
Array(1442203,2028002,1,1), //25
Array(1492163,2028002,1,1), //25
Array(1472198,2028002,1,1), //25
Array(1432151,2028002,1,1), //25
Array(1422125,2028002,1,1), //25
Array(1412123,2028002,1,1), //25
Array(1402174,2028002,1,1), //25
Array(1382193,2028002,1,1), //25
Array(1332207,2028002,1,1), //25
Array(1322182,2028002,1,1), //25
Array(1312136,2028002,1,1), //25
Array(1462178,2028002,1,1), //58
Array(1482152,2028002,1,1), //58 
Array(1302249,2028002,1,1)//25
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            sl = cm.getPlayer().getItemQuantity(2028002, false);
            StringS = "#b#n   角色剩余:" + sl + " 个#v2028002#（请保证背包有空间，否则会消失）";
