...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        txt = "\t  #b " + Icon[73][1] + " #r#e #fs16#妖精女王副本入口#fs12# #n#b " + Icon[74][1] + " #k\r\n\r\n";
        txt += Icon[41][1];
        for (var i = 0; i <= 59; i++) {
            txt += Icon[42][1];
        };
        ...
        txt += "　" + Icon[68][1] + "　#b推荐等级 #r230 - 300#b　　推荐人员 #r 1 - 1　　 " + Icon[68][1] + "#k\r\n\r\n";
        txt += "　" + Icon[68][1] + "　#b已进行普通模式 [ #r" + cm.getPQLog(PQ) + "#b ] 回合　剩余 [ #r" + pqtry + "#b ] 回合#k\r\n";
        txt += "　　　　　　　  #L1#" + Icon[15][1] + " #d开始挑战 " + Icon[15][1] + "#l#k\r\n\r\n\r\n";
                ...
                if (next) {
                    ...
                    if (em == null || open == false) {
                        ...
                        if (prop == null || prop.equals("0")) {
							...
							cm.worldSpouseMessage(0x15,"[副本消息]:   玩家 "+ cm.getChar().getName() +" 带领他的队伍一起去挑战妖精女王了!!! ");//副本提示
