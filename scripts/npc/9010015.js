...
function action(mode, type, selection) {
    if (mode == -1) {
       ...
       //     gsjb += "#L17##r快速搬砖 - #k#v4000000##v4000016##v4000010##v4000004##v4000011##v4000001##v4000003##v4000012##l\r\n";
            gsjb += "#L12##b#v4001126#兑换[抵用券]  #b比例 - (#r1 = 1#b)#l\r\n";
            gsjb += "#L13##b#v4000313#兑换[抵用券]  #b比例 - (#r1 = 10#b)#l\r\n";
            gsjb += "#L1##b#v4000040#兑换[金币]  #b比例 - (#r1 = 100000#b)#l\r\n";
            gsjb += "#L2##b#v4000176#兑换[金币]  #b比例 - (#r1 = 100000#b)#l\r\n";
            gsjb += "#L11##b#v4031250#兑换[点券]  #b比例 - (#r1 = 200#b)#l\r\n";
            gsjb += "#L14##b#v4001084#兑换[点券]  #b比例 - (#r1 = 300#b)#l\r\n";
            gsjb += "#L15##b#v4001085#兑换[点券]  #b比例 - (#r1 = 300#b)#l\r\n";
            gsjb += "#L16##b#v4001241#兑换[点券]  #b比例 - (#r1 = 300#b)#l\r\n";
            gsjb += "#L20##b#v4001242#兑换[点券]  #b比例 - (#r1 = 300#b)#l\r\n";
            gsjb += "#L21##b#v4001083#兑换[点券]  #b比例 - (#r1 = 500#b)#l\r\n";
 ...
 cm.sendGetNumber("请输入兑换数量。#b当前: #r #c4000040# 个  #k\r\n当前金币：#r"+ cm.getPlayer().getMeso(),1, 1, 100000);
              ...
              //  var iter = cm.getChar().getInventory(MapleInventoryType.ETC).listById(4000138).iterator();
               ...
               //var iter = cm.getChar().getInventory(MapleInventoryType.ETC).listById(4001010).iterator();
                if (cm.haveItem(4031250) == 0) {
                    ...
                    beauty = 11
                    cm.sendGetNumber("请输入兑换数量。#b当前: #r #c4031250# 个  #k\r\n当前金币：#r"+ cm.getPlayer().getNX(),1, 1, 200);
				}

            }else if (selection == 14) {
               //var iter = cm.getChar().getInventory(MapleInventoryType.ETC).listById(4001010).iterator();
                if (cm.haveItem(4001084) == 0) {
                    cm.sendOk("你的物品不足兑换.");
                    status = -1;
                } else {
                    beauty = 14
                    cm.sendGetNumber("请输入兑换数量。#b当前: #r #c4001084# 个  #k\r\n当前金币：#r"+ cm.getPlayer().getNX(),1, 1, 300);
				}
               ...
               //var iter = cm.getChar().getInventory(MapleInventoryType.ETC).listById(4001010).iterator();
                if (cm.haveItem(4001085) == 0) {
                    ...
                    beauty = 15
                    cm.sendGetNumber("请输入兑换数量。#b当前: #r #c4001085# 个  #k\r\n当前点券：#r"+ cm.getPlayer().getNX(),1, 1, 300);
				}
               ...
               //var iter = cm.getChar().getInventory(MapleInventoryType.ETC).listById(4001010).iterator();
                if (cm.haveItem(4001241) == 0) {
                    ...
                    beauty = 16
                    cm.sendGetNumber("请输入兑换数量。#b当前: #r #c4001241# 个  #k\r\n当前点券：#r"+ cm.getPlayer().getNX(),1, 1, 300);
				}
           ...
           cm.sendGetNumber("请输入数量:\r\n#b比例 - (#r1 = 1#b)\r\n  当前数量: #c4031196# 个#r \r\n", 1, 1, 100000 ); }
            ...
            if (beauty == 1) {
                if (cm.haveItem(4000040, selection)){
					...
					cm.worldMessage(6,"  玩家：["+cm.getName()+"]努力搬砖，兑换了："+(selection*100000)+" 金币。");
					 cm.dispose();
                } else {
                ...
                if (cm.haveItem(4000235, selection)){
					...
					cm.worldMessage(6,"  玩家：["+cm.getName()+"]努力搬砖，兑换了："+(selection*2000000)+" 金币。");
					 cm.dispose();
                } else {
                    cm.sendOk("您的输入的数量错误，无法兑换。");
                    cm.dispose()
                ...
                if (cm.haveItem(4000175, selection)){
					...
					cm.worldMessage(6,"  玩家：["+cm.getName()+"]努力搬砖，兑换了："+(selection*1400000)+" 金币。");
					 cm.dispose();
                } else {
                    cm.sendOk("您的输入的数量错误，无法兑换。");
                    cm.dispose()
                ...
                if (cm.haveItem(4000094, selection)){
					...
					cm.worldMessage(6,"  玩家：["+cm.getName()+"]努力搬砖，兑换了："+(selection*400000)+" 金币。");
					 cm.dispose();
                } else {
                    cm.sendOk("您的输入的数量错误，无法兑换。");
                    cm.dispose()
                ...
                if (cm.haveItem(4000138, selection)){
					...
					cm.worldMessage(6,"  玩家：["+cm.getName()+"]努力搬砖，兑换了："+(selection*3000000)+" 金币。");
					 cm.dispose();
                } else {
                    cm.sendOk("您的输入的数量错误，无法兑换。");
                    cm.dispose()
                ...
                if (cm.haveItem(4031250, selection)){
					 cm.gainItem(4031250, -selection);
                      cm.sendOk("兑换成功。 [#r"+selection+"#k] 兑换了:[#r"+(selection*200)+"#k] 点券。");
                     cm.gainNX(+200* selection);
					cm.worldMessage(6,"  玩家：["+cm.getName()+"]努力搬砖，兑换了："+(selection*200)+" 点券。");
					 cm.dispose();
                } else {
                    cm.sendOk("您的输入的数量错误，无法兑换。");
                    cm.dispose()
                ...
                if (cm.haveItem(4001241, selection)){
                    ...
                    cm.sendOk("兑换成功。 [#r"+selection+"#k] 兑换了:[#r"+(selection*300)+"#k] 点券。");
                     cm.gainNX(+300* selection);
					cm.worldMessage(6,"  玩家：["+cm.getName()+"]努力搬砖，兑换了："+(selection*300)+" 点券。");
					 cm.dispose();
                } else {
                    cm.sendOk("您的输入的数量错误，无法兑换。");
                    cm.dispose()
                ...
                if (cm.haveItem(4001084, selection)){
                ...
                if (cm.haveItem(4001126, selection)){
					...
					cm.gainDY(+selection*1); //抵用券加减
				//	cm.getChar().UpdateCash();   //
                    cm.sendOk("兑换成功。 [#r"+selection+"#k]枫叶 兑换了:[#r"+(selection*1)+"#k] 抵用券");
					cm.worldMessage(6,"  玩家：["+cm.getName()+"]努力搬砖，兑换了："+(selection*1)+" 抵用券");
					 cm.dispose();
                } else {
                    cm.sendOk("您的输入的数量错误，无法兑换。");
                    cm.dispose()
                ...
                if (cm.haveItem(4000313, selection)){
					...
					cm.gainDY(+selection*10);	//加减点券
					//cm.gainDY(selection*2); //抵用券加减
				//	cm.getChar().UpdateCash();   //
                    cm.sendOk("兑换成功。 [#r"+selection+"#k]黄金枫叶 兑换了:[#r"+(selection*10)+"#k] 抵用券");
					cm.worldMessage(6,"  玩家：["+cm.getName()+"]努力搬砖，兑换了："+(selection*10)+" 抵用券");
					 cm.dispose();
                } else {
                    cm.sendOk("您的输入的数量错误，无法兑换。");
                    cm.dispose()
                ...
                if (cm.haveItem(4001242, selection)){
                     ...
                     cm.gainNX(+300* selection);
                    cm.sendOk("兑换成功。 [#r"+selection+"#k] 共兑换了:[#r"+(selection*300)+"#k] 点券。");
					cm.worldMessage(6,"  玩家：["+cm.getName()+"]努力搬砖，兑换了："+(selection*300)+" 点券。");
					 cm.dispose();
                } else {
                    cm.sendOk("您的输入的数量错误，无法兑换。");
                ...
                if (cm.haveItem(4001083, selection)){
                    ...
                    cm.sendOk("兑换成功。 [#r"+selection+"#k] 共兑换了:[#r"+(selection*500)+"#k] 点券。");
					cm.worldMessage(6,"  玩家：["+cm.getName()+"]努力搬砖，兑换了："+(selection*500)+" 点券。");
					 cm.dispose();
                } else {
                    cm.sendOk("您的输入的数量错误，无法兑换。");
                    cm.dispose()
