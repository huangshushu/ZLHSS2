...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "#L71##r" + 蓝色角点 + "#v1032206#第一阶段神话耳环#r #l\r\n" //3
            text += "#L72##r" + 蓝色角点 + "#v1032207#第二阶段神话耳环#r #l\r\n" //3
			text += "#L73##r" + 蓝色角点 + "#v1032208#第三阶段神话耳环#r  #l\r\n" //3
            text += "#L74##r" + 蓝色角点 + "#v1032209#第四阶段神话耳环#r #l\r\n" //3
            text += "#L75##r" + 蓝色角点 + "#v1032219#遗忘的神话耳环#r #l\r\n" //3
