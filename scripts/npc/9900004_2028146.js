...
var itemList = Array(
Array(1112688, 2, 1, 1), //鞋子
Array(1113185, 2, 1, 1), //手套
Array(1113016, 2, 1, 1), //披风
Array(1113149, 2, 1, 1), //腰带
...
function action(mode, type, selection) {
    if (mode == 1) {
		...
		if (status == 0) {
			if(cm.haveItem(2028146,1)) {
var str1 = "\r\n";	
           for (var i = 0; i < itemList.length; i++){
                   str1 += "#v"+itemList[i][0]+"#";
            }
				cm.sendYesNo(""+小烟花+"#r欢迎来到BOSS三头犬箱子#v2028146#抽奖!\r\n\r\n"+小烟花+"#e以下是奖池内容的全部物品:\r\n\r\n" + str1);
			} else {
var str1 = "\r\n";	
           for (var i = 0; i < itemList.length; i++){
                   str1 += "#v"+itemList[i][0]+"#";
            }
				cm.sendOk(""+小烟花+"#r欢迎来到BOSS三头犬箱子#v2028146#抽奖!\r\n\r\n"+小烟花+"#e以下是奖池内容的全部物品:\r\n\r\n" + str1);
				cm.dispose();
			}
		} else if (status == 1){	
        ...
        if (finalitem.length != 0) {
            ...
            item = cm.gainGachaponItem(itemId, quantity, "三头犬箱子BOSS箱子抽奖", notice);
            if (item != -500) {
			cm.gainItem(2028146, -1);//获得物品
