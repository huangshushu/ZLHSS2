...
function action(mode, type, selection) {
        ...
        if (status == 0) {
            ...
            if (cm.getLevel() < 255 && cm.getJob() == 0) {
                if (cm.getLevel() < 8) {
                    ...
                    cm.sendNext("恭喜你达到了#r10级#k，请选择你的一转职业");
                    status = 153;
                }
    ...
    cm.teachSkill(5221010,0,5);
            ...
            cm.sendSimple("              #r请选择一个你所喜欢的职业！#b\r\n #L0#战士#l   #L1#魔法师#l   #L2#弓箭手#l #L3#飞侠#l   #L4#海盗#l#b\r\n\r\n           #L10#战神#l#k");
            ...
            if(cm.getJob() == 1000 && cm.getLevel()>=10){
                ...
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 在NPC：管理员 快速转职为骑士团一转职业！");
                cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！");
            } else if(parseInt(cm.getJob() / 100) >10 && cm.getLevel()>=30 && cm.getJob()%100 == 0){
                cm.changeJob(cm.getJob()+10);
                //cm.gainItem(1142067,1);
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 在NPC：管理员 快速转职为骑士团二转职业！");
                cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！");
            } else if(parseInt(cm.getJob() / 100) >10 && cm.getLevel()>=70 && cm.getJob()%10 == 0){
            ...
            if(cm.getJob() == 2000 && cm.getLevel() >=10){
                ...
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 在NPC：管理员 快速转职为战神一转！");
                cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！");
            } else if(cm.getJob() == 2100 && cm.getLevel() >=30){
                cm.changeJob(2110);
                ...
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 在NPC：管理员 快速转职为战神二转！");
                cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！");
            } else if(cm.getJob() == 2110 && cm.getLevel() >=70){
                ...
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 在NPC：管理员 快速转职为战神三转！");
                cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！");
            } else if(cm.getJob() == 2111 && cm.getLevel() >=120){
                ...
                cm.changeJob(2112);
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 在NPC：管理员 快速转职为战神四转！");
                cm.sendOk("转职成功！希望您以后的冒险之路顺利！");
            }
            cm.dispose();
        } else {
