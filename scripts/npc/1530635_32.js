...
function action(mode, type, selection) {
    ...
    if (status == 0) {
		...
		txt += "#L10#" + Icon[0][1] + " #b升级创世武器强化#l#k\r\n\r\n";
		txt += "#L11#" + Icon[0][1] + " #b升级漆黑套装备强化#l#k\r\n\r\n";
		txt += "#L12#" + Icon[0][1] + " #b升级神秘武器强化#l#k\r\n\r\n";
		txt += "#L13#" + Icon[0][1] + " #b升级特米武器强化#l#k\r\n\r\n";
		txt += "#L14#" + Icon[0][1] + " #b升级法芙娜武器强化#l#k\r\n\r\n";
