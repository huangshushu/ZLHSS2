...
textz += "#L7##b" + 红色箭头 + "0星直接升级#e#b#n#r10★#e#b" + 蓝色角点 + "  需要#v4310009#×1个#l\r\n";
...
Packages.server.MapleInventoryManipulator.addFromDrop(cm.getC(),item,false);
var a=item.getItemId();
cm.serverNotice("『10星必成币』：恭喜【"+ cm.getChar().getName() +"】的装备升为【"+ cm.getChar().getInventory(Packages.client.inventory.MapleInventoryType.EQUIP).getItem(1).getOwner() +"】 战斗力大幅提升！");
