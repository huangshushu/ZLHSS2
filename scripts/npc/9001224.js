...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
		...
		var selStr = "";
		selStr += "\r\n     #b#L0#"+gggg+" #e挑战月光无尽之塔000 - 020层 "+gggg+"#l\r\n";	
		selStr += "\r\n    #b#L1#"+aaaa+" #e挑战月光无尽之塔020 - 040层 "+aaaa+"#l\r\n";
		selStr += "\r\n    #d#L2#"+bbbb+" #e挑战月光无尽之塔040 - 060层 "+bbbb+"#l\r\n";
		selStr += "\r\n    #d#L3#"+cccc+" #e挑战月光无尽之塔060 - 080层 "+cccc+"#l\r\n";
		selStr += "\r\n    #r#L4#"+dddd+" #e挑战月光无尽之塔080 - 100层 "+dddd+"#l\r\n";
		cm.sendSimple(selStr);
    } else if (status == 1) {
        switch (selection) {
            case 0:
                cm.dispose();
                cm.openNpc(9062140, "无尽挑战1入口")
				break;
			case 1:
                cm.dispose();
                cm.openNpc(9062140, "无尽挑战2入口")
				break;
            case 2:
                cm.dispose();
                cm.openNpc(9062140, "无尽挑战3入口")
				break;
            case 3:
                cm.dispose();
                cm.openNpc(9062140, "无尽挑战4入口")
				break;
			case 4:
                cm.dispose();
                cm.openNpc(9062140, "无尽挑战5入口")
				break;
         }
    }
}
