...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			cm.sendNext("#r您现在所选择的是#d[品克缤武器卷轴强化]#v1462184##k#l\r\n#b强化成功率:#r100%#k\r\n#b#b强化消耗:#v2044618##r*1#k\r\n#d次数限制:每天上限 #r[32] #k次#l\r\n");
		} else if (status == 1) {
		...
		//	var 爱心 = "#fEffect/CharacterEff/1022223/4/0#";
			...
			if (!cm.haveItem(2044618,1) || !cm.haveItem(1462184,1) || cm.getMeso()<2000000) {
				cm.sendOk("#b对不起,游戏币不足200万，或品克缤武器卷不足:#r[1]张！#k\r\n\t   #b当前所拥有#v2044618#:#r [#c2044618#] 张!#l");
				status = -1;
