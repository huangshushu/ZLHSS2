...
function action(mode, type, selection) {
	...
	if (status == 0) {
		...
		t += " - #z1114304# x 1\r\n";//	重启宇宙戒指
		t += " - #z5211060# x 1\r\n";//	三倍经验卡(2小时)
		t += " - #z1143078# x 1（#b装备属性：#rHP1000，MP1000，移动速度20，跳跃力20#k）\r\n";//	微不足道的新人
		t += " - #z1113028# x 1（#b装备属性：#r全属性50，双攻50，跳跃力20#k）\r\n";//	微不足道的新人
		t += " - #z1113164# x 1（#b装备属性：#rBoss伤害+15，总伤害+15#k）\r\n";//	微不足道的新人
		t += " - #z1002186# x 1\r\n";//	透明帽
		t += " - #z1702585# x 1\r\n";//	透明剑
		t += " - #z1002186# x 1\r\n";//	透明帽
		t += " - #z1702585# x 1\r\n";//	透明剑
		...
		if (cm.getBossLog("新手礼包", 1) == 0) {
			...
			cm.gainItem(1702585, 1);//	透明剑
			cm.gainItem(1092067, 1);//	透明盾牌
			...
			cm.gainItem(1050499, 1);//	珊瑚海泳装	
			cm.gainItem(1051567, 1);//	珊瑚海泳装
