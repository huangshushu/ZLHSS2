	...
	if (mode == -1) {
		...
		if (a == -1) {
			...
			if (selection == 0) {
		        ...
		        cm.sendOk("把#v1114303#放在第一格!");				   
			 ...
			 else	if (cm.haveItem(4002000, 50) && cm.haveItem(4002001, 50) && cm.haveItem(4002002, 50) && cm.haveItem(4002003, 50) && cm.haveItem(4031559, 50) && cm.getInventory(1).getItem(1).getOwner() == "第二阶段") {
					...
					cm.全服公告("玩家：["+cm.getName()+"]成功强化邮票戒指为第三阶段！恭喜恭喜！");
					cm.dispose();
				} else {
