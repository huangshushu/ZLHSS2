...
var 金币 = 1000000;
var itemlist = Array(
	Array(1102828, 1102481),
	Array(1102481, 1102623),
	Array(1102623, 1102775)
    ...
    if (mode == -1) {
        ...
        if (a == -1) {
			...
			if (selection == 0) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1102828#放在装备栏#r第1格#b，#v1102481#放在#r第2格\r\n\r\n";
			    text += "#b需要材料：#v4001241#*12，#v4001242#*12，#v4000244#*8，#v4000245#*8\r\n        #v4250802#*10，#v4011007#*3，#v4011008#*3\r\n          #v4310143#*100，金币*5000W\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 1) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1102481#放在装备栏#r第1格#b，#v1102623#放在#r第2格\r\n\r\n";
			    text += "#b需要材料：#v4001241#*14，#v4001242#*14，#v4000244#*10，#v4000245#*10\r\n        #v4250802#*15，#v4011007#*4，#v4011008#*4\r\n          #v4310143#*120，金币*8000W\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 2) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1102623#放在装备栏#r第1格#b，#v1102775#放在#r第2格\r\n\r\n";
			    text += "#b需要材料：#v4001241#*16，#v4001242#*16，#v4000244#*12，#v4000245#*12\r\n        #v4250802#*20，#v4011007#*5，#v4011008#*5\r\n          #v4310143#*140，金币*1E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
		} else if (a == 2) {
			if (b == 1) {
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
				    ...
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1102828 || cm.getInventory(1).getItem(2).getItemId() != 1102481)  {
				...
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
		            cm.sendOk("#b请将神铸所需的装备放置在装备栏的#r第1、2格#b！");
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1102481 || cm.getInventory(1).getItem(2).getItemId() != 1102623)  {
		            cm.sendOk("#r第1、2格装备#r不符合要求，请仔细确认！");
				    cm.dispose();
				} else {
					var ItemID = cm.getInventory(1).getItem(1).getItemId();
				...
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
		            cm.sendOk("#b请将神铸所需的装备放置在装备栏的#r第1、2格#b！");
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1102623 || cm.getInventory(1).getItem(2).getItemId() != 1102775)  {
		            cm.sendOk("#r第1、2格装备#r不符合要求，请仔细确认！");
				    cm.dispose();
				} else {
					var ItemID = cm.getInventory(1).getItem(1).getItemId();
			...
			if (b == 1) {
				...
				if (cm.haveItem(4001241,12) && cm.haveItem(4001241,12) && cm.haveItem(4000244,8) && cm.haveItem(4000245,8) &&cm.haveItem(4250802,10) && cm.haveItem(4011007,3) && cm.haveItem(4011008,3) && cm.haveItem(4310143,100)&& cm.getMeso() >= 50000000){
				...
				cm.gainMeso(-50000000);
					...
					Packages.handling.world.World.Broadcast.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(11,cm.getC().getChannel(),"装备神铸" + " : 恭喜" + cm.getPlayer().getName() +"成功将冒险岛寻宝披风神铸成暴君披风，属性获得大幅提升，大家祝贺他/她！",true).getBytes());
		 		    cm.dispose();
				} else {
				...
				var 可砸次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
				var 星级 = cm.getInventory(1).getItem(1).getOwner();	
				if (cm.haveItem(4001241,14) && cm.haveItem(4001241,14) && cm.haveItem(4000244,10) && cm.haveItem(4000245,10) &&cm.haveItem(4250802,15) && cm.haveItem(4011007,4) && cm.haveItem(4011008,4) && cm.haveItem(4310143,120)&& cm.getMeso() >= 80000000){
				...
				var 可砸次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
				var 星级 = cm.getInventory(1).getItem(1).getOwner();	
				if (cm.haveItem(4001241,16) && cm.haveItem(4001241,16) && cm.haveItem(4000244,12) && cm.haveItem(4000245,12) &&cm.haveItem(4250802,20) && cm.haveItem(4011007,5) && cm.haveItem(4011008,5) && cm.haveItem(4310143,140)&& cm.getMeso() >= 100000000){
