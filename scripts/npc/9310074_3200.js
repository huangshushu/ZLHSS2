...
var 金币 = 1000000;
var itemlist = Array(
	Array(1073057, 1072743, 1072874, 1073030),
	Array(1073057, 1072744, 1072874, 1073032),
	Array(1073057, 1072745, 1072874, 1073033),
	Array(1073057, 1072746, 1072874, 1073034),
	Array(1073057, 1072747, 1072874, 1073035)
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (a == -1) {
			...
			if (selection == 0) {
				cm.dispose();
				cm.openNpc(9310074,32001);
            }
			else if (selection == 1) {
				cm.dispose();
				cm.openNpc(9310074,32002);
            }
			else if (selection == 2) {
				cm.dispose();
				cm.openNpc(9310074,32003);
            }
			else if (selection == 3) {
				cm.dispose();
				cm.openNpc(9310074,32004);
            }
			else if (selection == 4) {
				cm.dispose();
				cm.openNpc(9310074,32005);
            }
			else if (selection == 5) {
				cm.dispose();
