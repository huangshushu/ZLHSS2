...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            gsjb += "#L104##v4031629##v4031632##v4031636##v4031640##v4031644##v4031648# (#r大丰收200W#k)#l\r\n\r\n";
            gsjb += "#L100##b#v4031636##z4031636#  兑换金币 #b比例-(#r1 = 50W#b)已拥有:#r#c4031636##k#l\r\n";
            gsjb += "#L101##b#v4031640##z4031640# 兑换点券 #b比例-(#r1 = 100#b)已拥有:#r#c4031640##k#l\r\n";
            gsjb += "#L102##b#v4031644##z4031644# 兑换#v4001322# #b比例-(#r5 = 1#b)已拥有:#r#c4031644##k#l\r\n";
            gsjb += "#L103##b#v4031648##z4031648# 兑换#v4001323# #b比例-(#r5 = 1#b)已拥有:#r#c4031648##k#l\r\n\r\n";
          ...
          /*  if (beauty == 16) {
            ...
            if (beauty == 0) {
                ...
                if (cm.haveItem(4031640, selection)){
					 cm.gainItem(4031640, -selection);
					 cm.gainNX(selection*100);	//加减点券
                     //cm.sendNext("兑换成功。 [#r"+selection+"#k] 兑换了:[#r"+(selection*100000)+"#k] 金币");
                     cm.sendOk("兑换成功！");
					//cm.worldMessage(6,"玩家：["+cm.getName()+"]钓到了大鱼！兑换了"+selection*500+"点券！");
				    cm.喇叭(1,"玩家：["+cm.getName()+"]钓到了大鱼！兑换了 "+selection*100+" 点券！");
					 cm.dispose();
                } else {
                    cm.sendNext("条件不足，无法兑换。");
                    cm.dispose()
                ...
                if (cm.haveItem(4031644, selection*5)){
					 cm.gainItem(4031644, -selection*5);
					 cm.gainItem(4001322, selection);
					 //cm.gainNX(selection*500);	//加减点券
                     //cm.sendNext("兑换成功。 [#r"+selection+"#k] 兑换了:[#r"+(selection*100000)+"#k] 金币");
                     cm.sendOk("兑换成功！");
					//cm.worldMessage(6,"玩家：["+cm.getName()+"]钓到了大鱼！兑换了"+selection*500+"点券！");
				    cm.喇叭(1,"玩家：["+cm.getName()+"]钓到了大鱼！兑换了 "+selection+" 个蓝宝石！");
					 cm.dispose();
                } else {
                    cm.sendNext("条件不足，无法兑换。");
                    cm.dispose()
                ...
                if (cm.haveItem(4031648, selection*5)){
                     ...
                     cm.sendOk("兑换成功！");
					//cm.worldMessage(6,"玩家：["+cm.getName()+"]钓到了大鱼！兑换了"+selection*500+"点券！");
				    cm.喇叭(1,"玩家：["+cm.getName()+"]钓到了大鱼！兑换了 "+selection+" 个红宝石！");
					 cm.dispose();
                } else {
                    cm.sendNext("条件不足，无法兑换。");
                    cm.dispose()
                ...
                if (cm.haveItem(4031629, selection) && cm.haveItem(4031632, selection) && cm.haveItem(4031636, selection) && cm.haveItem(4031640, selection) && cm.haveItem(4031644, selection) && cm.haveItem(4031648, selection)){
					 ...
					 cm.gainItem(4031644, -selection);
					 cm.gainItem(4031648, -selection);
					 cm.gainMeso(+2000000* selection); //加减金币
                     //cm.sendNext("兑换成功。 [#r"+selection+"#k] 兑换了:[#r"+(selection*100000)+"#k] 金币");
                     cm.sendOk("兑换成功！");
					//cm.worldMessage(6,"玩家：["+cm.getName()+"]钓到了大鱼！兑换了"+selection*500+"点券！");
				    cm.喇叭(1,"玩家：["+cm.getName()+"]钓鱼大丰收！获得了 "+selection*2000000+" 金币！");
					 cm.dispose();
                } else {
                    cm.sendNext("条件不足，无法兑换。");
                    cm.dispose()
