...
function action(mode, type, selection) {
    if (mode == 1) {
        ...
        if (status == 0) {
           selStr = "#e欢迎来到冒险岛特色抽奖，如有垃圾请联系管理员删除\r\n#r每次抽取需要消耗1个#v4032300#【BOSS获得/积分商城购买】\r\n#g\r\n#k\r\n";
    ...
    if (status == 0) {
        ...
        if (cm.haveItem(4310030, 1)) {
            cm.sendYesNo("欢迎来到冒险岛特色抽奖，如有垃圾请联系管理员删除\r\n#r每次抽取需要消耗1个#v4310030#【BOSS兑换获得/积分商城购买】\r\n盔甲敏捷卷属性为：敏捷+5 攻击+1 鞋子为：敏捷+3 攻击+2\r\n#r{#v4310027#可在兑换系统换大翅膀 抽奖币可用4赞助积分购买}\r\n        以下装备带上后无法交易 赶紧嗨起来吧  "+selStr);
        } else {
            cm.sendOk("欢迎来到冒险岛特色抽奖，如有垃圾请联系管理员删除\r\n#r每次抽取需要消耗1个#v4310030#【BOSS兑换获得/积分商城购买】\r\n全身盔甲敏捷卷属性为：敏捷+5 攻击+1 鞋子为：敏捷+3 攻击+2\r\n#r{#v4310027#可在兑换系统换大翅膀 抽奖币可用4赞助积分购买}\r\n\t以下抽奖装备属性都很高 带上后不支持剪刀交易\r\n\t↓武器必成卷任意三张可选群主换本职业一张↓"+selStr);
            cm.safeDispose();
        }
    } else if (status == 1) {
