...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		//var tex2 = ""+cm.getHyPay(1)+"";
            text += "#L1##r#v1113090#宝石戒指合成#r#l\r\n"//3
            text += "#L2##r#v1113090#宝石戒指强化#r#l\r\n\r\n"//3
			text += "#L3##r#v1113090#旧宝石戒指兑换新宝石戒指#r#l\r\n\r\n"//3

text += "\r\n"+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n\r\n"
		    cm.sendSimple(text);
        } else if (selection == 1) {//贝勒制作
            cm.openNpc(9900004, 10015);
		} else if (selection == 2) {//贝勒制作
            cm.openNpc(9900004, 10016);
		} else if (selection == 3) {//贝勒制作
            cm.openNpc(9900004, 10091);
