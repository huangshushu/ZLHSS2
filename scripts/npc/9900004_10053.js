...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		var tex2 = ""+cm.getHyPay(1)+"";
            ...
            text += "#r#L1##v1112444#升为1阶全属性+5需要\r\n#k#v4031456#x25#v4001126#x50#l\r\n"//3
			text += "#r#L2##v1112444#升为2阶全属性+5需要\r\n#k#v4031456#x50#v4001126#x100#l\r\n"//3
			text += "#r#L3##v1112444#升为3阶全属性+5需要\r\n#k#v4031456#x75#v4001126#x150#l\r\n"//3
			text += "#r#L4##v1112444#升为满阶全属性+5需要\r\n#k#v4031456#x100#v4001126#x200#l\r\n"//3

text += "\r\n"+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n\r\n"
		    cm.sendSimple(text);
        } else if (selection == 1) {//贝勒制作
            cm.openNpc(9900004, 10019);
		} else if (selection == 2) {//贝勒制作
            cm.openNpc(9900004, 10049);
		} else if (selection == 3) {//贝勒制作
            cm.openNpc(9900004, 10050);
		} else if (selection == 4) {//贝勒制作
            cm.openNpc(9900004, 10051);
