...
var itemList = Array(
        ...
        Array(1142473, 134, 1, 0), //飞太远 太危险
        Array(1142670, 200, 1, 0), //马子狗
        Array(1142407, 134, 1, 0), //不要不要的
        Array(1142151, 200, 1, 0), //8+9就是狂
        Array(1142250, 200, 1, 0), //边缘人
        Array(1142732, 200, 1, 0), //狼若回头
        Array(1142733, 200, 1, 0), //不是报恩
        Array(1142734, 200, 1, 0), //就是报仇
        Array(1142334, 200, 1, 0), //有钱就是任性
        Array(1142622, 200, 1, 0) //满满的大平台
        );
...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        if (cm.getPlayer().getLevel() < 25) {
            ...
            cm.sendSimple("你有#b转蛋券#k或#b" + meso + "#k枫币你要试试手气吗?\r\n#L0##d转蛋券转蛋#l\r\n#L1##d枫币250W转蛋#l");
        } else {
