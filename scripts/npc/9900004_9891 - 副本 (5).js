    ...
    if (mode == -1) {
		...
		var tex2 = ""+cm.getHyPay(1)+"";
           // text += "#L72##r" + 蓝色角点 + "材料合成#r New     #v4251202##z4251202##l#l\r\n\r\n"//3
		    text += "#L70##r" + 蓝色角点 + "#v1012170#恐怖鬼娃#r 90级#l\r\n"//3
            text += "#L71##r" + 蓝色角点 + "#v1012171#恐怖鬼娃#r 100级#l\r\n"//3
			text += "#L72##r" + 蓝色角点 + "#v1012172#恐怖鬼娃#r 130级#l\r\n"//3
			text += "#L73##r" + 蓝色角点 + "#v1012173#恐怖鬼娃#r 150级#l\r\n"//3
			text += "#L74##r" + 蓝色角点 + "#v1012174#恐怖鬼娃#r 180级#l\r\n"//3
