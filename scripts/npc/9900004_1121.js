...
var 金币 = 1000000;
var itemlist = Array(
	//Array(1113076, 1112613, "升级“点状”升级次数。"),
	...
	Array(1022232, 1022231, "增加装备强化次数")//强化升级次数道具
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (a == -1) {
			...
			text = "#r请将初阶装备升至满星并砸满32次卷，进行属性增幅至5后再进行传承，否则属性低后果自负！#l\r\n\r\n#b装备传承需要4个月石和2亿游戏币#l\r\n\r\n#d请选择你要继承的装备#r#l\r\n";
			text += "\r\n";
			for (var i=0; i<itemlist.length; i++) {
				text += "#L" + i + "#将#v"+itemlist[i][0]+"#的属性继承到#d#v"+itemlist[i][1]+"##k#l\r\n\r\n";
				if (i != 0 && (i+1) % 99 == 0) {
					text += "\r\n";
				}
			}
