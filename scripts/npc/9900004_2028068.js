...
Array(1082543,2028068,1,1), //25
Array(1082544,2028068,1,1), //25
Array(1082545,2028068,1,1), //25
Array(1082546,2028068,1,1), //25
Array(1082547,2028068,1,1), //25

Array(1072743,2028068,1,1), //25
Array(1072744,2028068,1,1), //25
Array(1072745,2028068,1,1), //25
Array(1072746,2028068,1,1), //25
Array(1072747,2028068,1,1), //25

Array(1102481,2028068,1,1), //25
Array(1102482,2028068,1,1), //25
Array(1102483,2028068,1,1), //25
Array(1102484,2028068,1,1), //25
Array(1102485,2028068,1,1), //25

Array(1132174,2028068,1,1), //25
Array(1132175,2028068,1,1), //25
Array(1132176,2028068,1,1), //25
Array(1132177,2028068,1,1), //25
Array(1132178,2028068,1,1) //25
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            sl = cm.getPlayer().getItemQuantity(2028068, false);
            StringS = "#b#n   角色剩余:" + sl + " 个#v2028068#（请保证背包有空间，否则会消失）";
