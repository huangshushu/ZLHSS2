...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		var tex2 = ""+cm.getHyPay(1)+"";
            ...
            text += "#r#L1##v1114226#升为1阶全属性+3需要\r\n#k#v4021009#x10#v4011007#x10#l\r\n"//3
			text += "#r#L2##v1114226#升为2阶全属性+3需要\r\n#k#v4021009#x15#v4011007#x15#l\r\n"//3
			text += "#r#L3##v1114226#升为3阶全属性+3需要\r\n#k#v4021009#x20#v4011007#x20#l\r\n"//3
			text += "#r#L4##v1114226#升为满阶全属性+3需要\r\n#k#v4021009#x25#v4011007#x25#l\r\n"//3

text += "\r\n"+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n\r\n"
		    cm.sendSimple(text);
        } else if (selection == 1) {//贝勒制作
            cm.openNpc(9900004, 10068);
		} else if (selection == 2) {//贝勒制作
            cm.openNpc(9900004, 10069);
		} else if (selection == 3) {//贝勒制作
            cm.openNpc(9900004, 10070);
		} else if (selection == 4) {//贝勒制作
            cm.openNpc(9900004, 10071);
