...
function action(mode, type, selection) {
    ...
    if (cm.getMapId() == 180000001) {
        ...
        cm.dispose();
         ...
         var 
        selStr = "#e#d              " + xx + " 装 备 分 解 " + xx + "\r\n";
		selStr += "" + epp + "" + epp + "" + epp + "" + epp + "\r\n";
            var x = 0;
        //str += "#r#L1#"+xxx+"#v1112676#升级成#v1112677##r#l\r\n";
        selStr += "           #L1#"+xx+"#e#r分解低级装备#b#l \r\n\r\n";//#r#e#L98#"+xx+" 戒指淬炼系统 \r\n
		selStr += "           #L2#"+xx+"#r#e分解高级装备#b#l \r\n\r\n";
		selStr +="\r\n";
        selStr +="\r\n";;
		selStr += "\r\n" + epp + "" + epp + "" + epp + "" + epp + ""
        ...
        switch (selection) {
            case 1://能力
                cm.dispose();
				cm.openNpc(2470020,"回收2");//cm.openNpc(9105003,"戒指强化");
				break;
            case 2://充值
                cm.dispose();
				cm.openNpc(2470021,"分解");//160juexing
                break;
            case 3://充值
                cm.dispose();
