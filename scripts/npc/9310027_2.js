...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            var gsjb = "";
            gsjb = " #r真相只有一个！#k - 那就是寻找物品来回收兑换金币吧！\r\n";
           // gsjb += "#L10##r[金币]#k 兑换 #v4021010#   -   (#r1000W = 1#b)#l\r\n";
            ...
            gsjb += "#L1##b#v4000040#回收[金币]  #b比例 - (#r1 = 300000#b)#l\r\n";
            gsjb += "#L2##b#v4000176#回收[金币]  #b比例 - (#r1 = 300000#b)#l\r\n";
            gsjb += "#L11##b#v4001010#回收[金币]  #b比例 - (#r1 = 300000#b)#l\r\n";
            gsjb += "#L14##b#v4000460#回收[金币]  #b比例 - (#r1 = 400000#b)#l\r\n";
            gsjb += "#L15##b#v4000461#回收[金币]  #b比例 - (#r1 = 400000#b)#l\r\n";
            gsjb += "#L16##b#v4000462#回收[金币]  #b比例 - (#r1 = 400000#b)#l\r\n";
			/*
            gsjb += "#L20##b#v4000000#回收[金币]  #b比例 - (#r1 = 1000#b)#l\r\n";
            gsjb += "#L21##b#v4000016#回收[金币]  #b比例 - (#r1 = 1000#b)#l\r\n";
            gsjb += "#L22##b#v4000010#回收[金币]  #b比例 - (#r1 = 1000#b)#l\r\n";
            gsjb += "#L23##b#v4000004#回收[金币]  #b比例 - (#r1 = 1000#b)#l\r\n";
            gsjb += "#L24##b#v4000011#回收[金币]  #b比例 - (#r1 = 1000#b)#l\r\n";
            gsjb += "#L25##b#v4000001#回收[金币]  #b比例 - (#r1 = 1000#b)#l\r\n";
            gsjb += "#L26##b#v4000003#回收[金币]  #b比例 - (#r1 = 1000#b)#l\r\n";
            gsjb += "#L27##b#v4000012#回收[金币]  #b比例 - (#r1 = 1000#b)#l\r\n";
			*/
           ...
           cm.sendGetNumber("请输入数量:\r\n#b比例 - (#r1 = 1#b)\r\n  当前数量: #c4031196# 个#r \r\n", 1, 1, 1000 ); }
            ...
            if (beauty == 1) {
                ...
                if (cm.haveItem(4002003, selection)){
                     ...
                     cm.gainNX(+5* selection);
                    cm.sendOk("兑换成功。 [#r"+selection+"#k] 共兑换了:[#r"+(selection*5)+"#k] 点卷。");
					cm.worldMessage(6,"玩家：["+cm.getName()+"]努力搬砖兑换了："+(selection*5)+" 点卷。");
					 cm.dispose();
                } else {
                    cm.sendOk("您的输入的数量错误，无法兑换。");
                    cm.dispose()
