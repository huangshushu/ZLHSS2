	...
	if (mode == -1) {
		...
		if (a == -1) {
			...
			if (selection == 0) {
				...
				cm.dispose();
			 ...
			 else	if (cm.haveItem(4005000, 5) && cm.haveItem(4005001, 5) && cm.haveItem(4005002, 5) && cm.haveItem(4005003, 5) && cm.getInventory(1).getItem(1).getOwner() == "") {
					...
					cm.全服公告("玩家：["+cm.getName()+"]成功强化宝石戒指为第一阶段！恭喜恭喜！");
					cm.dispose();
				} else {
