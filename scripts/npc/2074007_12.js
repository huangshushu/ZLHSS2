...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (mode == 1)
			...
			status--;
		if (status == 0) {
			var t = "#d#e男神认证通过可以获得以下福利哦~\r\n\r\n";
			t +="#d#e#i1142796# #t1142796##k[#b全属性：#r100#k #b双攻：#r100#k]\r\n";
			...
			t +="#d#e#i2439386# 男神认证每日奖励礼盒#k x #r1#k\r\n\r\n";
            ...
            cm.sendYesNo(t);	
                ...
                if (cm.haveItem(4031042) == false) {
			        ...
			        cm.gainItem(2439386,1);//男神认证每日奖励礼盒
                    cm.sendOk("恭喜您成功兑换月光女神勋章.");
			cm.getMap().startMapEffect("恭喜玩家 "+cm.getChar().getName()+" 成功兑换男神勋章。", 5120012);
			cm.worldSpouseMessage(0x28, "[男神认证] : 恭喜 " + cm.getChar().getName() + " 成功领取了月光岛男神勋章并获得了大量奖励！！！");
			cm.dispose();
                } 
				}
      }
