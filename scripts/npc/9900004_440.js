    ...
    if (mode == -1) {
		...
		var tex2 = ""+cm.getHyPay(1)+"";
           // text += "#L72##r" + 蓝色角点 + "材料合成#r New     #v4251202##z4251202##l#l\r\n\r\n"//3
		    text += "#L70##r" + 蓝色角点 + "#v1032206#神话I#r #l\r\n"//3
            text += "#L71##r" + 蓝色角点 + "#v1032207#神话II#r #l\r\n"//3
			text += "#L72##r" + 蓝色角点 + "#v1032208#神话III#r #l\r\n"//3
			text += "#L73##r" + 蓝色角点 + "#v1032209#神话IV#r #l\r\n"//3
			text += "#L74##r" + 蓝色角点 + "#v1032219#遗忘神话#r #l\r\n"//3
