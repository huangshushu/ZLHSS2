...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        txt = "\t\t　 #b " + Icon[73][1] + " #r#e #fs16#副本入口#fs12# #n#b " + Icon[74][1] + " #k\r\n\r\n";
        txt += Icon[41][1];
        for (var i = 0; i <= 59; i++) {
            txt += Icon[42][1];
        };
        ...
        txt += "　" + Icon[68][1] + "　#b推荐等级 #r230 - 250#b　　推荐人员 #r 3 - 6　　 " + Icon[68][1] + "#k\r\n\r\n";
        ...
        if (selection == 1) {
          /*  if (!cm.haveItem(道具, 5)) {
                cm.playerMessage(1, "\r\n\r\n抱歉\r\n你没有 " + cm.getItemName(道具) + " 5 个不能开启副本\r\n");
                cm.dispose();
                return;
            }          */
