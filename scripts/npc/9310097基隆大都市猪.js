		...
		if (status == 0) {
			...
			if ( choose == 0 ) {
				...
				if ( dc == 0 ) { // potential develop
					...
					var itemid = item.getItemId();
					var pretext = "你确定要使用#b#t"+ stone[ds][1] +"##k来开发#r[#t"+ itemid +"#]#k的潜能吗？\r\n#b[成功率："+ (stone[ds][2] * 100) +"%]#k\r\n";
					...
					} else if ( !cm.haveItem(clearstone) ) {
