...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		var tex2 = ""+cm.getHyPay(1)+"";
            ...
            text += "#r#L1##v1102039#升为1阶全属性+3需要\r\n#k#v4310081#x10#v4031997#x10#l\r\n"//3
			text += "#r#L2##v1102039#升为2阶全属性+3需要\r\n#k#v4310081#x10#v4031997#x10#l\r\n"//3
			text += "#r#L3##v1102039#升为3阶全属性+3需要\r\n#k#v4310081#x10#v4031997#x10#l\r\n"//3
			text += "#r#L4##v1102039#升为满阶全属性+3需要\r\n#k#v4310081#x10#v4031997#x10#l\r\n"//3
			text += "#r#L5##v1102039#升为史诗全属性+5需要\r\n#k#v4310081#x30#v4031997#x50+5000点券+10000抵用券+2500W金币#l\r\n"//5
			text += "#r#L6##v1102039#升为传说全属性+6需要\r\n#k#v4310081#x30#v4031997#x100+10000点券+20000抵用券+5000W金币#l\r\n"//5
			text += "#r#L7##v1102039#升为超越全属性+7需要\r\n#k#v4310081#x30#v4031997#x150+15000点券+30000抵用券+1E金币#l\r\n"//5
