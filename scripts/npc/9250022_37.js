...
function action(mode, type, selection) {
    if (mode == -1) {
	    ...
	    var a3 = "#L3#" + 正方箭头 + "#r#z1122135##l\r\n\r\n"+圆形+"800个#v4001126#+500万冒险币+#v1122022#制作\r\n";
	    var a4 = "#L4#" + 正方箭头 + "#r#z1122140##l\r\n\r\n"+圆形+"1500个#v4001126#+2000万冒险币+#v1122135#+20个#v4005002#制作\r\n";
	    var a5 = "#L5#" + 正方箭头 + "#r#z1122036##l\r\n\r\n"+圆形+"3000个#v4001126#+5000万冒险币+#v1122140#+30个#v4005002#制作\r\n";
		...
		if (cm.haveItem(4001126, 800)&&cm.getMeso()>=5000000&&cm.haveItem(1122022, 1)) {
			...
			cm.sendOk("#z1122135#已经制作好了，去试一下吧");
			cm.dispose();
			return;
		} else {
			cm.sendOk("你的材料不足!!!");
		...
		if (cm.haveItem(4001126, 1500)&&cm.getMeso()>=20000000&&cm.haveItem(1122135, 1)&&cm.haveItem(4005002, 20)) {
			...
			cm.sendOk("#z1122140#已经制作好了，去试一下吧");
			cm.dispose();
			return;
		} else {
			cm.sendOk("你的材料不足!!!");
		...
		if (cm.haveItem(4001126, 3000)&&cm.getMeso()>=50000000&&cm.haveItem(1122140, 1)&&cm.haveItem(4005002, 30)) {
			...
			cm.sendOk("#z1122036#已经制作好了，去试一下吧");
			cm.dispose();
			return;
		} else {
			cm.sendOk("你的材料不足!!!");
