...
Array(1003797,4310021,10,1), //25
Array(1003798,4310021,10,1), //25
Array(1003799,4310021,10,1), //25
Array(1003800,4310021,10,1), //25
Array(1003801,4310021,10,1), //25

Array(1062165,4310021,10,1), //25
Array(1062166,4310021,10,1), //25
Array(1062167,4310021,10,1), //25
Array(1062168,4310021,10,1), //25
Array(1062169,4310021,10,1), //25

Array(1042254,4310021,10,1), //25
Array(1042255,4310021,10,1), //25
Array(1042256,4310021,10,1), //58
Array(1042257,4310021,10,1), //58%
Array(1042258,4310021,10,1) //58%
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            sl = cm.getPlayer().getItemQuantity(4310021, false);
            StringS = "#b#n   角色剩余:" + sl + " 个#v4310021#（请保证背包有空间，否则会消失）";
