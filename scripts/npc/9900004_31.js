...
function action(k, e, s) {
    ...
    if (status == 0) {
        ...
        if (cm.getPlayer().getGMLevel() == 6) {
            ...
            if (cm.GetPiot("金币拍卖行开关", "1") <= 0) {
                j += "\r\n\t\t\t  #L100#" + jt + " #b金币拍卖行#g[开启中]#k#l";
            }
            if (cm.GetPiot("金币拍卖行开关", "1") >= 1) {
                j += "\r\n\t\t\t  #L101#" + jt + " #b金币拍卖行#r[关闭中]#k#l";
            }
            j += "\r\n\t\t\t  #L999#" + jt + " #r扩充容纳价格#l";
        }
        ...
        if (status == 1) {
            sel_0 = s;
            if (sel_0 == 100) {
                cm.GainPiot("金币拍卖行开关", "1", -金币拍卖行开关);
                cm.GainPiot("金币拍卖行开关", "1", 1);
                cm.dispose();
                ...
                var j = "          " + 心 + "  " + 心 + "  #e#d★ 交易金币兑换 ★#k#n  " + 心 + "  " + 心 + "\r\n\r\n";
                j += "            #r比例:  1 点jt == " + ratio_point + "金币#k\r\n\r\n";
                j += "\t\t\t\t#b#L1#" + 箭头 + "金币兑换jt#l#k \r\n#b\t\t\t\t#L2#" + 箭头 + "jt兑换金币#l#k\r\n";
                ...
                if (sel_0 == 22) {
                   ...
                   // j += "    #v1402037#   #v2000005#    #v3010532#    #v4000016#    #v5570000#";
                    cm.sendSimple(j);
                } else {
                    if (sel_0 == 23) {
            ...
            if (status == 2) {
                ...
                if (sel_0 == 21) {
                    cm.sendGetNumber("#b提示：你当前可以兑换 #r" + 金币 + "#k #bjt\r\n提示：你当前可以兑换 #r" + (auctionPoint == null ? 0 : auctionPoint.getPoint()) + "#k #b金币#d\r\n\r\n#k请输入你要兑换的jt数量:#k", 1, 1, 200000000);
                } else {
                    if (sel_0 == 22) {
                        ...
                        var j = "   #v2000005# #v2000005#  #b★#r拍卖市场商品浏览#b★ #v2000005# #v2000005##k#n\r\n#r#e#r[金币]#k#n_______________________________________________#k\r\n";
                        ...
                        if (sel_0 == 23) {
                            if (sel_1 == 1) {
                                ...
                                j += "  #b#L1#" + 装备2 + "#l#k#b  #L2#" + 消耗2 + "#l#k#b  #L3#" + 设置2 + "#l  #L4#" + 其他2 + "#l#k  #L5#" + 特殊2 + "#l#k\r\n\r\n";
                                cm.sendSimple(j);
                            } else {
                                if (sel_1 == 2) {
                ...
                if (status == 3) {
                    ...
                    if (sel_0 == 21) {
                        if (sel_1 == 1) {
                            if (sel_2 * ratio_point > cm.判断金币()) {
                                cm.sendOkS("金币不足:兑换" + sel_2 + "点jt需要" + sel_2 * ratio_point + "金币", 3);
                                cm.dispose();
                                return;
                            }
                            var o = cm.auction_addPoint1(sel_2);
                            if (o > -1) {
                                cm.gainMeso(-sel_2 * ratio_point);
                        ...
                        if (sel_0 == 22) {
                            ...
                            var j = "";
                            j += "#b道具#v" + r.getItem().getItemId() + "# #r" + r.getPrice() + "#b点/#r" + r.getQuantity() + "#b个 卖家#d[" + r.getCharacterName() + "] #b拍卖状态:" + (r.getAuctionState1().getState() == 0 ? "#k" : r.getAuctionState1().getState() == 1 ? "#r" : "#d") + r.getAuctionState1() + (r.getAuctionState1().getState() == 2 ? "[" + r.getBuyerName() + "]" : "") + "\r\n\r\n";
