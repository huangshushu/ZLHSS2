...
textz += "#L7##b" + 红色箭头 + "0星直接升级#e#b#n#r15★#e#b" + 蓝色角点 + "  需要#v4001255#×1个#l\r\n";
...
textz += "#L11##b" + 红色箭头 + "0星直接升级#e#b#n#r15★#e#b" + 蓝色角点 + "  需要#v4310010#×1个#l\r\n";
cm.sendSimple (textz);   
...
if(cm.getChar().getInventory(Packages.client.inventory.MapleInventoryType.EQUIP).getItem(1).getOwner() != xold0){ 
cm.sendOk("#e#d您的装备#r星级#d为#k【#b"+ cm.getChar().getInventory(Packages.client.inventory.MapleInventoryType.EQUIP).getItem(1).getOwner() +"#k】#d未满足强化要求！！");
cm.dispose();
return;
}
...
Packages.server.MapleInventoryManipulator.addFromDrop(cm.getC(),item,false);
var a=item.getItemId();
cm.serverNotice("『15星必成公告』：恭喜【"+ cm.getChar().getName() +"】的装备升为【"+ cm.getChar().getInventory(Packages.client.inventory.MapleInventoryType.EQUIP).getItem(1).getOwner() +"】 战斗力大幅提升！");
