...
var 装备列表 = Array(//ID、前缀、攻击、魔攻、力量、敏捷、智力、运气、物防、魔防、命中、回避、速度、跳跃、可升级次数
	Array(1052202, "一阶段", 1, 1, 1, 1, 1, 1, 10, 10, 10, 10, 0, 0, 10),
	Array(1052918, "二阶段", 3, 3, 3, 3, 3, 3, 30, 30, 30, 30, 0, 0, 10),
	Array(1052350, "三阶段", 6, 6, 6, 6, 6, 6, 60, 60, 60, 60, 0, 0, 10),
	Array(1052457, "满阶段", 10, 10, 10, 10, 10, 10, 100, 100, 100, 100, 0, 0, 10),
	Array(1052569, "史诗", 15, 15, 15, 15, 15, 15, 150, 150, 150, 150, 0, 0, 10),
	Array(1052929, "传说", 23, 23, 23, 23, 23, 23, 230, 230, 300, 300, 0, 0, 10)
);
