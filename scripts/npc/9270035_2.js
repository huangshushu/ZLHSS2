	...
	if (mode == -1) {
		...
		if (a == -1) {
			...
			if (selection == 0) {
				...
				if(cm.getPlayer().getOneTimeLoga("透明武器1阶") > 0){
			 ...
			 else	if (cm.haveItem(4310081, 10) && cm.haveItem(4031997, 10) && cm.getInventory(1).getItem(1).getOwner() == "") {
					cm.getPlayer().setOneTimeLoga("透明武器1阶");
