            ...
            if (cm.getPlayer().getLevel() < 25) {
                ...
                if (chance <= 1) {
                   ...
                   // cm.worldMessage(6, "[赌场公告]：玩家 " + cm.getChar().getName() + " ，在赌场五倍赌博机输了，看来今天并不被女神眷顾!");
                    ...
                    //cm.worldMessage(6, "[赌场公告]：玩家 " + cm.getChar().getName() + " ，在赌场五倍赌博机手抖了一下，赌局作废。");
                    cm.dispose();
                } else if (chance == 3) {
                    cm.getPlayer().modifyCSPoints(2, -50, true);
                    cm.sendNext("#i3994125# - #r你输了#k");
                    ...
                    cm.getPlayer().modifyCSPoints(2, 40 * 5, true);
                    cm.sendNext("#i3994125# -#r不错哦，恭喜你赢了，我愿赌服输!获得200点枫叶点数");
                    cm.mapMessage("[赌场公告]：玩家 " + cm.getChar().getName() + " ，在赌场五倍赌博机赢了，将筹码翻了【五倍】获得200点枫叶点数!");
                    cm.dispose();
                }
            }
        }
