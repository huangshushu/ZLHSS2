	...
	if (mode == -1) {
		...
		if (a == -1) {
			...
			if (selection == 0) {
				...
				cm.dispose();
			 ...
			 else	if (cm.haveItem(4005000, 15) && cm.haveItem(4005001, 15) && cm.haveItem(4005002, 15) && cm.haveItem(4005003, 15) && cm.getInventory(1).getItem(1).getOwner() == "第二阶段") {
					...
					cm.全服公告("玩家：["+cm.getName()+"]成功强化宝石戒指为第三阶段！恭喜恭喜！");
					cm.dispose();
				} else {
