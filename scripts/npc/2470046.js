...
function action(mode, type, selection) {
    ...
    if (mode == -1) {
        ...
        if (a == -1) {
            ...
            text = "#h0#，欢迎来到#e#r绝版点装商城,近期价格调整以及加入新时装#n#k，#b#e\r\n\r\n";
            text += "#d\t- 您当前#b点卷#d元宝：" + cm.getNX(1) + "\r\n#k";
            text += "#d\t- 您当前#b#d元宝：" + cm.getHyPay(1) + "\r\n#k";
            text += "#d#e#L2014#我要进行搜索#l #r#L2015#我要进入试穿模式#l#k#n\r\n";
            text += "#d#e#L2016##r<誓言>#b 爱的殿堂-婚礼村！#n\r\n";
            text += "#d#e#L2016##r<誓言>#b 爱的殿堂-婚礼村！#n\r\n";
...
function getItemList() {
    ...
    if (rs.length > 0) {
        rsList.push(Array(rs.get("itemid"), Math.floor(rs.get("itemprice") * discount)));
    }
    return rsList;
}
