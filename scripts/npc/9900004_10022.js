...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		var tex2 = ""+cm.getHyPay(1)+"";
            ...
            text += "#r#L1##v1114303#升为1阶全属性+5需要\r\n#k#v4002000#x15 #v4002001#x15 #v4002002#x15 #v4002003#x15 #v4031559#x15#l\r\n"//3
			text += "#r#L2##v1114303#升为2阶全属性+5需要\r\n#k#v4002000#x30 #v4002001#x30 #v4002002#x30 #v4002003#x30 #v4031559#x30#l\r\n"//3
			text += "#r#L3##v1114303#升为3阶全属性+5需要\r\n#k#v4002000#x50 #v4002001#x50 #v4002002#x50 #v4002003#x50 #v4031559#x50#l\r\n"//3
			text += "#r#L4##v1114303#升为满阶全属性+5需要\r\n\r\n#k#v4002000#x75 #v4002001#x75 #v4002002#x75 #v4002003#x75 #v4031559#x75#l\r\n\r\n"//3

text += "\r\n"+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n\r\n"
		    cm.sendSimple(text);
        } else if (selection == 1) {//贝勒制作
            cm.openNpc(9900004, 10064);
		} else if (selection == 2) {//贝勒制作
            cm.openNpc(9900004, 10065);
		} else if (selection == 3) {//贝勒制作
            cm.openNpc(9900004, 10066);
		} else if (selection == 4) {//贝勒制作
            cm.openNpc(9900004, 10067);
