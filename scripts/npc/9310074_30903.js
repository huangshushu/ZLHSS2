...
var 金币 = 1000000;
var itemlist = Array(
	Array(1082647, 1082545),
	Array(1082545, 1082556),
	Array(1082556, 1082638)
    ...
    if (mode == -1) {
        ...
        if (a == -1) {
			...
			if (selection == 0) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1082647#放在装备栏#r第1格#b，#v1082545#放在#r第2格\r\n\r\n";
			    text += "#b需要材料：#v4001158#*25，#v4000082#*25\r\n          #v4031456#*200，#v4251102#*15，#v4011007#*3，#v4011008#*3\r\n          #v4310143#*120，金币*1E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 1) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1082545#放在装备栏#r第1格#b，#v1082556#放在#r第2格\r\n\r\n";
			    text += "#b需要材料：#v4001158#*30，#v4000082#*30\r\n          #v4031456#*200，#v4251102#*20，#v4011007#*4，#v4011008#*4\r\n          #v4310143#*160，金币*1.5E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 2) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1082556#放在装备栏#r第1格#b，#v1082638#放在#r第2格\r\n\r\n";
			    text += "#b需要材料：#v4001158#*40，#v4000082#*40\r\n          #v4031456#*200，#v4251102#*25，#v4011007#*5，#v4011008#*5\r\n          #v4310143#*200，金币*2E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
		} else if (a == 2) {
			if (b == 1) {
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
				    ...
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1082647 || cm.getInventory(1).getItem(2).getItemId() != 1082545)  {
				...
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
		            cm.sendOk("#b请将神铸所需的装备放置在装备栏的#r第1、2格#b！");
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1082545 || cm.getInventory(1).getItem(2).getItemId() != 1082556)  {
		            cm.sendOk("#r第1、2格装备#r不符合要求，请仔细确认！");
				    cm.dispose();
				} else {
					var ItemID = cm.getInventory(1).getItem(1).getItemId();
				...
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
		            cm.sendOk("#b请将神铸所需的装备放置在装备栏的#r第1、2格#b！");
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1082556 || cm.getInventory(1).getItem(2).getItemId() != 1082638)  {
		            cm.sendOk("#r第1、2格装备#r不符合要求，请仔细确认！");
				    cm.dispose();
				} else {
					var ItemID = cm.getInventory(1).getItem(1).getItemId();
			...
			if (b == 1) {
				...
				if (cm.haveItem(4001158,25) && cm.haveItem(4000082,25) && cm.haveItem(4031456,200) && cm.haveItem(4251102,15) && cm.haveItem(4011007,3) && cm.haveItem(4011008,3)  && cm.haveItem(4310143,120)&& cm.getMeso() >= 100000000) {
				...
				var 可砸次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
				var 星级 = cm.getInventory(1).getItem(1).getOwner();	
				if (cm.haveItem(4001158,30) && cm.haveItem(4000082,30) && cm.haveItem(4031456,200) && cm.haveItem(4251102,20) && cm.haveItem(4011007,4) && cm.haveItem(4011008,4)  && cm.haveItem(4310143,160)&& cm.getMeso() >= 150000000) {
				...
				var 可砸次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
				var 星级 = cm.getInventory(1).getItem(1).getOwner();	
				if (cm.haveItem(4001158,40) && cm.haveItem(4000082,40) && cm.haveItem(4031456,200) && cm.haveItem(4251102,25) && cm.haveItem(4011007,5) && cm.haveItem(4011008,5)  && cm.haveItem(4310143,200)&& cm.getMeso() >= 200000000) {
					cm.gainItem(4001158,-40);
					cm.gainItem(4000082,-40);
					cm.gainItem(4031456,-200);
					cm.gainItem(4251102,-25);
