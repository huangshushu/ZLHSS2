...
Array(2290011,2028175,1,1), //25  qingwu
Array(2290021,2028175,1,1), //25  联欢缓坡	
Array(2290023,2028175,1,1), //25    黑棋
Array(2290031,2028175,1,1), //25	火独
Array(2290042,2028175,1,1), //25    饼类
Array(2290049,2028175,1,1), //25   助教
Array(2290061,2028175,1,1), //25
Array(2290074,2028175,1,1), //25
Array(2290084,2028175,1,1), //25
Array(2290083,2028175,1,1), //25
Array(2290107,2028175,1,1), //25
Array(2290118,2028175,1,1), //25
Array(2290133,2028175,1,1)
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            sl = cm.getPlayer().getItemQuantity(2028175, false);
            StringS = "#b#n   角色剩余:" + sl + " 个#v2028175#（请保证背包有空间，否则会消失）";
