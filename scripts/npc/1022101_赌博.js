...
var zhuangScore = 0;
var xianScore = 0;
var paiArray = Array(2,3,4,5);
var paiArray2 = Array(4,5,6,7);
var ran = -1;
		...
		//------------第二次要牌------------------//
			...
			if(selection == 2){
				...
				if(xianScore>21){
					...
					//cm.gainMeso(-selectionMeso);
					cm.worldMessage(6, "[搏一搏] :  " + cm.getPlayer().getName() + " 金币搏一搏输了" );
					cm.dispose();	
				}else{
					text2 = "";
					text2 += "#n#k,您目前的点数为： #r#e" + xianScore + "#n#k ，";
				...
				if((xianScore<22 && xianScore<=zhuangScore && zhuangScore<22) || (xianScore>=22 && zhuangScore>=22)){
					...
					cm.worldMessage(6, "[搏一搏] : 恭喜 " + cm.getPlayer().getName() + " 金币搏一搏赢了" );
					cm.dispose();	
				}
			}
