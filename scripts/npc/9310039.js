        ...
        if (status == 0) {
            ...
            if (selection == 0) {
                ...
                if (cm.getQuestStatus(8534) != 2) {
                    ...
                    cm.sendOk("请叫你的队长来找我!");
                    cm.dispose();
                } else if (cm.checkPartyBossLogCopy('shaoling', 2) > 0) {
                    cm.sendOk("每天只能打2次妖僧，队伍中有人已经超过次数了！");
                    cm.dispose();
                } else {
                    ...
                    if (next) {
                        ...
                        if (em == null) {
                            ...
                            if (prop.equals("0") || prop == null) {
                                ...
                                cm.setPartyBossLogCopy("shaoling");
                                cm.dispose();
                                return;
                            } else {
                                cm.sendOk("里面已经有人在挑战...");
                        ...
                        cm.sendOk("你的队伍貌似没有达到要求...需要 6 人以上且达到 50 等到 200 等。");
                    }
                }
                cm.dispose();
            }
