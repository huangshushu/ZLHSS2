...
function start() {
    if (cm.getBossLog("挑战副本4") > 1) {
        ...
        cm.sendOk("每天挑战2次 需要190级~");
        cm.dispose();
    } else if (cm.getPlayerCount(209000002) > 0 && cm.getBossLog('挑战暴力熊4') < 3|| cm.getPlayerCount(209000002) > 0) {
