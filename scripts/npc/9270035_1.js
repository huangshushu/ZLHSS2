...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		var tex2 = ""+cm.getHyPay(1)+"";
            ...
            text += "#r#L1##v1702224#升为1阶全属性+3需要\r\n#k#v4310081#x10#v4031997#x10#l\r\n"//3
			text += "#r#L2##v1702224#升为2阶全属性+3需要\r\n#k#v4310081#x10#v4031997#x10#l\r\n"//3
			text += "#r#L3##v1702224#升为3阶全属性+3需要\r\n#k#v4310081#x10#v4031997#x10#l\r\n"//3
			text += "#r#L4##v1702224#升为满阶全属性+3需要\r\n#k#v4310081#x10#v4031997#x10#l\r\n"//3
			text += "#r#L5##v1702224#升为史诗全属性+5需要\r\n#k#v4310081#x30#v4031997#x50+5000点券+10000抵用券+2500W金币#l\r\n"//5
			text += "#r#L6##v1702224#升为传说全属性+6需要\r\n#k#v4310081#x30#v4031997#x100+10000点券+20000抵用券+5000W金币#l\r\n"//5
			text += "#r#L7##v1702224#升为超越全属性+7需要\r\n#k#v4310081#x30#v4031997#x150+15000点券+30000抵用券+1E金币#l\r\n"//5
...
text += "\r\n"+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n\r\n"
            ...
            //cm.openNpc(9900004, 10060);
			cm.openNpc(9270035, 2);
		} else if (selection == 2) {//贝勒制作
            //cm.openNpc(9900004, 10061);
			cm.openNpc(9270035, 3);
		} else if (selection == 3) {//贝勒制作
            //cm.openNpc(9900004, 10062);
			cm.openNpc(9270035, 4);
		} else if (selection == 4) {//贝勒制作
            //cm.openNpc(9900004, 10063);
			cm.openNpc(9270035, 5);
		} else if (selection == 5) {//贝勒制作
            //cm.openNpc(9900004, 100631);
			cm.openNpc(9270035, 6);
		} else if (selection == 6) {//贝勒制作
            //cm.openNpc(9900004, 100632);
			cm.openNpc(9270035, 7);
		} else if (selection == 7) {//贝勒制作
            //cm.openNpc(9900004, 100633);
			cm.openNpc(9270035, 8);
