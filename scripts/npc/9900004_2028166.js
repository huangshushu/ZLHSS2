...
Array(1492231,2028166,1,1), //25
Array(1482216,2028166,1,1), //25
Array(1472261,2028166,1,1), //25
Array(1462239,2028166,1,1), //25
Array(1452252,2028166,1,1), //25
Array(1442268,2028166,1,1), //25
Array(1432214,2028166,1,1), //25
Array(1422184,2028166,1,1), //25
Array(1412177,2028166,1,1), //25
Array(1402251,2028166,1,1), //25
Array(1382259,2028166,1,1), //25
Array(1332274,2028166,1,1), //25
Array(1322250,2028166,1,1), //25
Array(1312199,2028166,1,1), //25
Array(1302333,2028166,1,1)//25
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            sl = cm.getPlayer().getItemQuantity(2028166, false);
            StringS = "#b#n   角色剩余:" + sl + " 个#v2028166#（请保证背包有空间，否则会消失）";
