	...
	if (mode == -1) {
		...
		if (a == -1) {
			...
			if (selection == 0) {
		        ...
		        if(dmID!=1114303) {
		        cm.sendOk("把#v1114303#放在第一格!");
				cm.dispose();
				}  
			 else	if (cm.haveItem(4002000, 75) && cm.haveItem(4002001, 75) && cm.haveItem(4002002, 75) && cm.haveItem(4002003, 75) && cm.haveItem(4031559, 75) && cm.getInventory(1).getItem(1).getOwner() == "第三阶段") {
					...
					cm.gainItem(4002000, -75);
					cm.gainItem(4002001, -75);
					cm.gainItem(4002002, -75);
					cm.gainItem(4002003, -75);
					cm.gainItem(4031559, -75);
					cm.sendOk("强化成功，当前装备等级为 “#r满阶#k”。\r\n #r#e全属性增加[5]点");
					cm.全服公告("玩家：["+cm.getName()+"]成功强化邮票戒指为满阶！恭喜恭喜！");
					cm.dispose();
				} else {
