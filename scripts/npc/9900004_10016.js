...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		var tex2 = ""+cm.getHyPay(1)+"";
            ...
            text += "#r#L1##v1113090#升为1阶全属性+3需要\r\n#k#v4005000#x5#v4005001#x5#v4005002#x5#v4005003#x5#l\r\n"//3
			text += "#r#L2##v1113090#升为2阶全属性+3需要\r\n#k#v4005000#x10#v4005001#x10#v4005002#x10#v4005003#x10#l\r\n"//3
			text += "#r#L3##v1113090#升为3阶全属性+3需要\r\n#k#v4005000#x15#v4005001#x15#v4005002#x15#v4005003#x15#l\r\n"//3
			text += "#r#L4##v1113090#升为满阶全属性+3需要\r\n#k#v4005000#x20#v4005001#x20#v4005002#x20#v4005003#x20#l\r\n"//3

text += "\r\n"+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n\r\n"
		    cm.sendSimple(text);
        } else if (selection == 1) {//贝勒制作
            cm.openNpc(9900004, 10055);
		} else if (selection == 2) {//贝勒制作
            cm.openNpc(9900004, 10056);
		} else if (selection == 3) {//贝勒制作
            cm.openNpc(9900004, 10057);
		} else if (selection == 4) {//贝勒制作
            cm.openNpc(9900004, 10058);
