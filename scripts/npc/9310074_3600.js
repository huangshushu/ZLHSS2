...
var 金币 = 1000000;
var itemlist = Array(
	Array(1113084, 1113016),
	Array(1113016, 1112597)
    ...
    if (mode == -1) {
        ...
        if (a == -1) {
			...
			if (selection == 0) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1113084#放在装备栏#r第1格#b，#v1113016#放在#r第2格\r\n\r\n";
		        text += "#b需要材料：#v4000186#*80，#v4001094#*20，#v4001080#*10，#v4001081#*10\r\n          #v4001082#*10，#v4310143#*150，金币*1.2E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 1) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1113016#放在装备栏#r第1格#b，#v1112597#放在#r第2格\r\n\r\n";
		        text += "#b需要材料：#v4000186#*100，#v4001094#*30，#v4001080#*15，#v4001081#*15\r\n          #v4001082#*15，#v4310143#*200，金币*2E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 2) {
			...
			if (b == 1) {
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
				    ...
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1113084 || cm.getInventory(1).getItem(2).getItemId() != 1113016)  {
				...
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
		            cm.sendOk("#b请将神铸所需的装备放置在装备栏的#r第1、2格#b！");
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1113016 || cm.getInventory(1).getItem(2).getItemId() != 1112597)  {
		            cm.sendOk("#r第1、2格装备#r不符合要求，请仔细确认！");
				    cm.dispose();
				} else {
					var ItemID = cm.getInventory(1).getItem(1).getItemId();
			...
			if (b == 1) {
				...
				if (cm.haveItem(4000186,80) && cm.haveItem(4001094,20) && cm.haveItem(4001080,10) && cm.haveItem(4001081,10) && cm.haveItem(4001082,10) && cm.haveItem(4310143,150) && cm.getMeso() >= 120000000) {
					cm.gainItem(4000186,-80);
				...
				var 可砸次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
				var 星级 = cm.getInventory(1).getItem(1).getOwner();	
				if (cm.haveItem(4000186,100) && cm.haveItem(4001094,30) && cm.haveItem(4001080,15) && cm.haveItem(4001081,15) && cm.haveItem(4001082,15) && cm.haveItem(4310143,200) && cm.getMeso() >= 200000000) {
