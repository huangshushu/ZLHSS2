...
var 金币 = 1000000;
var itemlist = Array(
	Array(1113089, 1113149),
	Array(1113149, 1113056)
    ...
    if (mode == -1) {
        ...
        if (a == -1) {
			...
			if (selection == 0) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1113089#放在装备栏#r第1格#b，#v1113149#放在#r第2格\r\n\r\n";
			    text += "#b需要材料：#v4310008#*40，#v4251202#*10，#v4011007#*4，#v4011008#*4，                    #v4310143#*150，金币*1E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 1) {
				...
				text += "              #r欢迎来到月月冒险岛装备神铸#k\r\n";
				text += ""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+""+红枫叶+"\r\n";
				text += "      #b请将#v1113149#放在装备栏#r第1格#b，#v1113056#放在#r第2格\r\n\r\n";
			    text += "#b需要材料：#v4310008#*50，#v4251202#*15，#v4011007#*6，#v4011008#*6，                    #v4310143#*200，金币*2E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
			else if (selection == 2) {
			    ...
			    text += "#b需要材料：#v4310008#*60，#v4251202#*20，#v4011007#*8，#v4011008#*8，                    #v4310143#*250，金币*3E\r\n";
				text += "                  #r确定是否要进行神铸\r\n";
				cm.sendYesNo(text);
			}
		} else if (a == 2) {
			if (b == 1) {
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
				    ...
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1113089 || cm.getInventory(1).getItem(2).getItemId() != 1113149)  {
				...
				if (cm.getInventory(1).getItem(1) == null || cm.getInventory(1).getItem(2) == null)  {
		            cm.sendOk("#b请将神铸所需的装备放置在装备栏的#r第1、2格#b！");
				    cm.dispose();
				} else if (cm.getInventory(1).getItem(1).getItemId() != 1113149 || cm.getInventory(1).getItem(2).getItemId() != 1113056)  {
		            cm.sendOk("#r第1、2格装备#r不符合要求，请仔细确认！");
				    cm.dispose();
				} else {
					var ItemID = cm.getInventory(1).getItem(1).getItemId();
			...
			if (b == 1) {
				...
				if (cm.haveItem(4310008,40) && cm.haveItem(4251202,10) && cm.haveItem(4011007,4) && cm.haveItem(4011008,4) && cm.haveItem(4310143,150) && cm.getMeso() >= 100000000) {
					cm.gainItem(4310008,-40);
				...
				var 可砸次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
				var 星级 = cm.getInventory(1).getItem(1).getOwner();	
				if (cm.haveItem(4310008,50) && cm.haveItem(4251202,15) && cm.haveItem(4011007,6) && cm.haveItem(4011008,6) && cm.haveItem(4310143,200) && cm.getMeso() >= 200000000) {
					cm.gainItem(4310008,-50);
				...
				var 可砸次数 = cm.getInventory(1).getItem(1).getUpgradeSlots();	
				var 星级 = cm.getInventory(1).getItem(1).getOwner();	
				if (cm.haveItem(4310008,60) && cm.haveItem(4251202,20) && cm.haveItem(4011007,8) && cm.haveItem(4011008,8) && cm.haveItem(4310143,250) && cm.getMeso() >= 300000000) {
					cm.gainItem(4310008,-60);
					cm.gainItem(4251202,-20);
					cm.gainItem(4011007,-8);
					cm.gainItem(4011008,-8);
					cm.gainItem(4310143,-250);
