...
function action(mode, type, selection) {
    if (mode == -1) {
		...
		var tex2 = ""+cm.getHyPay(1)+"";
            text += "#L1##r" + 蓝色角点 + "#v2044908#(短枪)X5 兑换X卷轴#r New#l\r\n"//3
			 text += "#L2##r" + 蓝色角点 + "#v2044815#(指节)X5 兑换X卷轴#r New#l\r\n"//3
			  text += "#L3##r" + 蓝色角点 + "#v2044703#(拳套)X5 兑换X卷轴#r New#l\r\n"//3
			   text += "#L4##r" + 蓝色角点 + "#v2044603#(弩)X5 兑换X卷轴#r New#l\r\n"//3
			    text += "#L5##r" + 蓝色角点 + "#v2044503#(弓)X5兑换X卷轴#r New#l\r\n"//3
				 text += "#L6##r" + 蓝色角点 + "#v2044403#(矛)X5 兑换X卷轴#r New#l\r\n"//3
				  text += "#L7##r" + 蓝色角点 + "#v2044303#枪)X5兑换X卷轴#r New#l\r\n"//3
				   text += "#L8##r" + 蓝色角点 + "#v2044203#(双手钝器)X5兑换X卷轴#r New#l\r\n"//3
				    text += "#L9##r" + 蓝色角点 + "#v2044103#(双手斧)X5兑换X卷轴#r New#l\r\n"//3
					 text += "#L10##r" + 蓝色角点 + "#v2044003#(双手剑)X5兑换X卷轴#r New#l\r\n"//3
					  text += "#L11##r" + 蓝色角点 + "#v2043803#(长杖)X5兑换X卷轴#r New#l\r\n"//3
					   text += "#L12##r" + 蓝色角点 + "#v2043703#(短杖)X5兑换X卷轴#r New#l\r\n"//3
					    text += "#L13##r" + 蓝色角点 + "#v2043303#(短剑)X5兑换X卷轴#r New#l\r\n"//3
						 text += "#L14##r" + 蓝色角点 + "#v2043203#(单手钝器)X5兑换X卷轴#r New#l\r\n"//3
						  text += "#L15##r" + 蓝色角点 + "#v2043103#(单手斧)X5兑换X卷轴#r New#l\r\n"//3
						   text += "#L16##r" + 蓝色角点 + "#v2043003#(单手剑)X5兑换X卷轴#r New#l\r\n"//3
