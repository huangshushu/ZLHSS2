...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			cm.sendNext("#r您现在所选择的是#d[进阶瞳印邮票强化]#v1022144##k#l\r\n#d[进阶瞳印邮票强化]#b强化成功率:#r100%#k\r\n#b属性幅度:#r-2~+3#k\r\n#b强化消耗:#v4002000##r*1#k\r\n#d次数限制:每天上限 #r[10] #k次#l\r\n#bPS：#d由于星之力的魔化产生了不可描述的变异,所以该强化系统无论强化成功或失败,均不会扣除强化次数!\r\n");
		} else if (status == 1) {
		...
		//	var 爱心 = "#fEffect/CharacterEff/1022223/4/0#";
			...
			if (!cm.haveItem(4002000,1)&&cm.getMeso()>=500000) {
				cm.sendOk("#b对不起,邮票数量不足:#r[1]颗！#k\r\n\t   #b当前所拥有#v4002000#:#r [#c4002000#] 颗!#l");
				status = -1;
