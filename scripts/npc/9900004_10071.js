...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (a == -1) {
			...
			if (selection == 0) {
				...
				cm.dispose();
			...
			else	if (cm.haveItem(4021009, 25) && cm.haveItem(4011007, 25) && cm.getInventory(1).getItem(1).getOwner() == "第三阶段") {
					...
					cm.gainItem(4021009, -25);
					cm.gainItem(4011007, -25);
					cm.sendOk("强化成功，当前装备等级为 “#r满阶#k”。\r\n #r#e全属性增加[3]点");
					cm.全服公告("玩家：["+cm.getName()+"]成功强化矿石戒指为满阶！恭喜恭喜！");
					cm.dispose();
				} else {
