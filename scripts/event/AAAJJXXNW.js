...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(105200800);
    map.resetFully();
    ...
    Attribute.setOHp(2000000000000);
    ...
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(760, 180));
    return eim;
}
...
function monsterKilled(eim, player, mobID) {
    switch (mobID) {
        case 100100://最后要显示输出伤害的怪物id 通畅都是最后的一个boss
            ...
            C_THREAD(eim, player, 30 * 60 * 1000, "进阶血腥女王", 282);
            var map = eim.getMapInstance(0);
