...
var BOSSMAP = Array(321133000,-132,-359);//乱入出现的地图、X坐标、Y坐标
...
function setup(level, leaderid) {
	...
	if (chance<BOSSChance||em.getProperty("leader")=="true"){
		...
		em.broadcastServerMsg(5121027, "注意：黄昏之林 "+C[2]+" 级BOSS乱入" ,true);
	}
...
function allMonstersDead(eim) {
	em.broadcastServerMsg(5121027, "恭喜玩家通关黄昏之林，请在10秒内狂点NPC获取奖励！" ,true);
