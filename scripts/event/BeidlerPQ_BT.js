...
function setup(level, partyid) {
    ...
    var eim = em.newInstance("BeidlerPQ_BT");
            ...
            if (eim.getProperty("BeidlerHead").equals("0")) {
                ...
                switch (s) {
                    case 0:
                        ...
                        eim.setProperty("rate", "1050000");
                        eim.setProperty("nlevel", "250");
                        break;
                    case 1:
                        eim.setProperty("Core", "2");
                        eim.setProperty("rate", "450000");
                        eim.setProperty("nlevel", "250");
                        break;
                    case 2:
                        eim.setProperty("Core", "1");
                        eim.setProperty("rate", "75000");
                        eim.setProperty("nlevel", "250");
                        break;
                    case 3:
                        eim.setProperty("Core", "0");
                        eim.setProperty("rate", "3000");
                        eim.setProperty("nlevel", "250");
                        break;
                }
