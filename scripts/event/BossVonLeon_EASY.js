...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(211070102);
    map.resetFully();
    ...
    Attribute.setOHp(1000000000000);
...
function monsterKilled(eim, player, mobID) {
    switch (mobID) {
        case 8840007://最后要显示输出伤害的怪物id 通畅都是最后的一个boss
            /* 这里是打死BOSS执行通关 | eim player | 副本时间 | 副本名称  | 公告类型 */
            C_THREAD(eim, player, 30 * 60 * 1000, "班·雷昂", 282);
            var map = eim.getMapInstance(0);
