...
function setup() {
    ...
    var eim = em.newInstance("duanwu");

    var map = eim.setInstanceMap(749040001);
    map.resetFully();
    map.killAllMonsters(false);
    var mob1 = em.getMonster(9600066);
    var modified = em.newMonsterStats();
    modified.setOHp(500000);
    mob1.setOverrideStats(modified);
    eim.registerMonster(mob1);
    map.spawnMonsterOnGroundBelow(mob1, new java.awt.Point(-1207, -18));
...
function playerEntry(eim, player) {
    var map = em.getMapFactory().getMap(749040001);
