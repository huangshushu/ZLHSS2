...
function setup(instanceID, mapID) {
    ...
    var eim = em.newInstance("MG_OmokRenewal" + instanceID);//创建分本实例
    ...
    var map = eim.createInstanceMap(910045000);
    map.resetFully();
    map = eim.createInstanceMap(910045100);
    map.resetFully();
    eim.setProperty("returnMap", "910045200");
...
function warpNext(eim) {
    ...
    eim.startMiniGame(0xE, 910045100);
}
