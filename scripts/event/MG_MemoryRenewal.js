...
function setup(instanceID, mapID) {
    ...
    var eim = em.newInstance("MG_MemoryRenewal" + instanceID);//创建分本实例
    ...
    var map = eim.createInstanceMap(910046000);
    map.resetFully();
    map = eim.createInstanceMap(910046100);
    map.resetFully();
    eim.setProperty("returnMap", "910046200");
...
function warpNext(eim) {
    ...
    eim.startMiniGame(0xF, 910046000);
}
