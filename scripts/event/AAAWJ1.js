...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(993160122);
    map.resetFully();
    map.killAllMonsters(false);
    eim.startEventTimer(TimeA);

    var mob = em.getMonster(9303130);
    Attribute = em.newMonsterStats();
    Attribute.setOHp(500000000000000);
    ...
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(-154, 29));
    return eim;
}
...
function monsterKilled(eim, player, mobID) {
    switch (mobID) {
        case 100100://最后要显示输出伤害的怪物id 通畅都是最后的一个boss
            ...
            C_THREAD(eim, player, 50 * 60 * 1000, "无尽001-020层", 282);
            var map = eim.getMapInstance(0);
