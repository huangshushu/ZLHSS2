...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(105200500);
    map.resetFully();
    ...
    Attribute.setOHp(2230000000000);
    ...
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(1821, 221));
    return eim;
}
...
function monsterKilled(eim, player, mobID) {
    switch (mobID) {
        case 100100://最后要显示输出伤害的怪物id 通畅都是最后的一个boss
            ...
            C_THREAD(eim, player, 30 * 60 * 1000, "进阶贝伦", 282);
            var map = eim.getMapInstance(0);
