...
var reviveCount = 10;
/* 开始地图 退出地图 副本时间 BOSS */
var Group = [100000000, 101050000, 7200000, 9400080]
...
function setup(eim, CharID) {
    ...
    Attribute.setOHp(20000000000000000);//血量
    Attribute.setOMp(mob.getMobMaxMp());
    Attribute.setOExp(1000);
    stats = mob.getStats();
    stats.setPhysicalAttack(300);//攻击?
    stats.setMagicAttack(300);//攻击?
    stats.setPDRate(10);//这个好像是防御不百分比
    stats.setMDRate(10);//一样魔防
    stats.setAcc(5000);//闪避
    stats.setSpeed(80);//移速
    ...
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(896, 334));
