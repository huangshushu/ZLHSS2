...
var itemList=Array(
	...
	Array(2614074, 550), // - 1亿破攻
	Array(2614074, 550), // - 1亿破攻
	Array(3018230, 550), // - 黑魔法师椅子		
	Array(4036584, 550), // - 漆黑羽毛
	Array(4036584, 550), // - 漆黑羽毛
	Array(4036584, 550), // - 漆黑羽毛	

	
	Array(2614074, 550) //  一亿破攻
);
function init() {
...
function setup(level, leaderid) {
	...
	modified.setOHp(mob.getMobMaxHp()*7000000000);
    ...
    mob = em.getMonster(mobid);
	modified = em.newMonsterStats();
	modified.setOHp(mob.getMobMaxHp()*100000);
	modified.setOMp(mob.getMobMaxMp()*999);
	mob.setOverrideStats(modified);
...
function playerRevive(eim, player) {
    var map = em.getMapFactory().getMap(262000000);
    if (map != null) {
        player.changeMap(map, map.getPortal(0));
    }
    eim.disposeIfPlayerBelow(100, 262030000);
