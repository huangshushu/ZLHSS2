var mapId = 910023100;
var item = Array(1000050,1050227,1001076,1042081,1102453,1102390,1102389,1102385,1102386,1102368,1102367,1102358,1102355); //稀有点装
...
function setup(eim, leaderid) {
    ...
    var mob = em.getMonster(8830007);//上帝
...
function allMonstersDead(eim) {
		...
		map.spawnAutoDrop(3993003,chr.getPosition());
                map.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(5, "恭喜，干掉了上帝，获得了" + yp[randyp] + "张邮票和福袋奖励"));
            }
        }
    }
