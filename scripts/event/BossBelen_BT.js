...
function setup(eim, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("BossBelen_BT");
    var map = eim.setInstanceMap(109090204);
    map.resetFully();
    map.killAllMonsters(false);
    var mob = em.getMonster(9303159);//
    modified = em.newMonsterStats();
    modified.setOHp(120000000000000);
    ...
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(-472, 155));
...
function allMonstersDead(eim) {
    ...
    map.spawnNpc(2400006, new java.awt.Point(-472, 155));
