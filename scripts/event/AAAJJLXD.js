...
function setup(level, leaderid) {
    ...
    var map = eim.setInstanceMap(450004550);
    map.resetFully();
    ...
    Attribute.setOHp(9000000000000000);
    ...
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(721, -490));
    return eim;
}
...
function monsterKilled(eim, player, mobID) {
    switch (mobID) {
        case 8880151://最后要显示输出伤害的怪物id 通畅都是最后的一个boss
            ...
            C_THREAD(eim, player, 60 * 60 * 1000, "进阶路西德", 282);
            var map = eim.getMapInstance(0);
