...
var mapcode=993141010;//地图ID
var mobcode=new Array(
	//怪物ID，每次刷新数量，X轴坐标，Y轴坐标（可以通过!mapinfo命令查看当前角色所在坐标位置）
	Array(9010138,5,-127,328),
	Array(9010138,5,-1,329),
	Array(9010138,5,116,327)
);

var dropItems = new Array(9010138,
		//怪物ID，物品ID，爆率，最小值，最大值
		new Array(9010138, 5062024, 100, 1, 1)//闪炫魔方
	);
	
var spawnTime=1000*3;//怪物刷新时间 1000=1秒 （刷新机制为：当角色刚进副本或者地图上的怪都被消灭后开始倒计时刷新）
var Time=50 * 40 * 10;//副本持续时间 1000=1秒
