...
function setup(eim, leaderid) {
    var eim = em.newInstance("BossDorothy_BT");
    ...
    modified.setOHp(mob.getMobMaxHp() * 300000);
    modified.setOMp(mob.getMobMaxMp() * 1550);
...
function spawn(eim) {
    ...
    modified.setOHp(mob2.getMobMaxHp() * 120000);
    modified.setOMp(mob2.getMobMaxMp() * 750);
...
function allMonstersDead(eim) {
    ...
    map.startMapEffect("请先捡取掉落物品后点击NPC领取奖励.点击NPC后就传送回自由市场了！。", 5120092);
	 map.spawnNpc(2400006, new java.awt.Point(740, 184));
}
