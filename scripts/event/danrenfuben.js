...
var reviveCount = 3;
/* 开始地图 退出地图 副本时间 BOSS */
var Group = [101050000, 101050000, 3600000, 9309207]
...
function setup(eim, CharID) {
    ...
    Attribute.setOHp(2000000000000);//血量
    Attribute.setOMp(mob.getMobMaxMp());
    Attribute.setOExp(1000);
    stats = mob.getStats();
    stats.setPhysicalAttack(1000);//攻击?
    stats.setMagicAttack(1000);//攻击?
    stats.setPDRate(1000);//这个好像是防御不百分比
    stats.setMDRate(1000);//一样魔防
    stats.setAcc(500000);//闪避
    ...
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(514, 185));
