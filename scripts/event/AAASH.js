...
function setup(level, leaderid) {
    ...
    Attribute.setOHp(41158950000000000);
    ...
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(2, 196));
    return eim;
}
...
function monsterKilled(eim, player, mobID) {
    switch (mobID) {
        case 9500392://最后要显示输出伤害的怪物id 通畅都是最后的一个boss
