...
em.setProperty("balrogState", "0");
    ...
    var mob2 = em.getMonster(8880501); //left hand is invincible at first
    var mob3 = em.getMonster(100000);
    ...
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(-542, 88));
    map.spawnMonsterOnGroundBelow(mob2, new java.awt.Point(548, 88));
    map.spawnMonsterOnGroundBelow(mob3, new java.awt.Point(1058, 100));
...
function changedMap(eim, player, mapid) {
    if (mapid != 450013100 && mapid != 105100301) {
