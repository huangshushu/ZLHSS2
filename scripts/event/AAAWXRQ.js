...
function setup(level, leaderid) {
    ...
    Attribute.setOHp(500000000000000000);
    ...
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(546, 32));
...
function monsterKilled(eim, player, mobID) {
    switch (mobID) {
        case 8880200://最后要显示输出伤害的怪物id 通畅都是最后的一个boss
            /* 这里是打死BOSS执行通关 | eim player | 副本时间 | 副本名称  | 公告类型 */
            C_THREAD(eim, player, 20 * 60 * 1000, "外星入侵", 282);
            var map = eim.getMapInstance(0);
