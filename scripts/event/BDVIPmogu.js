var eventName="VIPBanZhuan";//脚本名称
var reviveCount = 99;//复活次数
var backMap=101050000;//副本结束后，返回的地图
var mapcode=910196100;//地图ID
var mobcode=new Array(
	//怪物ID，每次刷新数量，X轴坐标，Y轴坐标（可以通过!mapinfo命令查看当前角色所在坐标位置）
	Array(9600038,1,305,155),
	Array(9600038,1,437,155),
	Array(9600038,1,574,155)
);

var dropItems = new Array(9600038,
		//怪物ID，物品ID，爆率，最小值，最大值
		new Array(9600038, 4031997, 100, 1, 1)//蘑菇金币
	);	
var spawnTime=1000*3;//怪物刷新时间 1000=1秒 （刷新机制为：当角色刚进副本或者地图上的怪都被消灭后开始倒计时刷新）
var Time=1000 * 60 * 1.5;//副本持续时间 1000=1秒
