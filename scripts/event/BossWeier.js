...
/*
 * 地图ID 
 * 350160200 - 堕落世界树 - 世界树顶端
 * 350160240 - 堕落世界树 - 世界树顶端
 * 
 * 怪物
 * 8880110 - 戴米安 一阶段
 * 8880111 - 戴米安 二阶段
...
function setup(level, partyid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("BossWeier");
    var map1 = eim.setInstanceMap(450008150);
    var map2 = eim.setInstanceMap(450008400);
    
    map1.resetPQ(level);
    map2.resetPQ(level);

    eim.setProperty("summom", "0");
    //var mob1 = em.getMonster(8880110);
...
function changedMap(eim, player, mapid) {
    if (mapid != 450008150 && mapid != 450008400) {
