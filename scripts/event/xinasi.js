...
function setup(eim, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("xinasi");//改------
    var map = eim.setInstanceMap(271040100);//改------
    map.resetFully();
    map.killAllMonsters(false);
    var mob = em.getMonster(8850011);//改------
    mob.getStats().setChange(true);
    mob.changeLevel(170);//改------
    mob.getChangedStats().setOHp(36200000000);//改------
    mob.setHp(36200000000);//改------
    /*var modified = em.newMonsterStats();
     modified.setOHp(mob.getMobMaxHp() * 300);
     modified.setOMp(mob.getMobMaxMp() * 9000);
     mob.setOverrideStats(modified);*/
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(-147, 115));//改------
