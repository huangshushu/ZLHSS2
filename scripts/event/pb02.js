...
em.setProperty("balrogState", "0");
	...
	map.resetFully();
	eim.setInstanceMap(270050000).resetFully();

    var mob = em.getMonster(8820001);
	...
	modified.setOExp(0);
      ...
      map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(9, -42));
...
function changedMap(eim, player, mapid) {
    if (mapid != 272030400 && mapid != 270050000) {
