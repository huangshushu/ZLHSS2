...
function setup(eim, leaderid) {
    ...
    em.setProperty("leader", "true");
    var eim = em.newInstance("BossBloody_BT");
    var map = eim.setInstanceMap(992020000);
    map.resetFully();
    map.killAllMonsters(false);
    var mob = em.getMonster(8920003);//
    mob.changeLevel(250);
    mob.getChangedStats().setOHp(240000000000000);
    mob.setHp(240000000000000);
    eim.registerMonster(mob);
    map.spawnMonsterOnGroundBelow(mob, new java.awt.Point(437, 155));
...
function allMonstersDead(eim) {
    ...
    map.startMapEffect("请先捡取掉落物品后点击NPC领取奖励.点击NPC后就传送回自由市场了！。", 5120092);
	 map.spawnNpc(2400006, new java.awt.Point(437, 155));
}
