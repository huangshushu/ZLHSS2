...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += " \t" + M14 + "#d豆豆：" + cm.getBeans() + "             " + 点券 + "#d点卷余额:#r" + cm.getPlayer().getCSPoints(1) + "#k\r\n"
            ...
            text += "\t#L23##d" + FSTZ + "公婆戒指#l#L24##d" + FSTZ + "材料兑换#l#L10##d" + FSTZ + "升级礼包#l\r\n";
            ...
            if (cm.getPlayer().isGM()) {
                ...
                text += "#L1001#" + LJ + "属性修改#l#L1002#" + LJ + "装扮中心#L1007#" + LJ + "虚拟上线#l\r\n"
        ...
        if (selection == 10) {//主线任务
            cm.dispose();
            //cm.openNpc(9900004, 10);
            cm.openNpc(9900004, "主线任务");
        }
        if (selection == 11) {//暴君兑换
            cm.dispose();
        ...
        if (selection == 13) {//爆率查询
            cm.dispose();
            //cm.openNpc(9900004, "怪物爆率");	
            cm.openNpc(9900004, "爆率查询");

        }
        if (selection == 14) {//货币兑换
            cm.dispose();
            cm.openNpc(9900004, 10112);

        }
        if (selection == 15) {//BOSS战利品
            cm.dispose();
            cm.openNpc(9900004, 15);
        }
        if (selection == 16) {//背包清理
            cm.dispose();
        ...
        if (selection == 23) {//公婆戒指
            cm.dispose();
            cm.openNpc(9900004, "公婆戒指");
        }
        if (selection == 24) {//材料兑换
            cm.dispose();
            cm.openNpc(9900004, "材料兑换");
        }
        if (selection == 25) {//快速转职
            cm.dispose();
        ...
        if (selection == 101) {//南山银行
            cm.dispose();
            cm.openNpc(9900004, 101);
        }
        if (selection == 102) {//赞助福利，暂未启用
            cm.dispose();
            cm.openNpc(9900004, 102);
        }
        if (selection == 103) {//点卷商城
            cm.dispose();
            cm.openNpc(9900004, 103);
        }
        if (selection == 1111) {//永恒、重生蛋的道具说明
            var txt = "";
        ...
        if (selection == 1000) {//万能传送
            cm.dispose();
            cm.openNpc(9900004, 1000);
        }
        if (selection == 1001) {//属性修改
            cm.dispose();
            cm.openNpc(9900004, 1001);
        }
        if (selection == 1002) {//装扮中心
            cm.dispose();
            cm.openNpc(9900004, 1002);
        }
        if (selection == 1003) {//刷物品
            cm.dispose();
            cm.openNpc(9900004, 1003);
        }
        if (selection == 1004) {//全服信息
            cm.dispose();
            cm.openNpc(9900004, 1004);
        }
        if (selection == 1005) {//测试功能2
            cm.dispose();
            cm.openNpc(9900004, 1005);
        }
        if (selection == 1006) {//删除物品
            cm.dispose();
            cm.openNpc(9900004, 1006);
        }
        if (selection == 1007) {//虚拟上线提示
            cm.dispose();
            cm.openNpc(9900004, 1007);
        }
        if (selection == 1008) {//测试功能3
            cm.dispose();
            cm.openNpc(9900004, 1008);
        }
        if (selection == 1009) {//快速转职
            cm.dispose();
            cm.openNpc(9900004, 1009);
        }
        if (selection == 1010) {//未开发
            cm.dispose();
            cm.openNpc(9900004, 1010);
        }
        if (selection == 1011) {//未开发
            cm.dispose();
            cm.openNpc(9900004, 1011);
        }
        if (selection == 1012) {//功能测试
            cm.dispose();
            cm.openNpc(9900004, 1012);
        }
        if (selection == 1013) {//虚拟抽奖
            cm.dispose();
            cm.openNpc(9900004, 1013);
        }
        if (selection == 1014) {//全服查物品
            cm.dispose();
        ...
        if (selection == 2001) {//测试员面板
            cm.dispose();
            cm.openNpc(9900004, 2001);
        }
        if (selection == 2002) {//摄影地图
            cm.warp(970000000, 0);
            cm.dispose();
        }
        if (selection == 1110) {//全服查物品
            ...
            txt += "\r\n" + cm.getPlayer().getMap().findClosestPortal(cm.getPlayer().getPosition()).getName() + "位置" + cm.getPlayer().getMap().findClosestPortal(cm.getPlayer().getPosition()).getPosition()
