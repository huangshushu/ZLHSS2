...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            var a1 = "#L1#" + 红色箭头 + " #r需要物品：#v4000048#150个 #v4000051#150个 #l\r\n\r\n"+圆形+"完成奖励：300点券\r\n";//
            ...
            if (cm.haveItem(4000048, 150) && cm.haveItem(4000051, 150)) {//需要物品数量
                cm.gainItem(4000048,-150);//减少玩家50个ID为4000016的道具
                cm.gainItem(4000051,-150);//减少玩家50个ID为4000016的道具
                cm.gainPotion(1,300);//奖励点卷数
