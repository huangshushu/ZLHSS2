...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            var a1 = "#L1#" + 红色箭头 + " #r需要物品：#v4000020#150个 #v4000024#150个 #l\r\n\r\n"+圆形+"完成奖励：180点券\r\n";//
            ...
            if (cm.haveItem(4000020, 150) && cm.haveItem(4000024, 150)) {//需要物品数量
                cm.gainItem(4000020,-150);//减少玩家50个ID为4000016的道具
                cm.gainItem(4000024,-150);//减少玩家50个ID为4000016的道具
                cm.gainPotion(1,180);//奖励点卷数
