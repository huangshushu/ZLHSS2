...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            var a1 = "#L1#" + 红色箭头 + " 这里是跑商第一环，你愿意把 #v4031952# 送给妖精玛丽吗？\r\n";//    
            ...
            if (cm.haveItem(4000016, 30) && cm.haveItem(4000000, 30)) {//需要物品数量
                //cm.gainItem(4000016,-30);//减少玩家50个ID为4000016的道具
                //cm.gainItem(4000000,-30);//减少玩家50个ID为4000016的道具
                //cm.gainPotion(1,100);//奖励点卷数
