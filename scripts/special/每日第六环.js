...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            var a1 = "#L1#" + 红色箭头 + " #r需要物品：#v4000029#150个 #v4000041#150个 #l\r\n\r\n"+圆形+"完成奖励：240点券\r\n";//
            ...
            if (cm.haveItem(4000029, 150) && cm.haveItem(4000041, 150)) {//需要物品数量
                cm.gainItem(4000029,-150);//减少玩家50个ID为4000016的道具
                cm.gainItem(4000041,-150);//减少玩家50个ID为4000016的道具
                cm.gainPotion(1,240);//奖励点卷数
