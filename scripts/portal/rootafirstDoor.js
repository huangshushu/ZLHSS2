function enter(pi) {
	...
	if(pi.getMap(105200200).isDisconnected(pi.getPlayer().getId())){
			pi.playPortalSE();
			pi.warp(105200200, "sp");
	}
	if (pi.getBossLog("皮埃尔") >= 3) {
	...
	if (pi.getPlayerCount(105200200) <= 0) {
			var FantMap = pi.getMap(105200200);
			//pi.setBossLog("皮埃尔");
	    ...
	    if (pi.getMap(105200210).getSpeedRunStart() == 0 && (pi.getMonsterCount(105200210) <= 0)) {
		pi.playPortalSE();
		//pi.setBossLog("皮埃尔");
		pi.warp(105200200, "sp");
		}else{
