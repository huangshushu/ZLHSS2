...
import java.util.Map;
 ...
 public class MonsterDropCreator  {
    ...
    public static void main(String[] args) throws IOException, NotBoundException, InstanceAlreadyExistsException, MBeanRegistrationException, NotCompliantMBeanException, MalformedObjectNameException {
        ...
        /* 247 */
        for (Pair Pair : itemNameCache) /* 248 */ {
            if ((((Integer) Pair.getLeft()).intValue() >= 2380000) && (((Integer) Pair.getLeft()).intValue() <= lastmonstercardid)) {
                /* 249 */
                bookName.append((String) Pair.getRight());
                /*     */
    ...
    private static int IncrementRate(int itemid, int times) {
        ...
        if (times == 0) {
            /* 293 */
            if ((itemid == 1002357) || (itemid == 1002926) || (itemid == 1002927)) /* 294 */ {
                return 999999;
            }
            /* 295 */
            if (itemid == 1122000) /* 296 */ {
                return 999999;
            }
            /* 297 */
            if (itemid == 1002972) /* 298 */ {
                return 999999;
            }
            /*     */
        } /* 300 */ else if (times == 1) {
            /* 301 */
            if ((itemid == 1002357) || (itemid == 1002926) || (itemid == 1002927)) /* 302 */ {
                return 999999;
            }
            /* 303 */
            if (itemid == 1122000) /* 304 */ {
                return 999999;
            }
            /* 305 */
            if (itemid == 1002972) /* 306 */ {
                return 300000;
            }
            /*     */
        } /* 308 */ else if (times == 2) {
            /* 309 */
            if ((itemid == 1002357) || (itemid == 1002926) || (itemid == 1002927)) /* 310 */ {
                return 300000;
            }
            /* 311 */
            if (itemid == 1122000) /* 312 */ {
                return 300000;
            }
            /*     */
        } /* 314 */ else if (times == 3) {
            /* 315 */
            if ((itemid == 1002357) || (itemid == 1002926) || (itemid == 1002927)) /* 316 */ {
                return 300000;
            }
            /*     */
