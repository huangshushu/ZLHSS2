...
/*  13:    */ public class WzStringDumper /*  14:    */ {
    ...
    /*  16:    */ throws IOException /*  17:    */ {
        ...
        /*  59: 63 */
        for (MapleData child : cash.getChildren()) /*  60:    */ {
            /*  61: 64 */
        ...
        /*  79: 82 */
        for (MapleData child : consume.getChildren()) /*  80:    */ {
            /*  81: 83 */
            MapleData nameData = child.getChildByPath("name");
            /*  82: 84 */
            MapleData descData = child.getChildByPath("desc");
        ...
        /*  98:100 */
        for (MapleData child : eqp.getChildren()) /*  99:    */ {
            /* 100:101 */
            ...
            /* 104:105 */
            for (MapleData child2 : child.getChildren()) /* 105:    */ {
                /* 106:106 */
        ...
        /* 126:126 */
        for (MapleData child : etc.getChildren()) /* 127:    */ {
            /* 128:127 */
            MapleData nameData = child.getChildByPath("name");
            /* 129:128 */
            MapleData descData = child.getChildByPath("desc");
        ...
        /* 146:145 */
        for (MapleData child : ins.getChildren()) /* 147:    */ {
            /* 148:146 */
            MapleData nameData = child.getChildByPath("name");
            /* 149:147 */
            MapleData descData = child.getChildByPath("desc");
        ...
        /* 166:164 */
        for (MapleData child : pet.getChildren()) /* 167:    */ {
            /* 168:165 */
            MapleData nameData = child.getChildByPath("name");
            /* 169:166 */
            MapleData descData = child.getChildByPath("desc");
        ...
        /* 186:183 */
        for (MapleData child : map.getChildren()) /* 187:    */ {
            /* 188:184 */
            writer.println(child.getName());
            /* 189:185 */
            writer.println();
            /* 190:186 */
            for (MapleData child2 : child.getChildren()) /* 191:    */ {
                /* 192:187 */
        ...
        /* 212:207 */
        for (MapleData child : mob.getChildren()) /* 213:    */ {
            /* 214:208 */
            MapleData nameData = child.getChildByPath("name");
            /* 215:209 */
            String name = "";
        ...
        /* 227:221 */
        for (MapleData child : skill.getChildren()) /* 228:    */ {
            /* 229:222 */
            MapleData nameData = child.getChildByPath("name");
            /* 230:223 */
            MapleData descData = child.getChildByPath("desc");
        ...
        /* 250:245 */
        for (MapleData child : npc.getChildren()) /* 251:    */ {
            /* 252:246 */
            MapleData nameData = child.getChildByPath("name");
            /* 253:247 */
            String name = "";
