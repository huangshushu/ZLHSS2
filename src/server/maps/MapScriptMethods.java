...
public class MapScriptMethods {
    ...
    public static void startScript_FirstUser(MapleClient c, String scriptName) {
        ...
        switch (onFirstUserEnter.fromString(scriptName)) {
            ...
            case StageMsg_romio: {
                switch (c.getPlayer().getMapId()) {
                    ...
                    case 926100001:
                        ...
                        break;
                    case 926100100:
                        c.getPlayer().getMap().startMapEffect("把烧杯填满!", 5120021);
                        break;
                    case 926100200:
            ...
            case StageMsg_juliet: {
                switch (c.getPlayer().getMapId()) {
                    ...
                    case 926110001:
                        ...
                        break;
                    case 926110100:
                        c.getPlayer().getMap().startMapEffect("把烧杯填满!", 5120022);
                        break;
                    case 926110200:
            ...
            case party6weatherMsg: {
                switch (c.getPlayer().getMapId()) {
                    ...
                    case 930000200:
                        ...
                        break;
                    case 930000300:
                        c.getPlayer().getMap().startMapEffect("妈妈你在哪里呜呜 哭哭我迷路了", 5120023);
                        break;
                    case 930000400:
            ...
            case StageMsg_davy: {
                switch (c.getPlayer().getMapId()) {
                    case 925100000:
                        ...
                        break;
                    case 925100100:
                        c.getPlayer().getMap().startMapEffect("我们必须证明自己！请给我海盗奖牌!", 5120020);
                        break;
                    case 925100200:
                    ...
                    case 925100300:
                        ...
                        break;
                    case 925100400:
                        c.getPlayer().getMap().startMapEffect("打败怪物然后把钥匙放入门缝里!", 5120020);
                        break;
                    case 925100500:
                        c.getPlayer().getMap().startMapEffect("打倒这只BOSS即可过关。", 5120020);
                        break;
                }
            ...
            default: {
                System.err.println("未处理的脚本 : " + scriptName + ", 型态 : onFirstUserEnter - 地图ID " + c.getPlayer().getMapId());
                FilePrinter.printError("MapScriptMethods.txt", "未处理的脚本 : " + scriptName + ", 型态 : onUserEnter - 地图ID " + c.getPlayer().getMapId());
                break;
            }
        }
    }
    ...
    public static void startScript_User(MapleClient c, String scriptName) {
        ...
        switch (onUserEnter.fromString(scriptName)) {
            ...
            default: {
                System.err.println("未处理的脚本 : " + scriptName + ", 型态 : onUserEnter - 地图ID " + c.getPlayer().getMapId());
                FilePrinter.printError("MapScriptMethods.txt", "未处理的脚本 : " + scriptName + ", 型态 : onUserEnter - 地图ID " + c.getPlayer().getMapId());
                break;
            }
        }
